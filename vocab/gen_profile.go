...
type ProfileType interface {
	...
	HasUnknownDescribes() (ok bool)
	GetUnknownDescribes() (v interface{})
	SetUnknownDescribes(i interface{})
	IsAltitude() (ok bool)
...
func (t *Profile) IsSharesCollection() (ok bool) {
...
func (t *Profile) GetSharesCollection() (v CollectionType) {
	return t.shares.Collection

}

// SetSharesCollection sets the value of shares to be of CollectionType type
func (t *Profile) SetSharesCollection(v CollectionType) {
...
func (t *Profile) IsSharesOrderedCollection() (ok bool) {
