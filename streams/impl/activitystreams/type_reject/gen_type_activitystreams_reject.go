...
//     "type": "Reject"
//   }
type ActivityStreamsReject struct {
...
// ActivityStreamsRejectExtends returns true if the Reject type extends from the
// other type.
...
// DeserializeReject creates a Reject from a map representation that has been
// unmarshalled from a text or binary format.
func DeserializeReject(m map[string]interface{}, aliasMap map[string]string) (*ActivityStreamsReject, error) {
	alias := ""
	aliasPrefix := ""
	...
	if typeValue, ok := m["type"]; !ok {
		...
		if typeName != "Reject" {
			return nil, fmt.Errorf("\"type\" property is not of %q type: %s", "Reject", typeName)
		}
		// Fall through, success in finding a proper Type
	} else if arrType, ok := typeValue.([]interface{}); ok {
		found := false
		for _, elemVal := range arrType {
			if typeString, ok := elemVal.(string); ok && strings.TrimPrefix(typeString, aliasPrefix) == "Reject" {
				found = true
				break
			}
		}
		if !found {
			return nil, fmt.Errorf("could not find a \"type\" property of value %q", "Reject")
		}
		// Fall through, success in finding a proper Type
	} else {
...
func NewActivityStreamsReject() *ActivityStreamsReject {
	...
	typeProp.AppendXMLSchemaString("Reject")
	return &ActivityStreamsReject{
...
// otherwise.
func (this ActivityStreamsReject) GetActivityStreamsSummary() vocab.ActivityStreamsSummaryProperty {
	return this.ActivityStreamsSummary
}

// GetActivityStreamsTag returns the "tag" property if it exists, and nil
// otherwise.
func (this ActivityStreamsReject) GetActivityStreamsTag() vocab.ActivityStreamsTagProperty {
	return this.ActivityStreamsTag
}

// GetActivityStreamsTarget returns the "target" property if it exists, and nil
// otherwise.
func (this ActivityStreamsReject) GetActivityStreamsTarget() vocab.ActivityStreamsTargetProperty {
	return this.ActivityStreamsTarget
}

// GetActivityStreamsTo returns the "to" property if it exists, and nil otherwise.
func (this ActivityStreamsReject) GetActivityStreamsTo() vocab.ActivityStreamsToProperty {
	return this.ActivityStreamsTo
}

// GetActivityStreamsType returns the "type" property if it exists, and nil
// otherwise.
func (this ActivityStreamsReject) GetActivityStreamsType() vocab.ActivityStreamsTypeProperty {
	return this.ActivityStreamsType
}

// GetActivityStreamsUpdated returns the "updated" property if it exists, and nil
// otherwise.
func (this ActivityStreamsReject) GetActivityStreamsUpdated() vocab.ActivityStreamsUpdatedProperty {
	return this.ActivityStreamsUpdated
}

// GetActivityStreamsUrl returns the "url" property if it exists, and nil
// otherwise.
func (this ActivityStreamsReject) GetActivityStreamsUrl() vocab.ActivityStreamsUrlProperty {
...
// GetUnknownProperties returns the unknown properties for the Reject type. Note
...
func (this ActivityStreamsReject) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// IsExtending returns true if the Reject type extends from the other type.
func (this ActivityStreamsReject) IsExtending(other vocab.Type) bool {
	return ActivityStreamsRejectExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this ActivityStreamsReject) JSONLDContext() map[string]string {
...
// LessThan computes if this Reject is lesser, with an arbitrary but stable
// determination.
func (this ActivityStreamsReject) LessThan(o vocab.ActivityStreamsReject) bool {
...
func (this ActivityStreamsReject) Serialize() (map[string]interface{}, error) {
	m := make(map[string]interface{})
	typeName := "Reject"
	if len(this.alias) > 0 {
		typeName = this.alias + ":" + "Reject"
	}
	m["type"] = typeName
...
// otherwise.
func (this *ActivityStreamsReject) SetActivityStreamsReplies(i vocab.ActivityStreamsRepliesProperty) {
	this.ActivityStreamsReplies = i
}

// SetActivityStreamsResult returns the "result" property if it exists, and nil
// otherwise.
func (this *ActivityStreamsReject) SetActivityStreamsResult(i vocab.ActivityStreamsResultProperty) {
...
// otherwise.
func (this *ActivityStreamsReject) SetActivityStreamsSummary(i vocab.ActivityStreamsSummaryProperty) {
	this.ActivityStreamsSummary = i
}

// SetActivityStreamsTag returns the "tag" property if it exists, and nil
// otherwise.
func (this *ActivityStreamsReject) SetActivityStreamsTag(i vocab.ActivityStreamsTagProperty) {
	this.ActivityStreamsTag = i
}

// SetActivityStreamsTarget returns the "target" property if it exists, and nil
// otherwise.
func (this *ActivityStreamsReject) SetActivityStreamsTarget(i vocab.ActivityStreamsTargetProperty) {
	this.ActivityStreamsTarget = i
}

// SetActivityStreamsTo returns the "to" property if it exists, and nil otherwise.
func (this *ActivityStreamsReject) SetActivityStreamsTo(i vocab.ActivityStreamsToProperty) {
	this.ActivityStreamsTo = i
}

// SetActivityStreamsType returns the "type" property if it exists, and nil
// otherwise.
func (this *ActivityStreamsReject) SetActivityStreamsType(i vocab.ActivityStreamsTypeProperty) {
	this.ActivityStreamsType = i
}

// SetActivityStreamsUpdated returns the "updated" property if it exists, and nil
// otherwise.
func (this *ActivityStreamsReject) SetActivityStreamsUpdated(i vocab.ActivityStreamsUpdatedProperty) {
	this.ActivityStreamsUpdated = i
}

// SetActivityStreamsUrl returns the "url" property if it exists, and nil
// otherwise.
func (this *ActivityStreamsReject) SetActivityStreamsUrl(i vocab.ActivityStreamsUrlProperty) {
	this.ActivityStreamsUrl = i
}

// VocabularyURI returns the vocabulary's URI as a string.
func (this ActivityStreamsReject) VocabularyURI() string {
	return "https://www.w3.org/TR/activitystreams-vocabulary"
}

// helperJSONLDContext obtains the context uris and their aliases from a property,
// if it is not nil.
func (this ActivityStreamsReject) helperJSONLDContext(i jsonldContexter, toMerge map[string]string) map[string]string {
	if i == nil {
		return toMerge
	}
