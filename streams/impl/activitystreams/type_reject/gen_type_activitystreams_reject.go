...
func (this ActivityStreamsReject) GetJSONLDId() vocab.JSONLDIdProperty {
	return this.JSONLDId
}

// GetJSONLDType returns the "type" property if it exists, and nil otherwise.
func (this ActivityStreamsReject) GetJSONLDType() vocab.JSONLDTypeProperty {
...
func (this *ActivityStreamsReject) SetJSONLDId(i vocab.JSONLDIdProperty) {
	this.JSONLDId = i
}

// SetJSONLDType sets the "type" property.
func (this *ActivityStreamsReject) SetJSONLDType(i vocab.JSONLDTypeProperty) {
	this.JSONLDType = i
}
