...
func DeserializeReject(m map[string]interface{}, aliasMap map[string]string) (*Reject, error) {
	alias := ""
	aliasPrefix := ""
...
// RejectExtends returns true if the Reject type extends from the other type.
func RejectExtends(other vocab.Type) bool {
...
func (this Reject) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Reject) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Reject) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Reject type extends from the other type.
func (this Reject) IsExtending(other vocab.Type) bool {
	return RejectExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Reject) JSONLDContext() map[string]string {
...
// determination.
func (this Reject) LessThan(o vocab.RejectInterface) bool {
...
func (this Reject) Serialize() (map[string]interface{}, error) {
