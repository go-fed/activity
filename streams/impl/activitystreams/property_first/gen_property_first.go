...
// FirstProperty is the functional property "first". It is permitted to be one of
...
func DeserializeFirstProperty(m map[string]interface{}, aliasMap map[string]string) (*FirstProperty, error) {
	alias := ""
...
// NewFirstProperty creates a new first property.
func NewFirstProperty() *FirstProperty {
	return &FirstProperty{alias: ""}
}
...
func (this FirstProperty) GetCollectionPage() vocab.CollectionPageInterface {
	return this.CollectionPageMember
}

// GetIRI returns the IRI of this property. When IsIRI returns false, GetIRI will
// return an arbitrary value.
func (this FirstProperty) GetIRI() *url.URL {
	return this.iri
}

// GetLink returns the value of this property. When IsLink returns false, GetLink
// will return an arbitrary value.
func (this FirstProperty) GetLink() vocab.LinkInterface {
...
func (this FirstProperty) IsCollectionPage() bool {
	return this.CollectionPageMember != nil
}

// IsIRI returns true if this property is an IRI. When true, use GetIRI and SetIRI
// to access and set this property
func (this FirstProperty) IsIRI() bool {
	return this.iri != nil
}
...
func (this FirstProperty) IsLink() bool {
...
func (this FirstProperty) JSONLDContext() map[string]string {
...
func (this FirstProperty) KindIndex() int {
	if this.IsCollectionPage() {
		return 0
	}
	if this.IsLink() {
...
func (this FirstProperty) LessThan(o vocab.FirstPropertyInterface) bool {
	idx1 := this.KindIndex()
	idx2 := o.KindIndex()
	if idx1 < idx2 {
		return true
...
func (this FirstProperty) Name() string {
	return "first"
}
...
func (this FirstProperty) Serialize() (interface{}, error) {
	if this.IsCollectionPage() {
...
func (this *FirstProperty) SetCollectionPage(v vocab.CollectionPageInterface) {
	this.Clear()
	this.CollectionPageMember = v
}

// SetIRI sets the value of this property. Calling IsIRI afterwards returns true.
func (this *FirstProperty) SetIRI(v *url.URL) {
	this.Clear()
	this.iri = v
}

// SetLink sets the value of this property. Calling IsLink afterwards returns true.
func (this *FirstProperty) SetLink(v vocab.LinkInterface) {
	this.Clear()
	this.LinkMember = v
}
