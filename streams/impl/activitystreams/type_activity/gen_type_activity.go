...
// ActivityExtends returns true if the Activity type extends from the other type.
func ActivityExtends(other vocab.Type) bool {
...
func ActivityIsExtendedBy(other vocab.Type) bool {
	extensions := []string{"Reject", "TentativeReject", "Read", "View", "Flag", "Update", "Accept", "TentativeAccept", "Undo", "Offer", "Invite", "Follow", "Create", "Move", "Listen", "Remove", "Add", "Join", "Delete", "Dislike", "Ignore", "Block", "IntransitiveActivity", "Travel", "Arrive", "Question", "Leave", "Announce", "Like"}
	for _, ext := range extensions {
		if ext == other.GetName() {
			return true
		}
...
func (this Activity) GetSummary() vocab.SummaryPropertyInterface {
	return this.Summary
}

// GetTag returns the "tag" property if it exists, and nil otherwise.
func (this Activity) GetTag() vocab.TagPropertyInterface {
	return this.Tag
}

// GetTarget returns the "target" property if it exists, and nil otherwise.
func (this Activity) GetTarget() vocab.TargetPropertyInterface {
	return this.Target
}

// GetTo returns the "to" property if it exists, and nil otherwise.
func (this Activity) GetTo() vocab.ToPropertyInterface {
	return this.To
}

// GetType returns the "type" property if it exists, and nil otherwise.
func (this Activity) GetType() vocab.TypePropertyInterface {
	return this.Type
}
...
func (this Activity) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Activity) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Activity) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Activity type extends from the other type.
func (this Activity) IsExtending(other vocab.Type) bool {
	return ActivityExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Activity) JSONLDContext() map[string]string {
...
// determination.
func (this Activity) LessThan(o vocab.ActivityInterface) bool {
...
func (this Activity) Serialize() (interface{}, error) {
...
// if it is not nil.
func (this Activity) helperJSONLDContext(i jsonldContexter, toMerge map[string]string) map[string]string {
	if i == nil {
		return toMerge
	}
