...
// TagPropertyIterator is an iterator for a property. It is permitted to be one of
...
type TagPropertyIterator struct {
	...
	alias                       string
	myIdx                       int
	parent                      vocab.TagPropertyInterface
}

// NewTagPropertyIterator creates a new tag property.
func NewTagPropertyIterator() *TagPropertyIterator {
	return &TagPropertyIterator{alias: ""}
}

// deserializeTagPropertyIterator creates an iterator from an element that has
// been unmarshalled from a text or binary format.
func deserializeTagPropertyIterator(i interface{}, aliasMap map[string]string) (*TagPropertyIterator, error) {
	alias := ""
...
func (this TagPropertyIterator) GetAccept() vocab.AcceptInterface {
...
func (this TagPropertyIterator) GetActivity() vocab.ActivityInterface {
	return this.ActivityMember
}

// GetAdd returns the value of this property. When IsAdd returns false, GetAdd
// will return an arbitrary value.
func (this TagPropertyIterator) GetAdd() vocab.AddInterface {
...
func (this TagPropertyIterator) GetAnnounce() vocab.AnnounceInterface {
...
func (this TagPropertyIterator) GetApplication() vocab.ApplicationInterface {
...
func (this TagPropertyIterator) GetArrive() vocab.ArriveInterface {
...
func (this TagPropertyIterator) GetArticle() vocab.ArticleInterface {
...
func (this TagPropertyIterator) GetAudio() vocab.AudioInterface {
...
func (this TagPropertyIterator) GetBlock() vocab.BlockInterface {
...
func (this TagPropertyIterator) GetCollection() vocab.CollectionInterface {
...
func (this TagPropertyIterator) GetCollectionPage() vocab.CollectionPageInterface {
...
func (this TagPropertyIterator) GetCreate() vocab.CreateInterface {
	return this.CreateMember
}

// GetDelete returns the value of this property. When IsDelete returns false,
// GetDelete will return an arbitrary value.
func (this TagPropertyIterator) GetDelete() vocab.DeleteInterface {
...
func (this TagPropertyIterator) GetDislike() vocab.DislikeInterface {
...
func (this TagPropertyIterator) GetDocument() vocab.DocumentInterface {
...
func (this TagPropertyIterator) GetEvent() vocab.EventInterface {
	return this.EventMember
}

// GetFlag returns the value of this property. When IsFlag returns false, GetFlag
// will return an arbitrary value.
func (this TagPropertyIterator) GetFlag() vocab.FlagInterface {
...
func (this TagPropertyIterator) GetFollow() vocab.FollowInterface {
...
func (this TagPropertyIterator) GetGroup() vocab.GroupInterface {
	return this.GroupMember
}

// GetIRI returns the IRI of this property. When IsIRI returns false, GetIRI will
// return an arbitrary value.
func (this TagPropertyIterator) GetIRI() *url.URL {
	return this.iri
}

// GetIgnore returns the value of this property. When IsIgnore returns false,
// GetIgnore will return an arbitrary value.
func (this TagPropertyIterator) GetIgnore() vocab.IgnoreInterface {
...
func (this TagPropertyIterator) GetImage() vocab.ImageInterface {
...
// an arbitrary value.
func (this TagPropertyIterator) GetIntransitiveActivity() vocab.IntransitiveActivityInterface {
...
func (this TagPropertyIterator) GetInvite() vocab.InviteInterface {
	return this.InviteMember
}

// GetJoin returns the value of this property. When IsJoin returns false, GetJoin
// will return an arbitrary value.
func (this TagPropertyIterator) GetJoin() vocab.JoinInterface {
...
func (this TagPropertyIterator) GetListen() vocab.ListenInterface {
...
func (this TagPropertyIterator) GetObject() vocab.ObjectInterface {
...
func (this TagPropertyIterator) GetOffer() vocab.OfferInterface {
...
// arbitrary value.
func (this TagPropertyIterator) GetOrderedCollection() vocab.OrderedCollectionInterface {
...
// an arbitrary value.
func (this TagPropertyIterator) GetOrderedCollectionPage() vocab.OrderedCollectionPageInterface {
...
func (this TagPropertyIterator) GetOrganization() vocab.OrganizationInterface {
	return this.OrganizationMember
}

// GetPage returns the value of this property. When IsPage returns false, GetPage
// will return an arbitrary value.
func (this TagPropertyIterator) GetPage() vocab.PageInterface {
...
func (this TagPropertyIterator) GetPerson() vocab.PersonInterface {
...
func (this TagPropertyIterator) GetPlace() vocab.PlaceInterface {
...
func (this TagPropertyIterator) GetProfile() vocab.ProfileInterface {
...
func (this TagPropertyIterator) GetQuestion() vocab.QuestionInterface {
	return this.QuestionMember
}

// GetRead returns the value of this property. When IsRead returns false, GetRead
// will return an arbitrary value.
func (this TagPropertyIterator) GetRead() vocab.ReadInterface {
...
func (this TagPropertyIterator) GetReject() vocab.RejectInterface {
...
func (this TagPropertyIterator) GetRelationship() vocab.RelationshipInterface {
...
func (this TagPropertyIterator) GetRemove() vocab.RemoveInterface {
	return this.RemoveMember
}

// GetService returns the value of this property. When IsService returns false,
// GetService will return an arbitrary value.
func (this TagPropertyIterator) GetService() vocab.ServiceInterface {
...
func (this TagPropertyIterator) GetTentativeAccept() vocab.TentativeAcceptInterface {
...
func (this TagPropertyIterator) GetTentativeReject() vocab.TentativeRejectInterface {
...
func (this TagPropertyIterator) GetTombstone() vocab.TombstoneInterface {
...
func (this TagPropertyIterator) GetTravel() vocab.TravelInterface {
	return this.TravelMember
}

// GetUndo returns the value of this property. When IsUndo returns false, GetUndo
// will return an arbitrary value.
func (this TagPropertyIterator) GetUndo() vocab.UndoInterface {
...
func (this TagPropertyIterator) IsAccept() bool {
...
func (this TagPropertyIterator) IsActivity() bool {
...
func (this TagPropertyIterator) IsAdd() bool {
...
func (this TagPropertyIterator) IsAnnounce() bool {
...
// this property.
func (this TagPropertyIterator) IsApplication() bool {
...
func (this TagPropertyIterator) IsArrive() bool {
...
func (this TagPropertyIterator) IsArticle() bool {
...
func (this TagPropertyIterator) IsAudio() bool {
...
func (this TagPropertyIterator) IsBlock() bool {
...
// this property.
func (this TagPropertyIterator) IsCollection() bool {
...
func (this TagPropertyIterator) IsCollectionPage() bool {
...
func (this TagPropertyIterator) IsCreate() bool {
...
func (this TagPropertyIterator) IsDelete() bool {
...
func (this TagPropertyIterator) IsDislike() bool {
...
func (this TagPropertyIterator) IsDocument() bool {
...
func (this TagPropertyIterator) IsEvent() bool {
...
func (this TagPropertyIterator) IsFlag() bool {
...
func (this TagPropertyIterator) IsFollow() bool {
...
func (this TagPropertyIterator) IsGroup() bool {
	return this.GroupMember != nil
}

// IsIRI returns true if this property is an IRI. When true, use GetIRI and SetIRI
// to access and set this property
func (this TagPropertyIterator) IsIRI() bool {
	return this.iri != nil
}
...
func (this TagPropertyIterator) IsIgnore() bool {
...
func (this TagPropertyIterator) IsImage() bool {
...
func (this TagPropertyIterator) IsIntransitiveActivity() bool {
...
func (this TagPropertyIterator) IsInvite() bool {
...
func (this TagPropertyIterator) IsJoin() bool {
...
func (this TagPropertyIterator) IsLeave() bool {
...
func (this TagPropertyIterator) IsLike() bool {
...
func (this TagPropertyIterator) IsLink() bool {
...
func (this TagPropertyIterator) IsListen() bool {
...
func (this TagPropertyIterator) IsMention() bool {
...
func (this TagPropertyIterator) IsMove() bool {
...
func (this TagPropertyIterator) IsNote() bool {
...
func (this TagPropertyIterator) IsObject() bool {
...
func (this TagPropertyIterator) IsOffer() bool {
...
func (this TagPropertyIterator) IsOrderedCollection() bool {
...
func (this TagPropertyIterator) IsOrderedCollectionPage() bool {
...
// this property.
func (this TagPropertyIterator) IsOrganization() bool {
...
func (this TagPropertyIterator) IsPage() bool {
...
func (this TagPropertyIterator) IsPerson() bool {
...
func (this TagPropertyIterator) IsPlace() bool {
...
func (this TagPropertyIterator) IsProfile() bool {
...
func (this TagPropertyIterator) IsQuestion() bool {
...
func (this TagPropertyIterator) IsRead() bool {
...
func (this TagPropertyIterator) IsReject() bool {
...
// this property.
func (this TagPropertyIterator) IsRelationship() bool {
...
func (this TagPropertyIterator) IsRemove() bool {
...
func (this TagPropertyIterator) IsService() bool {
...
func (this TagPropertyIterator) IsTentativeAccept() bool {
...
func (this TagPropertyIterator) IsTentativeReject() bool {
...
// property.
func (this TagPropertyIterator) IsTombstone() bool {
...
func (this TagPropertyIterator) IsTravel() bool {
...
func (this TagPropertyIterator) IsUndo() bool {
...
func (this TagPropertyIterator) IsUpdate() bool {
...
func (this TagPropertyIterator) IsVideo() bool {
...
func (this TagPropertyIterator) IsView() bool {
...
func (this TagPropertyIterator) JSONLDContext() map[string]string {
...
func (this TagPropertyIterator) KindIndex() int {
	if this.IsObject() {
		return 0
	}
	if this.IsLink() {
...
func (this TagPropertyIterator) LessThan(o vocab.TagPropertyIteratorInterface) bool {
	idx1 := this.KindIndex()
	idx2 := o.KindIndex()
	if idx1 < idx2 {
		return true
...
func (this TagPropertyIterator) Name() string {
	return "tag"
}

// Next returns the next iterator, or nil if there is no next iterator.
func (this TagPropertyIterator) Next() vocab.TagPropertyIteratorInterface {
...
func (this TagPropertyIterator) Prev() vocab.TagPropertyIteratorInterface {
	if this.myIdx-1 < 0 {
		return nil
	} else {
		return this.parent.At(this.myIdx - 1)
...
// true.
func (this *TagPropertyIterator) SetAccept(v vocab.AcceptInterface) {
	this.clear()
	this.AcceptMember = v
}
...
// returns true.
func (this *TagPropertyIterator) SetActivity(v vocab.ActivityInterface) {
	this.clear()
	this.ActivityMember = v
}

// SetAdd sets the value of this property. Calling IsAdd afterwards returns true.
func (this *TagPropertyIterator) SetAdd(v vocab.AddInterface) {
	this.clear()
	this.AddMember = v
}
...
// returns true.
func (this *TagPropertyIterator) SetAnnounce(v vocab.AnnounceInterface) {
	this.clear()
...
func (this *TagPropertyIterator) SetApplication(v vocab.ApplicationInterface) {
	this.clear()
...
// true.
func (this *TagPropertyIterator) SetArrive(v vocab.ArriveInterface) {
	this.clear()
	this.ArriveMember = v
}
...
// returns true.
func (this *TagPropertyIterator) SetArticle(v vocab.ArticleInterface) {
	this.clear()
...
// true.
func (this *TagPropertyIterator) SetAudio(v vocab.AudioInterface) {
	this.clear()
	this.AudioMember = v
}
...
// true.
func (this *TagPropertyIterator) SetBlock(v vocab.BlockInterface) {
	this.clear()
	this.BlockMember = v
}
...
// returns true.
func (this *TagPropertyIterator) SetCollection(v vocab.CollectionInterface) {
	this.clear()
...
// afterwards returns true.
func (this *TagPropertyIterator) SetCollectionPage(v vocab.CollectionPageInterface) {
	this.clear()
...
// true.
func (this *TagPropertyIterator) SetCreate(v vocab.CreateInterface) {
	this.clear()
	this.CreateMember = v
}
...
// true.
func (this *TagPropertyIterator) SetDelete(v vocab.DeleteInterface) {
	this.clear()
	this.DeleteMember = v
}
...
// returns true.
func (this *TagPropertyIterator) SetDislike(v vocab.DislikeInterface) {
	this.clear()
...
// returns true.
func (this *TagPropertyIterator) SetDocument(v vocab.DocumentInterface) {
	this.clear()
...
// true.
func (this *TagPropertyIterator) SetEvent(v vocab.EventInterface) {
	this.clear()
	this.EventMember = v
}

// SetFlag sets the value of this property. Calling IsFlag afterwards returns true.
func (this *TagPropertyIterator) SetFlag(v vocab.FlagInterface) {
	this.clear()
	this.FlagMember = v
}
...
// true.
func (this *TagPropertyIterator) SetFollow(v vocab.FollowInterface) {
	this.clear()
	this.FollowMember = v
}
...
// true.
func (this *TagPropertyIterator) SetGroup(v vocab.GroupInterface) {
	this.clear()
	this.GroupMember = v
}

// SetIRI sets the value of this property. Calling IsIRI afterwards returns true.
func (this *TagPropertyIterator) SetIRI(v *url.URL) {
	this.clear()
	this.iri = v
}
...
// true.
func (this *TagPropertyIterator) SetIgnore(v vocab.IgnoreInterface) {
	this.clear()
	this.IgnoreMember = v
}
...
// true.
func (this *TagPropertyIterator) SetImage(v vocab.ImageInterface) {
	this.clear()
	this.ImageMember = v
}
...
func (this *TagPropertyIterator) SetIntransitiveActivity(v vocab.IntransitiveActivityInterface) {
	this.clear()
...
// true.
func (this *TagPropertyIterator) SetInvite(v vocab.InviteInterface) {
	this.clear()
	this.InviteMember = v
}

// SetJoin sets the value of this property. Calling IsJoin afterwards returns true.
func (this *TagPropertyIterator) SetJoin(v vocab.JoinInterface) {
	this.clear()
	this.JoinMember = v
}
...
// true.
func (this *TagPropertyIterator) SetLeave(v vocab.LeaveInterface) {
	this.clear()
	this.LeaveMember = v
}

// SetLike sets the value of this property. Calling IsLike afterwards returns true.
func (this *TagPropertyIterator) SetLike(v vocab.LikeInterface) {
	this.clear()
	this.LikeMember = v
}

// SetLink sets the value of this property. Calling IsLink afterwards returns true.
func (this *TagPropertyIterator) SetLink(v vocab.LinkInterface) {
	this.clear()
	this.LinkMember = v
}
...
// true.
func (this *TagPropertyIterator) SetListen(v vocab.ListenInterface) {
	this.clear()
	this.ListenMember = v
}
...
// returns true.
func (this *TagPropertyIterator) SetMention(v vocab.MentionInterface) {
	this.clear()
	this.MentionMember = v
}

// SetMove sets the value of this property. Calling IsMove afterwards returns true.
func (this *TagPropertyIterator) SetMove(v vocab.MoveInterface) {
	this.clear()
	this.MoveMember = v
}

// SetNote sets the value of this property. Calling IsNote afterwards returns true.
func (this *TagPropertyIterator) SetNote(v vocab.NoteInterface) {
	this.clear()
	this.NoteMember = v
}
...
// true.
func (this *TagPropertyIterator) SetObject(v vocab.ObjectInterface) {
	this.clear()
	this.ObjectMember = v
}
...
// true.
func (this *TagPropertyIterator) SetOffer(v vocab.OfferInterface) {
	this.clear()
	this.OfferMember = v
}
...
func (this *TagPropertyIterator) SetOrderedCollection(v vocab.OrderedCollectionInterface) {
	this.clear()
...
func (this *TagPropertyIterator) SetOrderedCollectionPage(v vocab.OrderedCollectionPageInterface) {
	this.clear()
...
// afterwards returns true.
func (this *TagPropertyIterator) SetOrganization(v vocab.OrganizationInterface) {
	this.clear()
	this.OrganizationMember = v
}

// SetPage sets the value of this property. Calling IsPage afterwards returns true.
func (this *TagPropertyIterator) SetPage(v vocab.PageInterface) {
	this.clear()
	this.PageMember = v
}
...
// true.
func (this *TagPropertyIterator) SetPerson(v vocab.PersonInterface) {
	this.clear()
	this.PersonMember = v
}
...
// true.
func (this *TagPropertyIterator) SetPlace(v vocab.PlaceInterface) {
	this.clear()
	this.PlaceMember = v
}
...
// returns true.
func (this *TagPropertyIterator) SetProfile(v vocab.ProfileInterface) {
	this.clear()
...
// returns true.
func (this *TagPropertyIterator) SetQuestion(v vocab.QuestionInterface) {
	this.clear()
	this.QuestionMember = v
}

// SetRead sets the value of this property. Calling IsRead afterwards returns true.
func (this *TagPropertyIterator) SetRead(v vocab.ReadInterface) {
	this.clear()
	this.ReadMember = v
}
...
// true.
func (this *TagPropertyIterator) SetReject(v vocab.RejectInterface) {
	this.clear()
	this.RejectMember = v
}
...
// afterwards returns true.
func (this *TagPropertyIterator) SetRelationship(v vocab.RelationshipInterface) {
	this.clear()
...
// true.
func (this *TagPropertyIterator) SetRemove(v vocab.RemoveInterface) {
	this.clear()
	this.RemoveMember = v
}
...
// returns true.
func (this *TagPropertyIterator) SetService(v vocab.ServiceInterface) {
	this.clear()
...
// afterwards returns true.
func (this *TagPropertyIterator) SetTentativeAccept(v vocab.TentativeAcceptInterface) {
	this.clear()
...
// afterwards returns true.
func (this *TagPropertyIterator) SetTentativeReject(v vocab.TentativeRejectInterface) {
	this.clear()
...
// returns true.
func (this *TagPropertyIterator) SetTombstone(v vocab.TombstoneInterface) {
	this.clear()
...
// true.
func (this *TagPropertyIterator) SetTravel(v vocab.TravelInterface) {
	this.clear()
	this.TravelMember = v
}

// SetUndo sets the value of this property. Calling IsUndo afterwards returns true.
func (this *TagPropertyIterator) SetUndo(v vocab.UndoInterface) {
	this.clear()
	this.UndoMember = v
}
...
// true.
func (this *TagPropertyIterator) SetUpdate(v vocab.UpdateInterface) {
	this.clear()
	this.UpdateMember = v
}
...
// true.
func (this *TagPropertyIterator) SetVideo(v vocab.VideoInterface) {
	this.clear()
	this.VideoMember = v
}

// SetView sets the value of this property. Calling IsView afterwards returns true.
func (this *TagPropertyIterator) SetView(v vocab.ViewInterface) {
	this.clear()
	this.ViewMember = v
}
...
func (this *TagPropertyIterator) clear() {
...
func (this TagPropertyIterator) serialize() (interface{}, error) {
	if this.IsObject() {
...
type TagProperty struct {
	properties []*TagPropertyIterator
	alias      string
}

// DeserializeTagProperty creates a "tag" property from an interface
// representation that has been unmarshalled from a text or binary format.
func DeserializeTagProperty(m map[string]interface{}, aliasMap map[string]string) (vocab.TagPropertyInterface, error) {
	alias := ""
	if a, ok := aliasMap["https://www.w3.org/TR/activitystreams-vocabulary"]; ok {
		alias = a
	}
	...
	if ok {
		...
		if list, ok := i.([]interface{}); ok {
			for _, iterator := range list {
				if p, err := deserializeTagPropertyIterator(iterator, aliasMap); err != nil {
					return this, err
				} else if p != nil {
			...
			if p, err := deserializeTagPropertyIterator(i, aliasMap); err != nil {
				return this, err
			} else if p != nil {
				this.properties = append(this.properties, p)
			}
...
// NewTagProperty creates a new tag property.
func NewTagProperty() *TagProperty {
	return &TagProperty{alias: ""}
}
...
func (this *TagProperty) AppendAccept(v vocab.AcceptInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		AcceptMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
		parent:       this,
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendActivity(v vocab.ActivityInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		ActivityMember: v,
		alias:          this.alias,
		myIdx:          this.Len(),
...
// AppendAdd appends a Add value to the back of a list of the property "tag".
// Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendAdd(v vocab.AddInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		AddMember: v,
		alias:     this.alias,
		myIdx:     this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendAnnounce(v vocab.AnnounceInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		AnnounceMember: v,
		alias:          this.alias,
		myIdx:          this.Len(),
...
func (this *TagProperty) AppendApplication(v vocab.ApplicationInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		ApplicationMember: v,
		alias:             this.alias,
		myIdx:             this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendArrive(v vocab.ArriveInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		ArriveMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendArticle(v vocab.ArticleInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		ArticleMember: v,
		alias:         this.alias,
		myIdx:         this.Len(),
...
// AppendAudio appends a Audio value to the back of a list of the property "tag".
// Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendAudio(v vocab.AudioInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		AudioMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// AppendBlock appends a Block value to the back of a list of the property "tag".
// Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendBlock(v vocab.BlockInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		BlockMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// property "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendCollection(v vocab.CollectionInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		CollectionMember: v,
		alias:            this.alias,
		myIdx:            this.Len(),
...
func (this *TagProperty) AppendCollectionPage(v vocab.CollectionPageInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		CollectionPageMember: v,
		alias:                this.alias,
		myIdx:                this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendCreate(v vocab.CreateInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		CreateMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendDelete(v vocab.DeleteInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		DeleteMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendDislike(v vocab.DislikeInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		DislikeMember: v,
		alias:         this.alias,
		myIdx:         this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendDocument(v vocab.DocumentInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		DocumentMember: v,
		alias:          this.alias,
		myIdx:          this.Len(),
...
// AppendEvent appends a Event value to the back of a list of the property "tag".
// Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendEvent(v vocab.EventInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		EventMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// AppendFlag appends a Flag value to the back of a list of the property "tag".
// Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendFlag(v vocab.FlagInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		FlagMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendFollow(v vocab.FollowInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		FollowMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendGroup appends a Group value to the back of a list of the property "tag".
// Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendGroup(v vocab.GroupInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		GroupMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
func (this *TagProperty) AppendIRI(v *url.URL) {
	this.properties = append(this.properties, &TagPropertyIterator{
		alias:  this.alias,
		iri:    v,
		myIdx:  this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendIgnore(v vocab.IgnoreInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		IgnoreMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendImage appends a Image value to the back of a list of the property "tag".
// Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendImage(v vocab.ImageInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		ImageMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// using Prev.
func (this *TagProperty) AppendIntransitiveActivity(v vocab.IntransitiveActivityInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		IntransitiveActivityMember: v,
		alias:                      this.alias,
		myIdx:                      this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendInvite(v vocab.InviteInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		InviteMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendJoin appends a Join value to the back of a list of the property "tag".
// Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendJoin(v vocab.JoinInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		JoinMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendLeave appends a Leave value to the back of a list of the property "tag".
// Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendLeave(v vocab.LeaveInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		LeaveMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// AppendLike appends a Like value to the back of a list of the property "tag".
// Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendLike(v vocab.LikeInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		LikeMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendLink appends a Link value to the back of a list of the property "tag".
// Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendLink(v vocab.LinkInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		LinkMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendListen(v vocab.ListenInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		ListenMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendMention(v vocab.MentionInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		MentionMember: v,
		alias:         this.alias,
		myIdx:         this.Len(),
...
// AppendMove appends a Move value to the back of a list of the property "tag".
// Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendMove(v vocab.MoveInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		MoveMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendNote appends a Note value to the back of a list of the property "tag".
// Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendNote(v vocab.NoteInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		NoteMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendObject(v vocab.ObjectInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		ObjectMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendOffer appends a Offer value to the back of a list of the property "tag".
// Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendOffer(v vocab.OfferInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		OfferMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
func (this *TagProperty) AppendOrderedCollection(v vocab.OrderedCollectionInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		OrderedCollectionMember: v,
		alias:                   this.alias,
		myIdx:                   this.Len(),
...
// using Prev.
func (this *TagProperty) AppendOrderedCollectionPage(v vocab.OrderedCollectionPageInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		OrderedCollectionPageMember: v,
		alias:                       this.alias,
		myIdx:                       this.Len(),
...
// property "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendOrganization(v vocab.OrganizationInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		OrganizationMember: v,
		alias:              this.alias,
		myIdx:              this.Len(),
...
// AppendPage appends a Page value to the back of a list of the property "tag".
// Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendPage(v vocab.PageInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		PageMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendPerson(v vocab.PersonInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		PersonMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendPlace appends a Place value to the back of a list of the property "tag".
// Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendPlace(v vocab.PlaceInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		PlaceMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendProfile(v vocab.ProfileInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		ProfileMember: v,
		alias:         this.alias,
		myIdx:         this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendQuestion(v vocab.QuestionInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		QuestionMember: v,
		alias:          this.alias,
		myIdx:          this.Len(),
...
// AppendRead appends a Read value to the back of a list of the property "tag".
// Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendRead(v vocab.ReadInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		ReadMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendReject(v vocab.RejectInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		RejectMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// property "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendRelationship(v vocab.RelationshipInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		RelationshipMember: v,
		alias:              this.alias,
		myIdx:              this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendRemove(v vocab.RemoveInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		RemoveMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendService(v vocab.ServiceInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		ServiceMember: v,
		alias:         this.alias,
		myIdx:         this.Len(),
...
// the property "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendTentativeAccept(v vocab.TentativeAcceptInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		TentativeAcceptMember: v,
		alias:                 this.alias,
		myIdx:                 this.Len(),
...
// the property "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendTentativeReject(v vocab.TentativeRejectInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		TentativeRejectMember: v,
		alias:                 this.alias,
		myIdx:                 this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendTombstone(v vocab.TombstoneInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		TombstoneMember: v,
		alias:           this.alias,
		myIdx:           this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendTravel(v vocab.TravelInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		TravelMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendUndo appends a Undo value to the back of a list of the property "tag".
// Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendUndo(v vocab.UndoInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		UndoMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// "tag". Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendUpdate(v vocab.UpdateInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		UpdateMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendVideo appends a Video value to the back of a list of the property "tag".
// Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendVideo(v vocab.VideoInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		VideoMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// AppendView appends a View value to the back of a list of the property "tag".
// Invalidates iterators that are traversing using Prev.
func (this *TagProperty) AppendView(v vocab.ViewInterface) {
	this.properties = append(this.properties, &TagPropertyIterator{
		ViewMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// out of bounds.
func (this TagProperty) At(index int) vocab.TagPropertyIteratorInterface {
...
func (this TagProperty) Begin() vocab.TagPropertyIteratorInterface {
	if this.Empty() {
		return nil
	} else {
...
func (this TagProperty) Empty() bool {
	return this.Len() == 0
}
...
func (this TagProperty) End() vocab.TagPropertyIteratorInterface {
	return nil
}
...
// property and the specific values that are set. The value in the map is the
// alias used to import the property's value or values.
func (this TagProperty) JSONLDContext() map[string]string {
	m := map[string]string{"https://www.w3.org/TR/activitystreams-vocabulary": this.alias}
...
// out of bounds.
func (this TagProperty) KindIndex(idx int) int {
	return this.properties[idx].KindIndex()
}

// Len returns the number of values that exist for the "tag" property.
func (this TagProperty) Len() (length int) {
	return len(this.properties)
}

// Less computes whether another property is less than this one. Mixing types
// results in a consistent but arbitrary ordering
func (this TagProperty) Less(i, j int) bool {
...
// help alternative implementations to go-fed to be able to normalize
// nonfunctional properties.
func (this TagProperty) LessThan(o vocab.TagPropertyInterface) bool {
	l1 := this.Len()
	l2 := o.Len()
	l := l1
	if l2 < l1 {
...
// Name returns the name of this property: "tag".
func (this TagProperty) Name() string {
	return "tag"
}

// PrependAccept prepends a Accept value to the front of a list of the property
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependAccept(v vocab.AcceptInterface) {
	this.properties = append([]*TagPropertyIterator{{
		AcceptMember: v,
		alias:        this.alias,
		myIdx:        0,
		parent:       this,
...
func (this *TagProperty) PrependActivity(v vocab.ActivityInterface) {
	this.properties = append([]*TagPropertyIterator{{
		ActivityMember: v,
		alias:          this.alias,
		myIdx:          0,
...
// PrependAdd prepends a Add value to the front of a list of the property "tag".
// Invalidates all iterators.
func (this *TagProperty) PrependAdd(v vocab.AddInterface) {
	this.properties = append([]*TagPropertyIterator{{
		AddMember: v,
		alias:     this.alias,
		myIdx:     0,
...
// property "tag". Invalidates all iterators.
func (this *TagProperty) PrependAnnounce(v vocab.AnnounceInterface) {
	this.properties = append([]*TagPropertyIterator{{
		AnnounceMember: v,
		alias:          this.alias,
		myIdx:          0,
...
// property "tag". Invalidates all iterators.
func (this *TagProperty) PrependApplication(v vocab.ApplicationInterface) {
	this.properties = append([]*TagPropertyIterator{{
		ApplicationMember: v,
		alias:             this.alias,
		myIdx:             0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependArrive(v vocab.ArriveInterface) {
	this.properties = append([]*TagPropertyIterator{{
		ArriveMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependArticle(v vocab.ArticleInterface) {
	this.properties = append([]*TagPropertyIterator{{
		ArticleMember: v,
		alias:         this.alias,
		myIdx:         0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependAudio(v vocab.AudioInterface) {
	this.properties = append([]*TagPropertyIterator{{
		AudioMember: v,
		alias:       this.alias,
		myIdx:       0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependBlock(v vocab.BlockInterface) {
	this.properties = append([]*TagPropertyIterator{{
		BlockMember: v,
		alias:       this.alias,
		myIdx:       0,
...
// property "tag". Invalidates all iterators.
func (this *TagProperty) PrependCollection(v vocab.CollectionInterface) {
	this.properties = append([]*TagPropertyIterator{{
		CollectionMember: v,
		alias:            this.alias,
		myIdx:            0,
...
func (this *TagProperty) PrependCollectionPage(v vocab.CollectionPageInterface) {
	this.properties = append([]*TagPropertyIterator{{
		CollectionPageMember: v,
		alias:                this.alias,
		myIdx:                0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependCreate(v vocab.CreateInterface) {
	this.properties = append([]*TagPropertyIterator{{
		CreateMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependDelete(v vocab.DeleteInterface) {
	this.properties = append([]*TagPropertyIterator{{
		DeleteMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependDislike(v vocab.DislikeInterface) {
	this.properties = append([]*TagPropertyIterator{{
		DislikeMember: v,
		alias:         this.alias,
		myIdx:         0,
...
// property "tag". Invalidates all iterators.
func (this *TagProperty) PrependDocument(v vocab.DocumentInterface) {
	this.properties = append([]*TagPropertyIterator{{
		DocumentMember: v,
		alias:          this.alias,
		myIdx:          0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependEvent(v vocab.EventInterface) {
	this.properties = append([]*TagPropertyIterator{{
		EventMember: v,
		alias:       this.alias,
		myIdx:       0,
...
// PrependFlag prepends a Flag value to the front of a list of the property "tag".
// Invalidates all iterators.
func (this *TagProperty) PrependFlag(v vocab.FlagInterface) {
	this.properties = append([]*TagPropertyIterator{{
		FlagMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependFollow(v vocab.FollowInterface) {
	this.properties = append([]*TagPropertyIterator{{
		FollowMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependGroup(v vocab.GroupInterface) {
	this.properties = append([]*TagPropertyIterator{{
		GroupMember: v,
		alias:       this.alias,
		myIdx:       0,
...
func (this *TagProperty) PrependIRI(v *url.URL) {
	this.properties = append([]*TagPropertyIterator{{
		alias:  this.alias,
		iri:    v,
		myIdx:  0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependIgnore(v vocab.IgnoreInterface) {
	this.properties = append([]*TagPropertyIterator{{
		IgnoreMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependImage(v vocab.ImageInterface) {
	this.properties = append([]*TagPropertyIterator{{
		ImageMember: v,
		alias:       this.alias,
		myIdx:       0,
...
func (this *TagProperty) PrependIntransitiveActivity(v vocab.IntransitiveActivityInterface) {
	this.properties = append([]*TagPropertyIterator{{
		IntransitiveActivityMember: v,
		alias:                      this.alias,
		myIdx:                      0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependInvite(v vocab.InviteInterface) {
	this.properties = append([]*TagPropertyIterator{{
		InviteMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// PrependJoin prepends a Join value to the front of a list of the property "tag".
// Invalidates all iterators.
func (this *TagProperty) PrependJoin(v vocab.JoinInterface) {
	this.properties = append([]*TagPropertyIterator{{
		JoinMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependLeave(v vocab.LeaveInterface) {
	this.properties = append([]*TagPropertyIterator{{
		LeaveMember: v,
		alias:       this.alias,
		myIdx:       0,
...
// PrependLike prepends a Like value to the front of a list of the property "tag".
// Invalidates all iterators.
func (this *TagProperty) PrependLike(v vocab.LikeInterface) {
	this.properties = append([]*TagPropertyIterator{{
		LikeMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// PrependLink prepends a Link value to the front of a list of the property "tag".
// Invalidates all iterators.
func (this *TagProperty) PrependLink(v vocab.LinkInterface) {
	this.properties = append([]*TagPropertyIterator{{
		LinkMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependListen(v vocab.ListenInterface) {
	this.properties = append([]*TagPropertyIterator{{
		ListenMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependMention(v vocab.MentionInterface) {
	this.properties = append([]*TagPropertyIterator{{
		MentionMember: v,
		alias:         this.alias,
		myIdx:         0,
...
// PrependMove prepends a Move value to the front of a list of the property "tag".
// Invalidates all iterators.
func (this *TagProperty) PrependMove(v vocab.MoveInterface) {
	this.properties = append([]*TagPropertyIterator{{
		MoveMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// PrependNote prepends a Note value to the front of a list of the property "tag".
// Invalidates all iterators.
func (this *TagProperty) PrependNote(v vocab.NoteInterface) {
	this.properties = append([]*TagPropertyIterator{{
		NoteMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependObject(v vocab.ObjectInterface) {
	this.properties = append([]*TagPropertyIterator{{
		ObjectMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependOffer(v vocab.OfferInterface) {
	this.properties = append([]*TagPropertyIterator{{
		OfferMember: v,
		alias:       this.alias,
		myIdx:       0,
...
func (this *TagProperty) PrependOrderedCollection(v vocab.OrderedCollectionInterface) {
	this.properties = append([]*TagPropertyIterator{{
		OrderedCollectionMember: v,
		alias:                   this.alias,
		myIdx:                   0,
...
func (this *TagProperty) PrependOrderedCollectionPage(v vocab.OrderedCollectionPageInterface) {
	this.properties = append([]*TagPropertyIterator{{
		OrderedCollectionPageMember: v,
		alias:                       this.alias,
		myIdx:                       0,
...
// property "tag". Invalidates all iterators.
func (this *TagProperty) PrependOrganization(v vocab.OrganizationInterface) {
	this.properties = append([]*TagPropertyIterator{{
		OrganizationMember: v,
		alias:              this.alias,
		myIdx:              0,
...
// PrependPage prepends a Page value to the front of a list of the property "tag".
// Invalidates all iterators.
func (this *TagProperty) PrependPage(v vocab.PageInterface) {
	this.properties = append([]*TagPropertyIterator{{
		PageMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependPerson(v vocab.PersonInterface) {
	this.properties = append([]*TagPropertyIterator{{
		PersonMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependPlace(v vocab.PlaceInterface) {
	this.properties = append([]*TagPropertyIterator{{
		PlaceMember: v,
		alias:       this.alias,
		myIdx:       0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependProfile(v vocab.ProfileInterface) {
	this.properties = append([]*TagPropertyIterator{{
		ProfileMember: v,
		alias:         this.alias,
		myIdx:         0,
...
// property "tag". Invalidates all iterators.
func (this *TagProperty) PrependQuestion(v vocab.QuestionInterface) {
	this.properties = append([]*TagPropertyIterator{{
		QuestionMember: v,
		alias:          this.alias,
		myIdx:          0,
...
// PrependRead prepends a Read value to the front of a list of the property "tag".
// Invalidates all iterators.
func (this *TagProperty) PrependRead(v vocab.ReadInterface) {
	this.properties = append([]*TagPropertyIterator{{
		ReadMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependReject(v vocab.RejectInterface) {
	this.properties = append([]*TagPropertyIterator{{
		RejectMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// property "tag". Invalidates all iterators.
func (this *TagProperty) PrependRelationship(v vocab.RelationshipInterface) {
	this.properties = append([]*TagPropertyIterator{{
		RelationshipMember: v,
		alias:              this.alias,
		myIdx:              0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependRemove(v vocab.RemoveInterface) {
	this.properties = append([]*TagPropertyIterator{{
		RemoveMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependService(v vocab.ServiceInterface) {
	this.properties = append([]*TagPropertyIterator{{
		ServiceMember: v,
		alias:         this.alias,
		myIdx:         0,
...
func (this *TagProperty) PrependTentativeAccept(v vocab.TentativeAcceptInterface) {
	this.properties = append([]*TagPropertyIterator{{
		TentativeAcceptMember: v,
		alias:                 this.alias,
		myIdx:                 0,
...
// of the property "tag". Invalidates all iterators.
func (this *TagProperty) PrependTentativeReject(v vocab.TentativeRejectInterface) {
	this.properties = append([]*TagPropertyIterator{{
		TentativeRejectMember: v,
		alias:                 this.alias,
		myIdx:                 0,
...
// property "tag". Invalidates all iterators.
func (this *TagProperty) PrependTombstone(v vocab.TombstoneInterface) {
	this.properties = append([]*TagPropertyIterator{{
		TombstoneMember: v,
		alias:           this.alias,
		myIdx:           0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependTravel(v vocab.TravelInterface) {
	this.properties = append([]*TagPropertyIterator{{
		TravelMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// PrependUndo prepends a Undo value to the front of a list of the property "tag".
// Invalidates all iterators.
func (this *TagProperty) PrependUndo(v vocab.UndoInterface) {
	this.properties = append([]*TagPropertyIterator{{
		UndoMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependUpdate(v vocab.UpdateInterface) {
	this.properties = append([]*TagPropertyIterator{{
		UpdateMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "tag". Invalidates all iterators.
func (this *TagProperty) PrependVideo(v vocab.VideoInterface) {
	this.properties = append([]*TagPropertyIterator{{
		VideoMember: v,
		alias:       this.alias,
		myIdx:       0,
...
// PrependView prepends a View value to the front of a list of the property "tag".
// Invalidates all iterators.
func (this *TagProperty) PrependView(v vocab.ViewInterface) {
	this.properties = append([]*TagPropertyIterator{{
		ViewMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// Invalidates all iterators.
func (this *TagProperty) Remove(idx int) {
	(this.properties)[idx].parent = nil
	copy((this.properties)[idx:], (this.properties)[idx+1:])
	(this.properties)[len(this.properties)-1] = &TagPropertyIterator{}
...
// function as most typical use cases serialize types instead of individual
// properties. It is exposed for alternatives to go-fed implementations to use.
func (this TagProperty) Serialize() (interface{}, error) {
...
func (this *TagProperty) SetAccept(idx int, v vocab.AcceptInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		AcceptMember: v,
		alias:        this.alias,
		myIdx:        idx,
		parent:       this,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetActivity(idx int, v vocab.ActivityInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		ActivityMember: v,
		alias:          this.alias,
...
// SetAdd sets a Add value to be at the specified index for the property "tag".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetAdd(idx int, v vocab.AddInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		AddMember: v,
		alias:     this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetAnnounce(idx int, v vocab.AnnounceInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		AnnounceMember: v,
		alias:          this.alias,
...
// iterators.
func (this *TagProperty) SetApplication(idx int, v vocab.ApplicationInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		ApplicationMember: v,
		alias:             this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetArrive(idx int, v vocab.ArriveInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		ArriveMember: v,
		alias:        this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetArticle(idx int, v vocab.ArticleInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		ArticleMember: v,
		alias:         this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetAudio(idx int, v vocab.AudioInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		AudioMember: v,
		alias:       this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetBlock(idx int, v vocab.BlockInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		BlockMember: v,
		alias:       this.alias,
...
// property "tag". Panics if the index is out of bounds. Invalidates all
// iterators.
func (this *TagProperty) SetCollection(idx int, v vocab.CollectionInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		CollectionMember: v,
		alias:            this.alias,
...
// iterators.
func (this *TagProperty) SetCollectionPage(idx int, v vocab.CollectionPageInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		CollectionPageMember: v,
		alias:                this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetCreate(idx int, v vocab.CreateInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		CreateMember: v,
		alias:        this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetDelete(idx int, v vocab.DeleteInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		DeleteMember: v,
		alias:        this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetDislike(idx int, v vocab.DislikeInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		DislikeMember: v,
		alias:         this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetDocument(idx int, v vocab.DocumentInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		DocumentMember: v,
		alias:          this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetEvent(idx int, v vocab.EventInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		EventMember: v,
		alias:       this.alias,
...
// SetFlag sets a Flag value to be at the specified index for the property "tag".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetFlag(idx int, v vocab.FlagInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		FlagMember: v,
		alias:      this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetFollow(idx int, v vocab.FollowInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		FollowMember: v,
		alias:        this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetGroup(idx int, v vocab.GroupInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		GroupMember: v,
		alias:       this.alias,
...
func (this *TagProperty) SetIRI(idx int, v *url.URL) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		alias:  this.alias,
		iri:    v,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetIgnore(idx int, v vocab.IgnoreInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		IgnoreMember: v,
		alias:        this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetImage(idx int, v vocab.ImageInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		ImageMember: v,
		alias:       this.alias,
...
func (this *TagProperty) SetIntransitiveActivity(idx int, v vocab.IntransitiveActivityInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		IntransitiveActivityMember: v,
		alias:                      this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetInvite(idx int, v vocab.InviteInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		InviteMember: v,
		alias:        this.alias,
...
// SetJoin sets a Join value to be at the specified index for the property "tag".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetJoin(idx int, v vocab.JoinInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		JoinMember: v,
		alias:      this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetLeave(idx int, v vocab.LeaveInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		LeaveMember: v,
		alias:       this.alias,
...
// SetLike sets a Like value to be at the specified index for the property "tag".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetLike(idx int, v vocab.LikeInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		LikeMember: v,
		alias:      this.alias,
...
// SetLink sets a Link value to be at the specified index for the property "tag".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetLink(idx int, v vocab.LinkInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		LinkMember: v,
		alias:      this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetListen(idx int, v vocab.ListenInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		ListenMember: v,
		alias:        this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetMention(idx int, v vocab.MentionInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		MentionMember: v,
		alias:         this.alias,
...
// SetMove sets a Move value to be at the specified index for the property "tag".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetMove(idx int, v vocab.MoveInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		MoveMember: v,
		alias:      this.alias,
...
// SetNote sets a Note value to be at the specified index for the property "tag".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetNote(idx int, v vocab.NoteInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		NoteMember: v,
		alias:      this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetObject(idx int, v vocab.ObjectInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		ObjectMember: v,
		alias:        this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetOffer(idx int, v vocab.OfferInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		OfferMember: v,
		alias:       this.alias,
...
// Invalidates all iterators.
func (this *TagProperty) SetOrderedCollection(idx int, v vocab.OrderedCollectionInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		OrderedCollectionMember: v,
		alias:                   this.alias,
...
// specified index for the property "tag". Panics if the index is out of
// bounds. Invalidates all iterators.
func (this *TagProperty) SetOrderedCollectionPage(idx int, v vocab.OrderedCollectionPageInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		OrderedCollectionPageMember: v,
		alias:                       this.alias,
...
// property "tag". Panics if the index is out of bounds. Invalidates all
// iterators.
func (this *TagProperty) SetOrganization(idx int, v vocab.OrganizationInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		OrganizationMember: v,
		alias:              this.alias,
...
// SetPage sets a Page value to be at the specified index for the property "tag".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetPage(idx int, v vocab.PageInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		PageMember: v,
		alias:      this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetPerson(idx int, v vocab.PersonInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		PersonMember: v,
		alias:        this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetPlace(idx int, v vocab.PlaceInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		PlaceMember: v,
		alias:       this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetProfile(idx int, v vocab.ProfileInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		ProfileMember: v,
		alias:         this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetQuestion(idx int, v vocab.QuestionInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		QuestionMember: v,
		alias:          this.alias,
...
// SetRead sets a Read value to be at the specified index for the property "tag".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetRead(idx int, v vocab.ReadInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		ReadMember: v,
		alias:      this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetReject(idx int, v vocab.RejectInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		RejectMember: v,
		alias:        this.alias,
...
// property "tag". Panics if the index is out of bounds. Invalidates all
// iterators.
func (this *TagProperty) SetRelationship(idx int, v vocab.RelationshipInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		RelationshipMember: v,
		alias:              this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetRemove(idx int, v vocab.RemoveInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		RemoveMember: v,
		alias:        this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetService(idx int, v vocab.ServiceInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		ServiceMember: v,
		alias:         this.alias,
...
// all iterators.
func (this *TagProperty) SetTentativeAccept(idx int, v vocab.TentativeAcceptInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		TentativeAcceptMember: v,
		alias:                 this.alias,
...
// for the property "tag". Panics if the index is out of bounds. Invalidates
// all iterators.
func (this *TagProperty) SetTentativeReject(idx int, v vocab.TentativeRejectInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		TentativeRejectMember: v,
		alias:                 this.alias,
...
// property "tag". Panics if the index is out of bounds. Invalidates all
// iterators.
func (this *TagProperty) SetTombstone(idx int, v vocab.TombstoneInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		TombstoneMember: v,
		alias:           this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetTravel(idx int, v vocab.TravelInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		TravelMember: v,
		alias:        this.alias,
...
// SetUndo sets a Undo value to be at the specified index for the property "tag".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetUndo(idx int, v vocab.UndoInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		UndoMember: v,
		alias:      this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetUpdate(idx int, v vocab.UpdateInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		UpdateMember: v,
		alias:        this.alias,
...
// "tag". Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetVideo(idx int, v vocab.VideoInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		VideoMember: v,
		alias:       this.alias,
...
// SetView sets a View value to be at the specified index for the property "tag".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *TagProperty) SetView(idx int, v vocab.ViewInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &TagPropertyIterator{
		ViewMember: v,
		alias:      this.alias,
...
func (this TagProperty) Swap(i, j int) {
