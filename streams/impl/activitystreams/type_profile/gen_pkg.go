...
type privateManager interface {
	...
	// method for the "DescribesPropertyInterface" non-functional property
	// in the vocabulary "ActivityStreams"
	DeserializeDescribesPropertyActivityStreams() func(map[string]interface{}, map[string]string) (vocab.DescribesPropertyInterface, error)
