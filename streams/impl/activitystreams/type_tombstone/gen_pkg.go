...
type privateManager interface {
	...
	// method for the "DeletedPropertyInterface" non-functional property
	// in the vocabulary "ActivityStreams"
	DeserializeDeletedPropertyActivityStreams() func(map[string]interface{}, map[string]string) (vocab.DeletedPropertyInterface, error)
	...
	// deserialization method for the "FormerTypePropertyInterface"
	// non-functional property in the vocabulary "ActivityStreams"
	DeserializeFormerTypePropertyActivityStreams() func(map[string]interface{}, map[string]string) (vocab.FormerTypePropertyInterface, error)
