...
type Tombstone struct {
	...
	Deleted      vocab.DeletedPropertyInterface
	Duration     vocab.DurationPropertyInterface
	EndTime      vocab.EndTimePropertyInterface
	FormerType   vocab.FormerTypePropertyInterface
...
// TombstoneExtends returns true if the Tombstone type extends from the other type.
func TombstoneExtends(other vocab.Type) bool {
...
func (this Tombstone) GetAltitude() vocab.AltitudePropertyInterface {
	return this.Altitude
}

// GetAttachment returns the "attachment" property if it exists, and nil otherwise.
func (this Tombstone) GetAttachment() vocab.AttachmentPropertyInterface {
	return this.Attachment
}

// GetAttributedTo returns the "attributedTo" property if it exists, and nil
// otherwise.
func (this Tombstone) GetAttributedTo() vocab.AttributedToPropertyInterface {
	return this.AttributedTo
}

// GetAudience returns the "audience" property if it exists, and nil otherwise.
func (this Tombstone) GetAudience() vocab.AudiencePropertyInterface {
	return this.Audience
}

// GetBcc returns the "bcc" property if it exists, and nil otherwise.
func (this Tombstone) GetBcc() vocab.BccPropertyInterface {
	return this.Bcc
}

// GetBto returns the "bto" property if it exists, and nil otherwise.
func (this Tombstone) GetBto() vocab.BtoPropertyInterface {
	return this.Bto
}

// GetCc returns the "cc" property if it exists, and nil otherwise.
func (this Tombstone) GetCc() vocab.CcPropertyInterface {
	return this.Cc
}

// GetContent returns the "content" property if it exists, and nil otherwise.
func (this Tombstone) GetContent() vocab.ContentPropertyInterface {
	return this.Content
}

// GetContext returns the "context" property if it exists, and nil otherwise.
func (this Tombstone) GetContext() vocab.ContextPropertyInterface {
	return this.Context
}

// GetDeleted returns the "deleted" property if it exists, and nil otherwise.
func (this Tombstone) GetDeleted() vocab.DeletedPropertyInterface {
	return this.Deleted
}

// GetDuration returns the "duration" property if it exists, and nil otherwise.
func (this Tombstone) GetDuration() vocab.DurationPropertyInterface {
	return this.Duration
}

// GetEndTime returns the "endTime" property if it exists, and nil otherwise.
func (this Tombstone) GetEndTime() vocab.EndTimePropertyInterface {
	return this.EndTime
}

// GetFormerType returns the "formerType" property if it exists, and nil otherwise.
func (this Tombstone) GetFormerType() vocab.FormerTypePropertyInterface {
	return this.FormerType
}

// GetGenerator returns the "generator" property if it exists, and nil otherwise.
func (this Tombstone) GetGenerator() vocab.GeneratorPropertyInterface {
	return this.Generator
}

// GetIcon returns the "icon" property if it exists, and nil otherwise.
func (this Tombstone) GetIcon() vocab.IconPropertyInterface {
	return this.Icon
}

// GetId returns the "id" property if it exists, and nil otherwise.
func (this Tombstone) GetId() vocab.IdPropertyInterface {
	return this.Id
}

// GetImage returns the "image" property if it exists, and nil otherwise.
func (this Tombstone) GetImage() vocab.ImagePropertyInterface {
	return this.Image
}

// GetInReplyTo returns the "inReplyTo" property if it exists, and nil otherwise.
func (this Tombstone) GetInReplyTo() vocab.InReplyToPropertyInterface {
...
func (this Tombstone) GetMediaType() vocab.MediaTypePropertyInterface {
	return this.MediaType
}

// GetName returns the "name" property if it exists, and nil otherwise.
func (this Tombstone) GetName() vocab.NamePropertyInterface {
	return this.Name
}

// GetObject returns the "object" property if it exists, and nil otherwise.
func (this Tombstone) GetObject() vocab.ObjectPropertyInterface {
	return this.Object
}

// GetPreview returns the "preview" property if it exists, and nil otherwise.
func (this Tombstone) GetPreview() vocab.PreviewPropertyInterface {
	return this.Preview
}

// GetPublished returns the "published" property if it exists, and nil otherwise.
func (this Tombstone) GetPublished() vocab.PublishedPropertyInterface {
...
func (this Tombstone) GetStartTime() vocab.StartTimePropertyInterface {
	return this.StartTime
}

// GetSummary returns the "summary" property if it exists, and nil otherwise.
func (this Tombstone) GetSummary() vocab.SummaryPropertyInterface {
	return this.Summary
}

// GetTag returns the "tag" property if it exists, and nil otherwise.
func (this Tombstone) GetTag() vocab.TagPropertyInterface {
	return this.Tag
}

// GetTo returns the "to" property if it exists, and nil otherwise.
func (this Tombstone) GetTo() vocab.ToPropertyInterface {
	return this.To
}

// GetType returns the "type" property if it exists, and nil otherwise.
func (this Tombstone) GetType() vocab.TypePropertyInterface {
	return this.Type
}
...
func (this Tombstone) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Tombstone) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Tombstone) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Tombstone type extends from the other type.
func (this Tombstone) IsExtending(other vocab.Type) bool {
	return TombstoneExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Tombstone) JSONLDContext() map[string]string {
	...
	m = this.helperJSONLDContext(this.Deleted, m)
	m = this.helperJSONLDContext(this.Duration, m)
	m = this.helperJSONLDContext(this.EndTime, m)
	m = this.helperJSONLDContext(this.FormerType, m)
...
// determination.
func (this Tombstone) LessThan(o vocab.TombstoneInterface) bool {
	...
	if this.Deleted.LessThan(o.GetDeleted()) {
		return true
	} else if o.GetDeleted().LessThan(this.Deleted) {
		return false
	}
	...
	if this.FormerType.LessThan(o.GetFormerType()) {
		return true
	} else if o.GetFormerType().LessThan(this.FormerType) {
		return false
	}
...
func (this Tombstone) Serialize() (interface{}, error) {
	...
	if i, err := this.Deleted.Serialize(); err != nil {
		return nil, err
	} else if i != nil {
		m[this.Deleted.Name()] = i
	}
	...
	if i, err := this.FormerType.Serialize(); err != nil {
		return nil, err
	} else if i != nil {
		m[this.FormerType.Name()] = i
	}
...
// if it is not nil.
func (this Tombstone) helperJSONLDContext(i jsonldContexter, toMerge map[string]string) map[string]string {
	if i == nil {
		return toMerge
	}
