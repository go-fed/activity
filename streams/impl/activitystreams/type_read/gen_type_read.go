...
// DeserializeRead creates a Read from a map representation that has been
// unmarshalled from a text or binary format.
func DeserializeRead(m map[string]interface{}, aliasMap map[string]string) (*Read, error) {
	alias := ""
	aliasPrefix := ""
...
// ReadExtends returns true if the Read type extends from the other type.
func ReadExtends(other vocab.Type) bool {
...
func (this Read) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Read) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Read) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Read type extends from the other type.
func (this Read) IsExtending(other vocab.Type) bool {
	return ReadExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Read) JSONLDContext() map[string]string {
...
// determination.
func (this Read) LessThan(o vocab.ReadInterface) bool {
...
func (this Read) Serialize() (map[string]interface{}, error) {
	m := make(map[string]interface{})
	typeName := "Read"
	if len(this.alias) > 0 {
		typeName = this.alias + ":" + "Read"
	}
	m["type"] = typeName
