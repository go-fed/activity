...
// ActivityStreamsReadExtends returns true if the Read type extends from the other
// type.
...
func (this ActivityStreamsRead) GetActivityStreamsId() vocab.ActivityStreamsIdProperty {
...
// otherwise.
func (this ActivityStreamsRead) GetActivityStreamsType() vocab.ActivityStreamsTypeProperty {
...
func (this ActivityStreamsRead) IsExtending(other vocab.Type) bool {
	return ActivityStreamsReadExtends(other)
}
...
// determination.
func (this ActivityStreamsRead) LessThan(o vocab.ActivityStreamsRead) bool {
...
func (this *ActivityStreamsRead) SetActivityStreamsId(i vocab.ActivityStreamsIdProperty) {
...
// otherwise.
func (this *ActivityStreamsRead) SetActivityStreamsType(i vocab.ActivityStreamsTypeProperty) {
...
// if it is not nil.
func (this ActivityStreamsRead) helperJSONLDContext(i jsonldContexter, toMerge map[string]string) map[string]string {
	if i == nil {
		return toMerge
	}
