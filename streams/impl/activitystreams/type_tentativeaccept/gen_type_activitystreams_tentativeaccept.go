...
func (this ActivityStreamsTentativeAccept) GetJSONLDId() vocab.JSONLDIdProperty {
	return this.JSONLDId
}

// GetJSONLDType returns the "type" property if it exists, and nil otherwise.
func (this ActivityStreamsTentativeAccept) GetJSONLDType() vocab.JSONLDTypeProperty {
...
func (this *ActivityStreamsTentativeAccept) SetJSONLDId(i vocab.JSONLDIdProperty) {
	this.JSONLDId = i
}

// SetJSONLDType sets the "type" property.
func (this *ActivityStreamsTentativeAccept) SetJSONLDType(i vocab.JSONLDTypeProperty) {
	this.JSONLDType = i
}
