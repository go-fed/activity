...
// TentativeAcceptExtends returns true if the TentativeAccept type extends from
// the other type.
func TentativeAcceptExtends(other vocab.Type) bool {
...
func (this TentativeAccept) GetMediaType() vocab.MediaTypePropertyInterface {
	return this.MediaType
}

// GetName returns the "name" property if it exists, and nil otherwise.
func (this TentativeAccept) GetName() vocab.NamePropertyInterface {
	return this.Name
}

// GetObject returns the "object" property if it exists, and nil otherwise.
func (this TentativeAccept) GetObject() vocab.ObjectPropertyInterface {
	return this.Object
}

// GetOrigin returns the "origin" property if it exists, and nil otherwise.
func (this TentativeAccept) GetOrigin() vocab.OriginPropertyInterface {
	return this.Origin
}

// GetPreview returns the "preview" property if it exists, and nil otherwise.
func (this TentativeAccept) GetPreview() vocab.PreviewPropertyInterface {
	return this.Preview
}

// GetPublished returns the "published" property if it exists, and nil otherwise.
func (this TentativeAccept) GetPublished() vocab.PublishedPropertyInterface {
	return this.Published
}

// GetReplies returns the "replies" property if it exists, and nil otherwise.
func (this TentativeAccept) GetReplies() vocab.RepliesPropertyInterface {
	return this.Replies
}
...
func (this TentativeAccept) GetStartTime() vocab.StartTimePropertyInterface {
	return this.StartTime
}

// GetSummary returns the "summary" property if it exists, and nil otherwise.
func (this TentativeAccept) GetSummary() vocab.SummaryPropertyInterface {
	return this.Summary
}

// GetTag returns the "tag" property if it exists, and nil otherwise.
func (this TentativeAccept) GetTag() vocab.TagPropertyInterface {
	return this.Tag
}

// GetTarget returns the "target" property if it exists, and nil otherwise.
func (this TentativeAccept) GetTarget() vocab.TargetPropertyInterface {
	return this.Target
}

// GetTo returns the "to" property if it exists, and nil otherwise.
func (this TentativeAccept) GetTo() vocab.ToPropertyInterface {
	return this.To
}

// GetType returns the "type" property if it exists, and nil otherwise.
func (this TentativeAccept) GetType() vocab.TypePropertyInterface {
	return this.Type
}
...
func (this TentativeAccept) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this TentativeAccept) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this TentativeAccept) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the TentativeAccept type extends from the other
// type.
func (this TentativeAccept) IsExtending(other vocab.Type) bool {
	return TentativeAcceptExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this TentativeAccept) JSONLDContext() map[string]string {
...
func (this TentativeAccept) LessThan(o vocab.TentativeAcceptInterface) bool {
...
func (this TentativeAccept) Serialize() (interface{}, error) {
...
// if it is not nil.
func (this TentativeAccept) helperJSONLDContext(i jsonldContexter, toMerge map[string]string) map[string]string {
	if i == nil {
		return toMerge
	}
