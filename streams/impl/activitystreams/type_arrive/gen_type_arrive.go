...
func DeserializeArrive(m map[string]interface{}, aliasMap map[string]string) (*Arrive, error) {
	alias := ""
	aliasPrefix := ""
...
func (this Arrive) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Arrive) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Arrive) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Arrive type extends from the other type.
func (this Arrive) IsExtending(other vocab.Type) bool {
	return ArriveExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Arrive) JSONLDContext() map[string]string {
...
// determination.
func (this Arrive) LessThan(o vocab.ArriveInterface) bool {
...
func (this Arrive) Serialize() (map[string]interface{}, error) {
