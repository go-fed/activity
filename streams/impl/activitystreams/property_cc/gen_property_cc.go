...
// CcPropertyIterator is an iterator for a property. It is permitted to be one of
...
type CcPropertyIterator struct {
	...
	alias                       string
	myIdx                       int
	parent                      vocab.CcPropertyInterface
}

// NewCcPropertyIterator creates a new cc property.
func NewCcPropertyIterator() *CcPropertyIterator {
	return &CcPropertyIterator{alias: ""}
}

// deserializeCcPropertyIterator creates an iterator from an element that has been
// unmarshalled from a text or binary format.
func deserializeCcPropertyIterator(i interface{}, aliasMap map[string]string) (*CcPropertyIterator, error) {
	alias := ""
...
func (this CcPropertyIterator) GetAccept() vocab.AcceptInterface {
...
func (this CcPropertyIterator) GetActivity() vocab.ActivityInterface {
	return this.ActivityMember
}

// GetAdd returns the value of this property. When IsAdd returns false, GetAdd
// will return an arbitrary value.
func (this CcPropertyIterator) GetAdd() vocab.AddInterface {
...
func (this CcPropertyIterator) GetAnnounce() vocab.AnnounceInterface {
...
func (this CcPropertyIterator) GetApplication() vocab.ApplicationInterface {
...
func (this CcPropertyIterator) GetArrive() vocab.ArriveInterface {
...
func (this CcPropertyIterator) GetArticle() vocab.ArticleInterface {
...
func (this CcPropertyIterator) GetAudio() vocab.AudioInterface {
...
func (this CcPropertyIterator) GetBlock() vocab.BlockInterface {
...
func (this CcPropertyIterator) GetCollection() vocab.CollectionInterface {
...
func (this CcPropertyIterator) GetCollectionPage() vocab.CollectionPageInterface {
...
func (this CcPropertyIterator) GetCreate() vocab.CreateInterface {
	return this.CreateMember
}

// GetDelete returns the value of this property. When IsDelete returns false,
// GetDelete will return an arbitrary value.
func (this CcPropertyIterator) GetDelete() vocab.DeleteInterface {
...
func (this CcPropertyIterator) GetDislike() vocab.DislikeInterface {
...
func (this CcPropertyIterator) GetDocument() vocab.DocumentInterface {
...
func (this CcPropertyIterator) GetEvent() vocab.EventInterface {
	return this.EventMember
}

// GetFlag returns the value of this property. When IsFlag returns false, GetFlag
// will return an arbitrary value.
func (this CcPropertyIterator) GetFlag() vocab.FlagInterface {
...
func (this CcPropertyIterator) GetFollow() vocab.FollowInterface {
...
func (this CcPropertyIterator) GetGroup() vocab.GroupInterface {
	return this.GroupMember
}

// GetIRI returns the IRI of this property. When IsIRI returns false, GetIRI will
// return an arbitrary value.
func (this CcPropertyIterator) GetIRI() *url.URL {
	return this.iri
}

// GetIgnore returns the value of this property. When IsIgnore returns false,
// GetIgnore will return an arbitrary value.
func (this CcPropertyIterator) GetIgnore() vocab.IgnoreInterface {
...
func (this CcPropertyIterator) GetImage() vocab.ImageInterface {
...
// an arbitrary value.
func (this CcPropertyIterator) GetIntransitiveActivity() vocab.IntransitiveActivityInterface {
...
func (this CcPropertyIterator) GetInvite() vocab.InviteInterface {
	return this.InviteMember
}

// GetJoin returns the value of this property. When IsJoin returns false, GetJoin
// will return an arbitrary value.
func (this CcPropertyIterator) GetJoin() vocab.JoinInterface {
...
func (this CcPropertyIterator) GetListen() vocab.ListenInterface {
...
func (this CcPropertyIterator) GetObject() vocab.ObjectInterface {
...
func (this CcPropertyIterator) GetOffer() vocab.OfferInterface {
...
// arbitrary value.
func (this CcPropertyIterator) GetOrderedCollection() vocab.OrderedCollectionInterface {
...
// an arbitrary value.
func (this CcPropertyIterator) GetOrderedCollectionPage() vocab.OrderedCollectionPageInterface {
...
func (this CcPropertyIterator) GetOrganization() vocab.OrganizationInterface {
	return this.OrganizationMember
}

// GetPage returns the value of this property. When IsPage returns false, GetPage
// will return an arbitrary value.
func (this CcPropertyIterator) GetPage() vocab.PageInterface {
...
func (this CcPropertyIterator) GetPerson() vocab.PersonInterface {
...
func (this CcPropertyIterator) GetPlace() vocab.PlaceInterface {
...
func (this CcPropertyIterator) GetProfile() vocab.ProfileInterface {
...
func (this CcPropertyIterator) GetQuestion() vocab.QuestionInterface {
	return this.QuestionMember
}

// GetRead returns the value of this property. When IsRead returns false, GetRead
// will return an arbitrary value.
func (this CcPropertyIterator) GetRead() vocab.ReadInterface {
...
func (this CcPropertyIterator) GetReject() vocab.RejectInterface {
...
func (this CcPropertyIterator) GetRelationship() vocab.RelationshipInterface {
...
func (this CcPropertyIterator) GetRemove() vocab.RemoveInterface {
	return this.RemoveMember
}

// GetService returns the value of this property. When IsService returns false,
// GetService will return an arbitrary value.
func (this CcPropertyIterator) GetService() vocab.ServiceInterface {
...
func (this CcPropertyIterator) GetTentativeAccept() vocab.TentativeAcceptInterface {
...
func (this CcPropertyIterator) GetTentativeReject() vocab.TentativeRejectInterface {
...
func (this CcPropertyIterator) GetTombstone() vocab.TombstoneInterface {
...
func (this CcPropertyIterator) GetTravel() vocab.TravelInterface {
	return this.TravelMember
}

// GetUndo returns the value of this property. When IsUndo returns false, GetUndo
// will return an arbitrary value.
func (this CcPropertyIterator) GetUndo() vocab.UndoInterface {
...
func (this CcPropertyIterator) IsAccept() bool {
...
func (this CcPropertyIterator) IsActivity() bool {
...
func (this CcPropertyIterator) IsAdd() bool {
...
func (this CcPropertyIterator) IsAnnounce() bool {
...
// this property.
func (this CcPropertyIterator) IsApplication() bool {
...
func (this CcPropertyIterator) IsArrive() bool {
...
func (this CcPropertyIterator) IsArticle() bool {
...
func (this CcPropertyIterator) IsAudio() bool {
...
func (this CcPropertyIterator) IsBlock() bool {
...
// this property.
func (this CcPropertyIterator) IsCollection() bool {
...
func (this CcPropertyIterator) IsCollectionPage() bool {
...
func (this CcPropertyIterator) IsCreate() bool {
...
func (this CcPropertyIterator) IsDelete() bool {
...
func (this CcPropertyIterator) IsDislike() bool {
...
func (this CcPropertyIterator) IsDocument() bool {
...
func (this CcPropertyIterator) IsEvent() bool {
...
func (this CcPropertyIterator) IsFlag() bool {
...
func (this CcPropertyIterator) IsFollow() bool {
...
func (this CcPropertyIterator) IsGroup() bool {
	return this.GroupMember != nil
}

// IsIRI returns true if this property is an IRI. When true, use GetIRI and SetIRI
// to access and set this property
func (this CcPropertyIterator) IsIRI() bool {
	return this.iri != nil
}
...
func (this CcPropertyIterator) IsIgnore() bool {
...
func (this CcPropertyIterator) IsImage() bool {
...
func (this CcPropertyIterator) IsIntransitiveActivity() bool {
...
func (this CcPropertyIterator) IsInvite() bool {
...
func (this CcPropertyIterator) IsJoin() bool {
...
func (this CcPropertyIterator) IsLeave() bool {
...
func (this CcPropertyIterator) IsLike() bool {
...
func (this CcPropertyIterator) IsLink() bool {
...
func (this CcPropertyIterator) IsListen() bool {
...
func (this CcPropertyIterator) IsMention() bool {
...
func (this CcPropertyIterator) IsMove() bool {
...
func (this CcPropertyIterator) IsNote() bool {
...
func (this CcPropertyIterator) IsObject() bool {
...
func (this CcPropertyIterator) IsOffer() bool {
...
func (this CcPropertyIterator) IsOrderedCollection() bool {
...
func (this CcPropertyIterator) IsOrderedCollectionPage() bool {
...
// this property.
func (this CcPropertyIterator) IsOrganization() bool {
...
func (this CcPropertyIterator) IsPage() bool {
...
func (this CcPropertyIterator) IsPerson() bool {
...
func (this CcPropertyIterator) IsPlace() bool {
...
func (this CcPropertyIterator) IsProfile() bool {
...
func (this CcPropertyIterator) IsQuestion() bool {
...
func (this CcPropertyIterator) IsRead() bool {
...
func (this CcPropertyIterator) IsReject() bool {
...
// this property.
func (this CcPropertyIterator) IsRelationship() bool {
...
func (this CcPropertyIterator) IsRemove() bool {
...
func (this CcPropertyIterator) IsService() bool {
...
func (this CcPropertyIterator) IsTentativeAccept() bool {
...
func (this CcPropertyIterator) IsTentativeReject() bool {
...
// property.
func (this CcPropertyIterator) IsTombstone() bool {
...
func (this CcPropertyIterator) IsTravel() bool {
...
func (this CcPropertyIterator) IsUndo() bool {
...
func (this CcPropertyIterator) IsUpdate() bool {
...
func (this CcPropertyIterator) IsVideo() bool {
...
func (this CcPropertyIterator) IsView() bool {
...
func (this CcPropertyIterator) JSONLDContext() map[string]string {
...
func (this CcPropertyIterator) KindIndex() int {
	if this.IsObject() {
		return 0
	}
	if this.IsLink() {
...
func (this CcPropertyIterator) LessThan(o vocab.CcPropertyIteratorInterface) bool {
	idx1 := this.KindIndex()
	idx2 := o.KindIndex()
	if idx1 < idx2 {
		return true
...
func (this CcPropertyIterator) Name() string {
	return "cc"
}

// Next returns the next iterator, or nil if there is no next iterator.
func (this CcPropertyIterator) Next() vocab.CcPropertyIteratorInterface {
...
func (this CcPropertyIterator) Prev() vocab.CcPropertyIteratorInterface {
	if this.myIdx-1 < 0 {
		return nil
	} else {
		return this.parent.At(this.myIdx - 1)
...
// true.
func (this *CcPropertyIterator) SetAccept(v vocab.AcceptInterface) {
	this.clear()
	this.AcceptMember = v
}
...
// returns true.
func (this *CcPropertyIterator) SetActivity(v vocab.ActivityInterface) {
	this.clear()
	this.ActivityMember = v
}

// SetAdd sets the value of this property. Calling IsAdd afterwards returns true.
func (this *CcPropertyIterator) SetAdd(v vocab.AddInterface) {
	this.clear()
	this.AddMember = v
}
...
// returns true.
func (this *CcPropertyIterator) SetAnnounce(v vocab.AnnounceInterface) {
	this.clear()
...
func (this *CcPropertyIterator) SetApplication(v vocab.ApplicationInterface) {
	this.clear()
...
// true.
func (this *CcPropertyIterator) SetArrive(v vocab.ArriveInterface) {
	this.clear()
	this.ArriveMember = v
}
...
// returns true.
func (this *CcPropertyIterator) SetArticle(v vocab.ArticleInterface) {
	this.clear()
...
// true.
func (this *CcPropertyIterator) SetAudio(v vocab.AudioInterface) {
	this.clear()
	this.AudioMember = v
}
...
// true.
func (this *CcPropertyIterator) SetBlock(v vocab.BlockInterface) {
	this.clear()
	this.BlockMember = v
}
...
// returns true.
func (this *CcPropertyIterator) SetCollection(v vocab.CollectionInterface) {
	this.clear()
...
// afterwards returns true.
func (this *CcPropertyIterator) SetCollectionPage(v vocab.CollectionPageInterface) {
	this.clear()
...
// true.
func (this *CcPropertyIterator) SetCreate(v vocab.CreateInterface) {
	this.clear()
	this.CreateMember = v
}
...
// true.
func (this *CcPropertyIterator) SetDelete(v vocab.DeleteInterface) {
	this.clear()
	this.DeleteMember = v
}
...
// returns true.
func (this *CcPropertyIterator) SetDislike(v vocab.DislikeInterface) {
	this.clear()
...
// returns true.
func (this *CcPropertyIterator) SetDocument(v vocab.DocumentInterface) {
	this.clear()
...
// true.
func (this *CcPropertyIterator) SetEvent(v vocab.EventInterface) {
	this.clear()
	this.EventMember = v
}

// SetFlag sets the value of this property. Calling IsFlag afterwards returns true.
func (this *CcPropertyIterator) SetFlag(v vocab.FlagInterface) {
	this.clear()
	this.FlagMember = v
}
...
// true.
func (this *CcPropertyIterator) SetFollow(v vocab.FollowInterface) {
	this.clear()
	this.FollowMember = v
}
...
// true.
func (this *CcPropertyIterator) SetGroup(v vocab.GroupInterface) {
	this.clear()
	this.GroupMember = v
}

// SetIRI sets the value of this property. Calling IsIRI afterwards returns true.
func (this *CcPropertyIterator) SetIRI(v *url.URL) {
	this.clear()
	this.iri = v
}
...
// true.
func (this *CcPropertyIterator) SetIgnore(v vocab.IgnoreInterface) {
	this.clear()
	this.IgnoreMember = v
}
...
// true.
func (this *CcPropertyIterator) SetImage(v vocab.ImageInterface) {
	this.clear()
	this.ImageMember = v
}
...
func (this *CcPropertyIterator) SetIntransitiveActivity(v vocab.IntransitiveActivityInterface) {
	this.clear()
...
// true.
func (this *CcPropertyIterator) SetInvite(v vocab.InviteInterface) {
	this.clear()
	this.InviteMember = v
}

// SetJoin sets the value of this property. Calling IsJoin afterwards returns true.
func (this *CcPropertyIterator) SetJoin(v vocab.JoinInterface) {
	this.clear()
	this.JoinMember = v
}
...
// true.
func (this *CcPropertyIterator) SetLeave(v vocab.LeaveInterface) {
	this.clear()
	this.LeaveMember = v
}

// SetLike sets the value of this property. Calling IsLike afterwards returns true.
func (this *CcPropertyIterator) SetLike(v vocab.LikeInterface) {
	this.clear()
	this.LikeMember = v
}

// SetLink sets the value of this property. Calling IsLink afterwards returns true.
func (this *CcPropertyIterator) SetLink(v vocab.LinkInterface) {
	this.clear()
	this.LinkMember = v
}
...
// true.
func (this *CcPropertyIterator) SetListen(v vocab.ListenInterface) {
	this.clear()
	this.ListenMember = v
}
...
// returns true.
func (this *CcPropertyIterator) SetMention(v vocab.MentionInterface) {
	this.clear()
	this.MentionMember = v
}

// SetMove sets the value of this property. Calling IsMove afterwards returns true.
func (this *CcPropertyIterator) SetMove(v vocab.MoveInterface) {
	this.clear()
	this.MoveMember = v
}

// SetNote sets the value of this property. Calling IsNote afterwards returns true.
func (this *CcPropertyIterator) SetNote(v vocab.NoteInterface) {
	this.clear()
	this.NoteMember = v
}
...
// true.
func (this *CcPropertyIterator) SetObject(v vocab.ObjectInterface) {
	this.clear()
	this.ObjectMember = v
}
...
// true.
func (this *CcPropertyIterator) SetOffer(v vocab.OfferInterface) {
	this.clear()
	this.OfferMember = v
}
...
func (this *CcPropertyIterator) SetOrderedCollection(v vocab.OrderedCollectionInterface) {
	this.clear()
...
func (this *CcPropertyIterator) SetOrderedCollectionPage(v vocab.OrderedCollectionPageInterface) {
	this.clear()
...
// afterwards returns true.
func (this *CcPropertyIterator) SetOrganization(v vocab.OrganizationInterface) {
	this.clear()
	this.OrganizationMember = v
}

// SetPage sets the value of this property. Calling IsPage afterwards returns true.
func (this *CcPropertyIterator) SetPage(v vocab.PageInterface) {
	this.clear()
	this.PageMember = v
}
...
// true.
func (this *CcPropertyIterator) SetPerson(v vocab.PersonInterface) {
	this.clear()
	this.PersonMember = v
}
...
// true.
func (this *CcPropertyIterator) SetPlace(v vocab.PlaceInterface) {
	this.clear()
	this.PlaceMember = v
}
...
// returns true.
func (this *CcPropertyIterator) SetProfile(v vocab.ProfileInterface) {
	this.clear()
...
// returns true.
func (this *CcPropertyIterator) SetQuestion(v vocab.QuestionInterface) {
	this.clear()
	this.QuestionMember = v
}

// SetRead sets the value of this property. Calling IsRead afterwards returns true.
func (this *CcPropertyIterator) SetRead(v vocab.ReadInterface) {
	this.clear()
	this.ReadMember = v
}
...
// true.
func (this *CcPropertyIterator) SetReject(v vocab.RejectInterface) {
	this.clear()
	this.RejectMember = v
}
...
// afterwards returns true.
func (this *CcPropertyIterator) SetRelationship(v vocab.RelationshipInterface) {
	this.clear()
...
// true.
func (this *CcPropertyIterator) SetRemove(v vocab.RemoveInterface) {
	this.clear()
	this.RemoveMember = v
}
...
// returns true.
func (this *CcPropertyIterator) SetService(v vocab.ServiceInterface) {
	this.clear()
...
// afterwards returns true.
func (this *CcPropertyIterator) SetTentativeAccept(v vocab.TentativeAcceptInterface) {
	this.clear()
...
// afterwards returns true.
func (this *CcPropertyIterator) SetTentativeReject(v vocab.TentativeRejectInterface) {
	this.clear()
...
// returns true.
func (this *CcPropertyIterator) SetTombstone(v vocab.TombstoneInterface) {
	this.clear()
...
// true.
func (this *CcPropertyIterator) SetTravel(v vocab.TravelInterface) {
	this.clear()
	this.TravelMember = v
}

// SetUndo sets the value of this property. Calling IsUndo afterwards returns true.
func (this *CcPropertyIterator) SetUndo(v vocab.UndoInterface) {
	this.clear()
	this.UndoMember = v
}
...
// true.
func (this *CcPropertyIterator) SetUpdate(v vocab.UpdateInterface) {
	this.clear()
	this.UpdateMember = v
}
...
// true.
func (this *CcPropertyIterator) SetVideo(v vocab.VideoInterface) {
	this.clear()
	this.VideoMember = v
}

// SetView sets the value of this property. Calling IsView afterwards returns true.
func (this *CcPropertyIterator) SetView(v vocab.ViewInterface) {
	this.clear()
	this.ViewMember = v
}
...
func (this *CcPropertyIterator) clear() {
...
func (this CcPropertyIterator) serialize() (interface{}, error) {
	if this.IsObject() {
...
func DeserializeCcProperty(m map[string]interface{}, aliasMap map[string]string) (vocab.CcPropertyInterface, error) {
	alias := ""
	if a, ok := aliasMap["https://www.w3.org/TR/activitystreams-vocabulary"]; ok {
		alias = a
	}
	...
	if ok {
		...
		if list, ok := i.([]interface{}); ok {
			for _, iterator := range list {
				if p, err := deserializeCcPropertyIterator(iterator, aliasMap); err != nil {
					return this, err
				} else if p != nil {
			...
			if p, err := deserializeCcPropertyIterator(i, aliasMap); err != nil {
				return this, err
			} else if p != nil {
				this.properties = append(this.properties, p)
			}
...
// NewCcProperty creates a new cc property.
func NewCcProperty() *CcProperty {
	return &CcProperty{alias: ""}
}

// AppendAccept appends a Accept value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendAccept(v vocab.AcceptInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		AcceptMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
		parent:       this,
...
func (this *CcProperty) AppendActivity(v vocab.ActivityInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		ActivityMember: v,
		alias:          this.alias,
		myIdx:          this.Len(),
...
// AppendAdd appends a Add value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendAdd(v vocab.AddInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		AddMember: v,
		alias:     this.alias,
		myIdx:     this.Len(),
...
// "cc". Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendAnnounce(v vocab.AnnounceInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		AnnounceMember: v,
		alias:          this.alias,
		myIdx:          this.Len(),
...
func (this *CcProperty) AppendApplication(v vocab.ApplicationInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		ApplicationMember: v,
		alias:             this.alias,
		myIdx:             this.Len(),
...
// AppendArrive appends a Arrive value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendArrive(v vocab.ArriveInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		ArriveMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// "cc". Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendArticle(v vocab.ArticleInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		ArticleMember: v,
		alias:         this.alias,
		myIdx:         this.Len(),
...
// AppendAudio appends a Audio value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendAudio(v vocab.AudioInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		AudioMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// AppendBlock appends a Block value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendBlock(v vocab.BlockInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		BlockMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// property "cc". Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendCollection(v vocab.CollectionInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		CollectionMember: v,
		alias:            this.alias,
		myIdx:            this.Len(),
...
func (this *CcProperty) AppendCollectionPage(v vocab.CollectionPageInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		CollectionPageMember: v,
		alias:                this.alias,
		myIdx:                this.Len(),
...
// AppendCreate appends a Create value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendCreate(v vocab.CreateInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		CreateMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendDelete appends a Delete value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendDelete(v vocab.DeleteInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		DeleteMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// "cc". Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendDislike(v vocab.DislikeInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		DislikeMember: v,
		alias:         this.alias,
		myIdx:         this.Len(),
...
// "cc". Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendDocument(v vocab.DocumentInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		DocumentMember: v,
		alias:          this.alias,
		myIdx:          this.Len(),
...
// AppendEvent appends a Event value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendEvent(v vocab.EventInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		EventMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// AppendFlag appends a Flag value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendFlag(v vocab.FlagInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		FlagMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendFollow appends a Follow value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendFollow(v vocab.FollowInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		FollowMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendGroup appends a Group value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendGroup(v vocab.GroupInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		GroupMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
func (this *CcProperty) AppendIRI(v *url.URL) {
	this.properties = append(this.properties, &CcPropertyIterator{
		alias:  this.alias,
		iri:    v,
		myIdx:  this.Len(),
...
// AppendIgnore appends a Ignore value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendIgnore(v vocab.IgnoreInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		IgnoreMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendImage appends a Image value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendImage(v vocab.ImageInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		ImageMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// using Prev.
func (this *CcProperty) AppendIntransitiveActivity(v vocab.IntransitiveActivityInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		IntransitiveActivityMember: v,
		alias:                      this.alias,
		myIdx:                      this.Len(),
...
// AppendInvite appends a Invite value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendInvite(v vocab.InviteInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		InviteMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendJoin appends a Join value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendJoin(v vocab.JoinInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		JoinMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendLeave appends a Leave value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendLeave(v vocab.LeaveInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		LeaveMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// AppendLike appends a Like value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendLike(v vocab.LikeInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		LikeMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendLink appends a Link value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendLink(v vocab.LinkInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		LinkMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendListen appends a Listen value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendListen(v vocab.ListenInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		ListenMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// "cc". Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendMention(v vocab.MentionInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		MentionMember: v,
		alias:         this.alias,
		myIdx:         this.Len(),
...
// AppendMove appends a Move value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendMove(v vocab.MoveInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		MoveMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendNote appends a Note value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendNote(v vocab.NoteInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		NoteMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendObject appends a Object value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendObject(v vocab.ObjectInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		ObjectMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendOffer appends a Offer value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendOffer(v vocab.OfferInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		OfferMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
func (this *CcProperty) AppendOrderedCollection(v vocab.OrderedCollectionInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		OrderedCollectionMember: v,
		alias:                   this.alias,
		myIdx:                   this.Len(),
...
// using Prev.
func (this *CcProperty) AppendOrderedCollectionPage(v vocab.OrderedCollectionPageInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		OrderedCollectionPageMember: v,
		alias:                       this.alias,
		myIdx:                       this.Len(),
...
// property "cc". Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendOrganization(v vocab.OrganizationInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		OrganizationMember: v,
		alias:              this.alias,
		myIdx:              this.Len(),
...
// AppendPage appends a Page value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendPage(v vocab.PageInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		PageMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendPerson appends a Person value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendPerson(v vocab.PersonInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		PersonMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendPlace appends a Place value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendPlace(v vocab.PlaceInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		PlaceMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// "cc". Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendProfile(v vocab.ProfileInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		ProfileMember: v,
		alias:         this.alias,
		myIdx:         this.Len(),
...
// "cc". Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendQuestion(v vocab.QuestionInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		QuestionMember: v,
		alias:          this.alias,
		myIdx:          this.Len(),
...
// AppendRead appends a Read value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendRead(v vocab.ReadInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		ReadMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendReject appends a Reject value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendReject(v vocab.RejectInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		RejectMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// property "cc". Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendRelationship(v vocab.RelationshipInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		RelationshipMember: v,
		alias:              this.alias,
		myIdx:              this.Len(),
...
// AppendRemove appends a Remove value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendRemove(v vocab.RemoveInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		RemoveMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// "cc". Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendService(v vocab.ServiceInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		ServiceMember: v,
		alias:         this.alias,
		myIdx:         this.Len(),
...
// the property "cc". Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendTentativeAccept(v vocab.TentativeAcceptInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		TentativeAcceptMember: v,
		alias:                 this.alias,
		myIdx:                 this.Len(),
...
// the property "cc". Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendTentativeReject(v vocab.TentativeRejectInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		TentativeRejectMember: v,
		alias:                 this.alias,
		myIdx:                 this.Len(),
...
// "cc". Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendTombstone(v vocab.TombstoneInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		TombstoneMember: v,
		alias:           this.alias,
		myIdx:           this.Len(),
...
// AppendTravel appends a Travel value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendTravel(v vocab.TravelInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		TravelMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendUndo appends a Undo value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendUndo(v vocab.UndoInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		UndoMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendUpdate appends a Update value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendUpdate(v vocab.UpdateInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		UpdateMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendVideo appends a Video value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendVideo(v vocab.VideoInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		VideoMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// AppendView appends a View value to the back of a list of the property "cc".
// Invalidates iterators that are traversing using Prev.
func (this *CcProperty) AppendView(v vocab.ViewInterface) {
	this.properties = append(this.properties, &CcPropertyIterator{
		ViewMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// out of bounds.
func (this CcProperty) At(index int) vocab.CcPropertyIteratorInterface {
...
func (this CcProperty) Begin() vocab.CcPropertyIteratorInterface {
	if this.Empty() {
		return nil
	} else {
...
func (this CcProperty) Empty() bool {
	return this.Len() == 0
}
...
func (this CcProperty) End() vocab.CcPropertyIteratorInterface {
	return nil
}
...
// property and the specific values that are set. The value in the map is the
// alias used to import the property's value or values.
func (this CcProperty) JSONLDContext() map[string]string {
	m := map[string]string{"https://www.w3.org/TR/activitystreams-vocabulary": this.alias}
...
// out of bounds.
func (this CcProperty) KindIndex(idx int) int {
	return this.properties[idx].KindIndex()
}

// Len returns the number of values that exist for the "cc" property.
func (this CcProperty) Len() (length int) {
	return len(this.properties)
}

// Less computes whether another property is less than this one. Mixing types
// results in a consistent but arbitrary ordering
func (this CcProperty) Less(i, j int) bool {
...
// help alternative implementations to go-fed to be able to normalize
// nonfunctional properties.
func (this CcProperty) LessThan(o vocab.CcPropertyInterface) bool {
	l1 := this.Len()
	l2 := o.Len()
	l := l1
	if l2 < l1 {
...
// Name returns the name of this property: "cc".
func (this CcProperty) Name() string {
	return "cc"
}

// PrependAccept prepends a Accept value to the front of a list of the property
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependAccept(v vocab.AcceptInterface) {
	this.properties = append([]*CcPropertyIterator{{
		AcceptMember: v,
		alias:        this.alias,
		myIdx:        0,
		parent:       this,
...
func (this *CcProperty) PrependActivity(v vocab.ActivityInterface) {
	this.properties = append([]*CcPropertyIterator{{
		ActivityMember: v,
		alias:          this.alias,
		myIdx:          0,
...
// PrependAdd prepends a Add value to the front of a list of the property "cc".
// Invalidates all iterators.
func (this *CcProperty) PrependAdd(v vocab.AddInterface) {
	this.properties = append([]*CcPropertyIterator{{
		AddMember: v,
		alias:     this.alias,
		myIdx:     0,
...
// property "cc". Invalidates all iterators.
func (this *CcProperty) PrependAnnounce(v vocab.AnnounceInterface) {
	this.properties = append([]*CcPropertyIterator{{
		AnnounceMember: v,
		alias:          this.alias,
		myIdx:          0,
...
// property "cc". Invalidates all iterators.
func (this *CcProperty) PrependApplication(v vocab.ApplicationInterface) {
	this.properties = append([]*CcPropertyIterator{{
		ApplicationMember: v,
		alias:             this.alias,
		myIdx:             0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependArrive(v vocab.ArriveInterface) {
	this.properties = append([]*CcPropertyIterator{{
		ArriveMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependArticle(v vocab.ArticleInterface) {
	this.properties = append([]*CcPropertyIterator{{
		ArticleMember: v,
		alias:         this.alias,
		myIdx:         0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependAudio(v vocab.AudioInterface) {
	this.properties = append([]*CcPropertyIterator{{
		AudioMember: v,
		alias:       this.alias,
		myIdx:       0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependBlock(v vocab.BlockInterface) {
	this.properties = append([]*CcPropertyIterator{{
		BlockMember: v,
		alias:       this.alias,
		myIdx:       0,
...
// property "cc". Invalidates all iterators.
func (this *CcProperty) PrependCollection(v vocab.CollectionInterface) {
	this.properties = append([]*CcPropertyIterator{{
		CollectionMember: v,
		alias:            this.alias,
		myIdx:            0,
...
func (this *CcProperty) PrependCollectionPage(v vocab.CollectionPageInterface) {
	this.properties = append([]*CcPropertyIterator{{
		CollectionPageMember: v,
		alias:                this.alias,
		myIdx:                0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependCreate(v vocab.CreateInterface) {
	this.properties = append([]*CcPropertyIterator{{
		CreateMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependDelete(v vocab.DeleteInterface) {
	this.properties = append([]*CcPropertyIterator{{
		DeleteMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependDislike(v vocab.DislikeInterface) {
	this.properties = append([]*CcPropertyIterator{{
		DislikeMember: v,
		alias:         this.alias,
		myIdx:         0,
...
// property "cc". Invalidates all iterators.
func (this *CcProperty) PrependDocument(v vocab.DocumentInterface) {
	this.properties = append([]*CcPropertyIterator{{
		DocumentMember: v,
		alias:          this.alias,
		myIdx:          0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependEvent(v vocab.EventInterface) {
	this.properties = append([]*CcPropertyIterator{{
		EventMember: v,
		alias:       this.alias,
		myIdx:       0,
...
// PrependFlag prepends a Flag value to the front of a list of the property "cc".
// Invalidates all iterators.
func (this *CcProperty) PrependFlag(v vocab.FlagInterface) {
	this.properties = append([]*CcPropertyIterator{{
		FlagMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependFollow(v vocab.FollowInterface) {
	this.properties = append([]*CcPropertyIterator{{
		FollowMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependGroup(v vocab.GroupInterface) {
	this.properties = append([]*CcPropertyIterator{{
		GroupMember: v,
		alias:       this.alias,
		myIdx:       0,
...
func (this *CcProperty) PrependIRI(v *url.URL) {
	this.properties = append([]*CcPropertyIterator{{
		alias:  this.alias,
		iri:    v,
		myIdx:  0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependIgnore(v vocab.IgnoreInterface) {
	this.properties = append([]*CcPropertyIterator{{
		IgnoreMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependImage(v vocab.ImageInterface) {
	this.properties = append([]*CcPropertyIterator{{
		ImageMember: v,
		alias:       this.alias,
		myIdx:       0,
...
func (this *CcProperty) PrependIntransitiveActivity(v vocab.IntransitiveActivityInterface) {
	this.properties = append([]*CcPropertyIterator{{
		IntransitiveActivityMember: v,
		alias:                      this.alias,
		myIdx:                      0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependInvite(v vocab.InviteInterface) {
	this.properties = append([]*CcPropertyIterator{{
		InviteMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// PrependJoin prepends a Join value to the front of a list of the property "cc".
// Invalidates all iterators.
func (this *CcProperty) PrependJoin(v vocab.JoinInterface) {
	this.properties = append([]*CcPropertyIterator{{
		JoinMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependLeave(v vocab.LeaveInterface) {
	this.properties = append([]*CcPropertyIterator{{
		LeaveMember: v,
		alias:       this.alias,
		myIdx:       0,
...
// PrependLike prepends a Like value to the front of a list of the property "cc".
// Invalidates all iterators.
func (this *CcProperty) PrependLike(v vocab.LikeInterface) {
	this.properties = append([]*CcPropertyIterator{{
		LikeMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// PrependLink prepends a Link value to the front of a list of the property "cc".
// Invalidates all iterators.
func (this *CcProperty) PrependLink(v vocab.LinkInterface) {
	this.properties = append([]*CcPropertyIterator{{
		LinkMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependListen(v vocab.ListenInterface) {
	this.properties = append([]*CcPropertyIterator{{
		ListenMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependMention(v vocab.MentionInterface) {
	this.properties = append([]*CcPropertyIterator{{
		MentionMember: v,
		alias:         this.alias,
		myIdx:         0,
...
// PrependMove prepends a Move value to the front of a list of the property "cc".
// Invalidates all iterators.
func (this *CcProperty) PrependMove(v vocab.MoveInterface) {
	this.properties = append([]*CcPropertyIterator{{
		MoveMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// PrependNote prepends a Note value to the front of a list of the property "cc".
// Invalidates all iterators.
func (this *CcProperty) PrependNote(v vocab.NoteInterface) {
	this.properties = append([]*CcPropertyIterator{{
		NoteMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependObject(v vocab.ObjectInterface) {
	this.properties = append([]*CcPropertyIterator{{
		ObjectMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependOffer(v vocab.OfferInterface) {
	this.properties = append([]*CcPropertyIterator{{
		OfferMember: v,
		alias:       this.alias,
		myIdx:       0,
...
func (this *CcProperty) PrependOrderedCollection(v vocab.OrderedCollectionInterface) {
	this.properties = append([]*CcPropertyIterator{{
		OrderedCollectionMember: v,
		alias:                   this.alias,
		myIdx:                   0,
...
func (this *CcProperty) PrependOrderedCollectionPage(v vocab.OrderedCollectionPageInterface) {
	this.properties = append([]*CcPropertyIterator{{
		OrderedCollectionPageMember: v,
		alias:                       this.alias,
		myIdx:                       0,
...
// property "cc". Invalidates all iterators.
func (this *CcProperty) PrependOrganization(v vocab.OrganizationInterface) {
	this.properties = append([]*CcPropertyIterator{{
		OrganizationMember: v,
		alias:              this.alias,
		myIdx:              0,
...
// PrependPage prepends a Page value to the front of a list of the property "cc".
// Invalidates all iterators.
func (this *CcProperty) PrependPage(v vocab.PageInterface) {
	this.properties = append([]*CcPropertyIterator{{
		PageMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependPerson(v vocab.PersonInterface) {
	this.properties = append([]*CcPropertyIterator{{
		PersonMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependPlace(v vocab.PlaceInterface) {
	this.properties = append([]*CcPropertyIterator{{
		PlaceMember: v,
		alias:       this.alias,
		myIdx:       0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependProfile(v vocab.ProfileInterface) {
	this.properties = append([]*CcPropertyIterator{{
		ProfileMember: v,
		alias:         this.alias,
		myIdx:         0,
...
// property "cc". Invalidates all iterators.
func (this *CcProperty) PrependQuestion(v vocab.QuestionInterface) {
	this.properties = append([]*CcPropertyIterator{{
		QuestionMember: v,
		alias:          this.alias,
		myIdx:          0,
...
// PrependRead prepends a Read value to the front of a list of the property "cc".
// Invalidates all iterators.
func (this *CcProperty) PrependRead(v vocab.ReadInterface) {
	this.properties = append([]*CcPropertyIterator{{
		ReadMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependReject(v vocab.RejectInterface) {
	this.properties = append([]*CcPropertyIterator{{
		RejectMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// property "cc". Invalidates all iterators.
func (this *CcProperty) PrependRelationship(v vocab.RelationshipInterface) {
	this.properties = append([]*CcPropertyIterator{{
		RelationshipMember: v,
		alias:              this.alias,
		myIdx:              0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependRemove(v vocab.RemoveInterface) {
	this.properties = append([]*CcPropertyIterator{{
		RemoveMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependService(v vocab.ServiceInterface) {
	this.properties = append([]*CcPropertyIterator{{
		ServiceMember: v,
		alias:         this.alias,
		myIdx:         0,
...
func (this *CcProperty) PrependTentativeAccept(v vocab.TentativeAcceptInterface) {
	this.properties = append([]*CcPropertyIterator{{
		TentativeAcceptMember: v,
		alias:                 this.alias,
		myIdx:                 0,
...
// of the property "cc". Invalidates all iterators.
func (this *CcProperty) PrependTentativeReject(v vocab.TentativeRejectInterface) {
	this.properties = append([]*CcPropertyIterator{{
		TentativeRejectMember: v,
		alias:                 this.alias,
		myIdx:                 0,
...
// property "cc". Invalidates all iterators.
func (this *CcProperty) PrependTombstone(v vocab.TombstoneInterface) {
	this.properties = append([]*CcPropertyIterator{{
		TombstoneMember: v,
		alias:           this.alias,
		myIdx:           0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependTravel(v vocab.TravelInterface) {
	this.properties = append([]*CcPropertyIterator{{
		TravelMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// PrependUndo prepends a Undo value to the front of a list of the property "cc".
// Invalidates all iterators.
func (this *CcProperty) PrependUndo(v vocab.UndoInterface) {
	this.properties = append([]*CcPropertyIterator{{
		UndoMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependUpdate(v vocab.UpdateInterface) {
	this.properties = append([]*CcPropertyIterator{{
		UpdateMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "cc". Invalidates all iterators.
func (this *CcProperty) PrependVideo(v vocab.VideoInterface) {
	this.properties = append([]*CcPropertyIterator{{
		VideoMember: v,
		alias:       this.alias,
		myIdx:       0,
...
// PrependView prepends a View value to the front of a list of the property "cc".
// Invalidates all iterators.
func (this *CcProperty) PrependView(v vocab.ViewInterface) {
	this.properties = append([]*CcPropertyIterator{{
		ViewMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// Invalidates all iterators.
func (this *CcProperty) Remove(idx int) {
	(this.properties)[idx].parent = nil
	copy((this.properties)[idx:], (this.properties)[idx+1:])
	(this.properties)[len(this.properties)-1] = &CcPropertyIterator{}
...
// function as most typical use cases serialize types instead of individual
// properties. It is exposed for alternatives to go-fed implementations to use.
func (this CcProperty) Serialize() (interface{}, error) {
...
func (this *CcProperty) SetAccept(idx int, v vocab.AcceptInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		AcceptMember: v,
		alias:        this.alias,
		myIdx:        idx,
		parent:       this,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetActivity(idx int, v vocab.ActivityInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		ActivityMember: v,
		alias:          this.alias,
...
// SetAdd sets a Add value to be at the specified index for the property "cc".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetAdd(idx int, v vocab.AddInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		AddMember: v,
		alias:     this.alias,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetAnnounce(idx int, v vocab.AnnounceInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		AnnounceMember: v,
		alias:          this.alias,
...
// iterators.
func (this *CcProperty) SetApplication(idx int, v vocab.ApplicationInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		ApplicationMember: v,
		alias:             this.alias,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetArrive(idx int, v vocab.ArriveInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		ArriveMember: v,
		alias:        this.alias,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetArticle(idx int, v vocab.ArticleInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		ArticleMember: v,
		alias:         this.alias,
...
// SetAudio sets a Audio value to be at the specified index for the property "cc".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetAudio(idx int, v vocab.AudioInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		AudioMember: v,
		alias:       this.alias,
...
// SetBlock sets a Block value to be at the specified index for the property "cc".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetBlock(idx int, v vocab.BlockInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		BlockMember: v,
		alias:       this.alias,
...
// property "cc". Panics if the index is out of bounds. Invalidates all
// iterators.
func (this *CcProperty) SetCollection(idx int, v vocab.CollectionInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		CollectionMember: v,
		alias:            this.alias,
...
// iterators.
func (this *CcProperty) SetCollectionPage(idx int, v vocab.CollectionPageInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		CollectionPageMember: v,
		alias:                this.alias,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetCreate(idx int, v vocab.CreateInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		CreateMember: v,
		alias:        this.alias,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetDelete(idx int, v vocab.DeleteInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		DeleteMember: v,
		alias:        this.alias,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetDislike(idx int, v vocab.DislikeInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		DislikeMember: v,
		alias:         this.alias,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetDocument(idx int, v vocab.DocumentInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		DocumentMember: v,
		alias:          this.alias,
...
// SetEvent sets a Event value to be at the specified index for the property "cc".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetEvent(idx int, v vocab.EventInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		EventMember: v,
		alias:       this.alias,
...
// SetFlag sets a Flag value to be at the specified index for the property "cc".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetFlag(idx int, v vocab.FlagInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		FlagMember: v,
		alias:      this.alias,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetFollow(idx int, v vocab.FollowInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		FollowMember: v,
		alias:        this.alias,
...
// SetGroup sets a Group value to be at the specified index for the property "cc".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetGroup(idx int, v vocab.GroupInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		GroupMember: v,
		alias:       this.alias,
...
func (this *CcProperty) SetIRI(idx int, v *url.URL) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		alias:  this.alias,
		iri:    v,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetIgnore(idx int, v vocab.IgnoreInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		IgnoreMember: v,
		alias:        this.alias,
...
// SetImage sets a Image value to be at the specified index for the property "cc".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetImage(idx int, v vocab.ImageInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		ImageMember: v,
		alias:       this.alias,
...
func (this *CcProperty) SetIntransitiveActivity(idx int, v vocab.IntransitiveActivityInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		IntransitiveActivityMember: v,
		alias:                      this.alias,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetInvite(idx int, v vocab.InviteInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		InviteMember: v,
		alias:        this.alias,
...
// SetJoin sets a Join value to be at the specified index for the property "cc".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetJoin(idx int, v vocab.JoinInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		JoinMember: v,
		alias:      this.alias,
...
// SetLeave sets a Leave value to be at the specified index for the property "cc".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetLeave(idx int, v vocab.LeaveInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		LeaveMember: v,
		alias:       this.alias,
...
// SetLike sets a Like value to be at the specified index for the property "cc".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetLike(idx int, v vocab.LikeInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		LikeMember: v,
		alias:      this.alias,
...
// SetLink sets a Link value to be at the specified index for the property "cc".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetLink(idx int, v vocab.LinkInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		LinkMember: v,
		alias:      this.alias,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetListen(idx int, v vocab.ListenInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		ListenMember: v,
		alias:        this.alias,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetMention(idx int, v vocab.MentionInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		MentionMember: v,
		alias:         this.alias,
...
// SetMove sets a Move value to be at the specified index for the property "cc".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetMove(idx int, v vocab.MoveInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		MoveMember: v,
		alias:      this.alias,
...
// SetNote sets a Note value to be at the specified index for the property "cc".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetNote(idx int, v vocab.NoteInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		NoteMember: v,
		alias:      this.alias,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetObject(idx int, v vocab.ObjectInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		ObjectMember: v,
		alias:        this.alias,
...
// SetOffer sets a Offer value to be at the specified index for the property "cc".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetOffer(idx int, v vocab.OfferInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		OfferMember: v,
		alias:       this.alias,
...
// Invalidates all iterators.
func (this *CcProperty) SetOrderedCollection(idx int, v vocab.OrderedCollectionInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		OrderedCollectionMember: v,
		alias:                   this.alias,
...
// specified index for the property "cc". Panics if the index is out of
// bounds. Invalidates all iterators.
func (this *CcProperty) SetOrderedCollectionPage(idx int, v vocab.OrderedCollectionPageInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		OrderedCollectionPageMember: v,
		alias:                       this.alias,
...
// property "cc". Panics if the index is out of bounds. Invalidates all
// iterators.
func (this *CcProperty) SetOrganization(idx int, v vocab.OrganizationInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		OrganizationMember: v,
		alias:              this.alias,
...
// SetPage sets a Page value to be at the specified index for the property "cc".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetPage(idx int, v vocab.PageInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		PageMember: v,
		alias:      this.alias,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetPerson(idx int, v vocab.PersonInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		PersonMember: v,
		alias:        this.alias,
...
// SetPlace sets a Place value to be at the specified index for the property "cc".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetPlace(idx int, v vocab.PlaceInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		PlaceMember: v,
		alias:       this.alias,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetProfile(idx int, v vocab.ProfileInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		ProfileMember: v,
		alias:         this.alias,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetQuestion(idx int, v vocab.QuestionInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		QuestionMember: v,
		alias:          this.alias,
...
// SetRead sets a Read value to be at the specified index for the property "cc".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetRead(idx int, v vocab.ReadInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		ReadMember: v,
		alias:      this.alias,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetReject(idx int, v vocab.RejectInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		RejectMember: v,
		alias:        this.alias,
...
// property "cc". Panics if the index is out of bounds. Invalidates all
// iterators.
func (this *CcProperty) SetRelationship(idx int, v vocab.RelationshipInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		RelationshipMember: v,
		alias:              this.alias,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetRemove(idx int, v vocab.RemoveInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		RemoveMember: v,
		alias:        this.alias,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetService(idx int, v vocab.ServiceInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		ServiceMember: v,
		alias:         this.alias,
...
// all iterators.
func (this *CcProperty) SetTentativeAccept(idx int, v vocab.TentativeAcceptInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		TentativeAcceptMember: v,
		alias:                 this.alias,
...
// for the property "cc". Panics if the index is out of bounds. Invalidates
// all iterators.
func (this *CcProperty) SetTentativeReject(idx int, v vocab.TentativeRejectInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		TentativeRejectMember: v,
		alias:                 this.alias,
...
// property "cc". Panics if the index is out of bounds. Invalidates all
// iterators.
func (this *CcProperty) SetTombstone(idx int, v vocab.TombstoneInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		TombstoneMember: v,
		alias:           this.alias,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetTravel(idx int, v vocab.TravelInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		TravelMember: v,
		alias:        this.alias,
...
// SetUndo sets a Undo value to be at the specified index for the property "cc".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetUndo(idx int, v vocab.UndoInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		UndoMember: v,
		alias:      this.alias,
...
// "cc". Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetUpdate(idx int, v vocab.UpdateInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		UpdateMember: v,
		alias:        this.alias,
...
// SetVideo sets a Video value to be at the specified index for the property "cc".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetVideo(idx int, v vocab.VideoInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		VideoMember: v,
		alias:       this.alias,
...
// SetView sets a View value to be at the specified index for the property "cc".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *CcProperty) SetView(idx int, v vocab.ViewInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &CcPropertyIterator{
		ViewMember: v,
		alias:      this.alias,
...
func (this CcProperty) Swap(i, j int) {
