...
func (this Question) LessThan(o vocab.QuestionInterface) bool {
	...
	if this.AnyOf.LessThan(o.GetAnyOf()) {
		return true
	} else if o.GetAnyOf().LessThan(this.AnyOf) {
		return false
	}
	...
	if this.Closed.LessThan(o.GetClosed()) {
		return true
	} else if o.GetClosed().LessThan(this.Closed) {
		return false
	}
	...
	if this.OneOf.LessThan(o.GetOneOf()) {
		return true
	} else if o.GetOneOf().LessThan(this.OneOf) {
		return false
	}
...
func (this Question) Serialize() (interface{}, error) {
