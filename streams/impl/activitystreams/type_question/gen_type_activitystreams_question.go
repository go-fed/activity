...
// SetActivityStreamsAnyOf returns the "anyOf" property if it exists, and nil
// otherwise.
...
// SetActivityStreamsClosed returns the "closed" property if it exists, and nil
// otherwise.
...
// SetActivityStreamsOneOf returns the "oneOf" property if it exists, and nil
// otherwise.
