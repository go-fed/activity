...
type privateManager interface {
	...
	// method for the "ActorPropertyInterface" non-functional property in
	// the vocabulary "ActivityStreams"
	DeserializeActorPropertyActivityStreams() func(map[string]interface{}, map[string]string) (vocab.ActorPropertyInterface, error)
	...
	// DeserializeAnyOfPropertyActivityStreams returns the deserialization
	// method for the "AnyOfPropertyInterface" non-functional property in
	// the vocabulary "ActivityStreams"
	DeserializeAnyOfPropertyActivityStreams() func(map[string]interface{}, map[string]string) (vocab.AnyOfPropertyInterface, error)
	...
	// DeserializeClosedPropertyActivityStreams returns the deserialization
	// method for the "ClosedPropertyInterface" non-functional property in
	// the vocabulary "ActivityStreams"
	DeserializeClosedPropertyActivityStreams() func(map[string]interface{}, map[string]string) (vocab.ClosedPropertyInterface, error)
	...
	// DeserializeOneOfPropertyActivityStreams returns the deserialization
	// method for the "OneOfPropertyInterface" non-functional property in
	// the vocabulary "ActivityStreams"
	DeserializeOneOfPropertyActivityStreams() func(map[string]interface{}, map[string]string) (vocab.OneOfPropertyInterface, error)
	...
	// the vocabulary "ActivityStreams"
	DeserializeOriginPropertyActivityStreams() func(map[string]interface{}, map[string]string) (vocab.OriginPropertyInterface, error)
	...
	// method for the "TargetPropertyInterface" non-functional property in
	// the vocabulary "ActivityStreams"
	DeserializeTargetPropertyActivityStreams() func(map[string]interface{}, map[string]string) (vocab.TargetPropertyInterface, error)
