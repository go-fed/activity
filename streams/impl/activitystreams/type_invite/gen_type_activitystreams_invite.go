...
func (this ActivityStreamsInvite) GetJSONLDId() vocab.JSONLDIdProperty {
	return this.JSONLDId
}

// GetJSONLDType returns the "type" property if it exists, and nil otherwise.
func (this ActivityStreamsInvite) GetJSONLDType() vocab.JSONLDTypeProperty {
...
func (this *ActivityStreamsInvite) SetJSONLDId(i vocab.JSONLDIdProperty) {
	this.JSONLDId = i
}

// SetJSONLDType sets the "type" property.
func (this *ActivityStreamsInvite) SetJSONLDType(i vocab.JSONLDTypeProperty) {
	this.JSONLDType = i
}
