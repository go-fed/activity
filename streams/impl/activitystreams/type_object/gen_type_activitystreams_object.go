...
func (this ActivityStreamsObject) GetJSONLDType() vocab.JSONLDTypeProperty {
...
func (this *ActivityStreamsObject) SetJSONLDId(i vocab.JSONLDIdProperty) {
	this.JSONLDId = i
}

// SetJSONLDType sets the "type" property.
func (this *ActivityStreamsObject) SetJSONLDType(i vocab.JSONLDTypeProperty) {
	this.JSONLDType = i
}
