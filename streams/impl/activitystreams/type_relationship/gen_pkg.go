...
type privateManager interface {
	...
	// deserialization method for the "RelationshipPropertyInterface"
	// non-functional property in the vocabulary "ActivityStreams"
	DeserializeRelationshipPropertyActivityStreams() func(map[string]interface{}, map[string]string) (vocab.RelationshipPropertyInterface, error)
	...
	// method for the "SubjectPropertyInterface" non-functional property
	// in the vocabulary "ActivityStreams"
	DeserializeSubjectPropertyActivityStreams() func(map[string]interface{}, map[string]string) (vocab.SubjectPropertyInterface, error)
