...
func NewActivityStreamsImage() *ActivityStreamsImage {
	...
	typeProp.AppendXMLSchemaString("Image")
...
func (this ActivityStreamsImage) GetActivityStreamsId() vocab.ActivityStreamsIdProperty {
...
// otherwise.
func (this ActivityStreamsImage) GetActivityStreamsType() vocab.ActivityStreamsTypeProperty {
...
func (this ActivityStreamsImage) IsExtending(other vocab.Type) bool {
	return ActivityStreamsImageExtends(other)
}
...
// determination.
func (this ActivityStreamsImage) LessThan(o vocab.ActivityStreamsImage) bool {
...
func (this *ActivityStreamsImage) SetActivityStreamsId(i vocab.ActivityStreamsIdProperty) {
...
func (this *ActivityStreamsImage) SetActivityStreamsType(i vocab.ActivityStreamsTypeProperty) {
...
// if it is not nil.
func (this ActivityStreamsImage) helperJSONLDContext(i jsonldContexter, toMerge map[string]string) map[string]string {
	if i == nil {
		return toMerge
	}
