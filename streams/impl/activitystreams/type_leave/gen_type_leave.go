...
func DeserializeLeave(m map[string]interface{}, aliasMap map[string]string) (*Leave, error) {
	alias := ""
	aliasPrefix := ""
...
// LeaveExtends returns true if the Leave type extends from the other type.
func LeaveExtends(other vocab.Type) bool {
...
func (this Leave) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Leave) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Leave) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Leave type extends from the other type.
func (this Leave) IsExtending(other vocab.Type) bool {
	return LeaveExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Leave) JSONLDContext() map[string]string {
...
// determination.
func (this Leave) LessThan(o vocab.LeaveInterface) bool {
...
func (this Leave) Serialize() (map[string]interface{}, error) {
