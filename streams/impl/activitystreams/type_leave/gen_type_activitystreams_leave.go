...
func (this ActivityStreamsLeave) GetJSONLDId() vocab.JSONLDIdProperty {
	return this.JSONLDId
}

// GetJSONLDType returns the "type" property if it exists, and nil otherwise.
func (this ActivityStreamsLeave) GetJSONLDType() vocab.JSONLDTypeProperty {
...
func (this *ActivityStreamsLeave) SetJSONLDId(i vocab.JSONLDIdProperty) {
	this.JSONLDId = i
}

// SetJSONLDType sets the "type" property.
func (this *ActivityStreamsLeave) SetJSONLDType(i vocab.JSONLDTypeProperty) {
	this.JSONLDType = i
}
