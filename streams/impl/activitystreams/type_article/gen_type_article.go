...
// ArticleExtends returns true if the Article type extends from the other type.
func ArticleExtends(other vocab.Type) bool {
...
func DeserializeArticle(m map[string]interface{}, aliasMap map[string]string) (*Article, error) {
	alias := ""
	aliasPrefix := ""
...
func (this Article) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Article) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Article) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Article type extends from the other type.
func (this Article) IsExtending(other vocab.Type) bool {
	return ArticleExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Article) JSONLDContext() map[string]string {
...
// determination.
func (this Article) LessThan(o vocab.ArticleInterface) bool {
...
func (this Article) Serialize() (map[string]interface{}, error) {
