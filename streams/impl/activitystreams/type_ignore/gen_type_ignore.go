...
func DeserializeIgnore(m map[string]interface{}, aliasMap map[string]string) (*Ignore, error) {
	alias := ""
	aliasPrefix := ""
...
// IgnoreExtends returns true if the Ignore type extends from the other type.
func IgnoreExtends(other vocab.Type) bool {
...
func (this Ignore) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Ignore) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Ignore) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Ignore type extends from the other type.
func (this Ignore) IsExtending(other vocab.Type) bool {
	return IgnoreExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Ignore) JSONLDContext() map[string]string {
...
// determination.
func (this Ignore) LessThan(o vocab.IgnoreInterface) bool {
...
func (this Ignore) Serialize() (map[string]interface{}, error) {
