...
func (this ActivityStreamsIgnore) GetJSONLDId() vocab.JSONLDIdProperty {
	return this.JSONLDId
}

// GetJSONLDType returns the "type" property if it exists, and nil otherwise.
func (this ActivityStreamsIgnore) GetJSONLDType() vocab.JSONLDTypeProperty {
...
func (this *ActivityStreamsIgnore) SetJSONLDId(i vocab.JSONLDIdProperty) {
	this.JSONLDId = i
}

// SetJSONLDType sets the "type" property.
func (this *ActivityStreamsIgnore) SetJSONLDType(i vocab.JSONLDTypeProperty) {
	this.JSONLDType = i
}
