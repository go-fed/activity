...
// DeleteExtends returns true if the Delete type extends from the other type.
func DeleteExtends(other vocab.Type) bool {
...
func DeserializeDelete(m map[string]interface{}, aliasMap map[string]string) (*Delete, error) {
	alias := ""
	aliasPrefix := ""
...
func (this Delete) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Delete) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Delete) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Delete type extends from the other type.
func (this Delete) IsExtending(other vocab.Type) bool {
	return DeleteExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Delete) JSONLDContext() map[string]string {
...
// determination.
func (this Delete) LessThan(o vocab.DeleteInterface) bool {
...
func (this Delete) Serialize() (map[string]interface{}, error) {
