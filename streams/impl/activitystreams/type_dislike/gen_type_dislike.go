...
func DeserializeDislike(m map[string]interface{}, aliasMap map[string]string) (*Dislike, error) {
	alias := ""
	aliasPrefix := ""
...
// DislikeExtends returns true if the Dislike type extends from the other type.
func DislikeExtends(other vocab.Type) bool {
...
func (this Dislike) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Dislike) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Dislike) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Dislike type extends from the other type.
func (this Dislike) IsExtending(other vocab.Type) bool {
	return DislikeExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Dislike) JSONLDContext() map[string]string {
...
// determination.
func (this Dislike) LessThan(o vocab.DislikeInterface) bool {
...
func (this Dislike) Serialize() (map[string]interface{}, error) {
