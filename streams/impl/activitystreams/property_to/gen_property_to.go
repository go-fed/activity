...
// ToPropertyIterator is an iterator for a property. It is permitted to be one of
...
type ToPropertyIterator struct {
	...
	alias                       string
	myIdx                       int
	parent                      vocab.ToPropertyInterface
}

// NewToPropertyIterator creates a new to property.
func NewToPropertyIterator() *ToPropertyIterator {
	return &ToPropertyIterator{alias: ""}
}

// deserializeToPropertyIterator creates an iterator from an element that has been
// unmarshalled from a text or binary format.
func deserializeToPropertyIterator(i interface{}, aliasMap map[string]string) (*ToPropertyIterator, error) {
	alias := ""
...
func (this ToPropertyIterator) GetAccept() vocab.AcceptInterface {
...
func (this ToPropertyIterator) GetActivity() vocab.ActivityInterface {
	return this.ActivityMember
}

// GetAdd returns the value of this property. When IsAdd returns false, GetAdd
// will return an arbitrary value.
func (this ToPropertyIterator) GetAdd() vocab.AddInterface {
...
func (this ToPropertyIterator) GetAnnounce() vocab.AnnounceInterface {
...
func (this ToPropertyIterator) GetApplication() vocab.ApplicationInterface {
...
func (this ToPropertyIterator) GetArrive() vocab.ArriveInterface {
...
func (this ToPropertyIterator) GetArticle() vocab.ArticleInterface {
...
func (this ToPropertyIterator) GetAudio() vocab.AudioInterface {
...
func (this ToPropertyIterator) GetBlock() vocab.BlockInterface {
...
func (this ToPropertyIterator) GetCollection() vocab.CollectionInterface {
...
func (this ToPropertyIterator) GetCollectionPage() vocab.CollectionPageInterface {
...
func (this ToPropertyIterator) GetCreate() vocab.CreateInterface {
	return this.CreateMember
}

// GetDelete returns the value of this property. When IsDelete returns false,
// GetDelete will return an arbitrary value.
func (this ToPropertyIterator) GetDelete() vocab.DeleteInterface {
...
func (this ToPropertyIterator) GetDislike() vocab.DislikeInterface {
...
func (this ToPropertyIterator) GetDocument() vocab.DocumentInterface {
...
func (this ToPropertyIterator) GetEvent() vocab.EventInterface {
	return this.EventMember
}

// GetFlag returns the value of this property. When IsFlag returns false, GetFlag
// will return an arbitrary value.
func (this ToPropertyIterator) GetFlag() vocab.FlagInterface {
...
func (this ToPropertyIterator) GetFollow() vocab.FollowInterface {
...
func (this ToPropertyIterator) GetGroup() vocab.GroupInterface {
	return this.GroupMember
}

// GetIRI returns the IRI of this property. When IsIRI returns false, GetIRI will
// return an arbitrary value.
func (this ToPropertyIterator) GetIRI() *url.URL {
	return this.iri
}

// GetIgnore returns the value of this property. When IsIgnore returns false,
// GetIgnore will return an arbitrary value.
func (this ToPropertyIterator) GetIgnore() vocab.IgnoreInterface {
...
func (this ToPropertyIterator) GetImage() vocab.ImageInterface {
...
// an arbitrary value.
func (this ToPropertyIterator) GetIntransitiveActivity() vocab.IntransitiveActivityInterface {
...
func (this ToPropertyIterator) GetInvite() vocab.InviteInterface {
	return this.InviteMember
}

// GetJoin returns the value of this property. When IsJoin returns false, GetJoin
// will return an arbitrary value.
func (this ToPropertyIterator) GetJoin() vocab.JoinInterface {
...
func (this ToPropertyIterator) GetListen() vocab.ListenInterface {
...
func (this ToPropertyIterator) GetObject() vocab.ObjectInterface {
...
func (this ToPropertyIterator) GetOffer() vocab.OfferInterface {
...
// arbitrary value.
func (this ToPropertyIterator) GetOrderedCollection() vocab.OrderedCollectionInterface {
...
// an arbitrary value.
func (this ToPropertyIterator) GetOrderedCollectionPage() vocab.OrderedCollectionPageInterface {
...
func (this ToPropertyIterator) GetOrganization() vocab.OrganizationInterface {
	return this.OrganizationMember
}

// GetPage returns the value of this property. When IsPage returns false, GetPage
// will return an arbitrary value.
func (this ToPropertyIterator) GetPage() vocab.PageInterface {
...
func (this ToPropertyIterator) GetPerson() vocab.PersonInterface {
...
func (this ToPropertyIterator) GetPlace() vocab.PlaceInterface {
...
func (this ToPropertyIterator) GetProfile() vocab.ProfileInterface {
...
func (this ToPropertyIterator) GetQuestion() vocab.QuestionInterface {
	return this.QuestionMember
}

// GetRead returns the value of this property. When IsRead returns false, GetRead
// will return an arbitrary value.
func (this ToPropertyIterator) GetRead() vocab.ReadInterface {
...
func (this ToPropertyIterator) GetReject() vocab.RejectInterface {
...
func (this ToPropertyIterator) GetRelationship() vocab.RelationshipInterface {
...
func (this ToPropertyIterator) GetRemove() vocab.RemoveInterface {
	return this.RemoveMember
}

// GetService returns the value of this property. When IsService returns false,
// GetService will return an arbitrary value.
func (this ToPropertyIterator) GetService() vocab.ServiceInterface {
...
func (this ToPropertyIterator) GetTentativeAccept() vocab.TentativeAcceptInterface {
...
func (this ToPropertyIterator) GetTentativeReject() vocab.TentativeRejectInterface {
...
func (this ToPropertyIterator) GetTombstone() vocab.TombstoneInterface {
...
func (this ToPropertyIterator) GetTravel() vocab.TravelInterface {
	return this.TravelMember
}

// GetUndo returns the value of this property. When IsUndo returns false, GetUndo
// will return an arbitrary value.
func (this ToPropertyIterator) GetUndo() vocab.UndoInterface {
...
func (this ToPropertyIterator) IsAccept() bool {
...
func (this ToPropertyIterator) IsActivity() bool {
...
func (this ToPropertyIterator) IsAdd() bool {
...
func (this ToPropertyIterator) IsAnnounce() bool {
...
// this property.
func (this ToPropertyIterator) IsApplication() bool {
...
func (this ToPropertyIterator) IsArrive() bool {
...
func (this ToPropertyIterator) IsArticle() bool {
...
func (this ToPropertyIterator) IsAudio() bool {
...
func (this ToPropertyIterator) IsBlock() bool {
...
// this property.
func (this ToPropertyIterator) IsCollection() bool {
...
func (this ToPropertyIterator) IsCollectionPage() bool {
...
func (this ToPropertyIterator) IsCreate() bool {
...
func (this ToPropertyIterator) IsDelete() bool {
...
func (this ToPropertyIterator) IsDislike() bool {
...
func (this ToPropertyIterator) IsDocument() bool {
...
func (this ToPropertyIterator) IsEvent() bool {
...
func (this ToPropertyIterator) IsFlag() bool {
...
func (this ToPropertyIterator) IsFollow() bool {
...
func (this ToPropertyIterator) IsGroup() bool {
	return this.GroupMember != nil
}

// IsIRI returns true if this property is an IRI. When true, use GetIRI and SetIRI
// to access and set this property
func (this ToPropertyIterator) IsIRI() bool {
	return this.iri != nil
}
...
func (this ToPropertyIterator) IsIgnore() bool {
...
func (this ToPropertyIterator) IsImage() bool {
...
func (this ToPropertyIterator) IsIntransitiveActivity() bool {
...
func (this ToPropertyIterator) IsInvite() bool {
...
func (this ToPropertyIterator) IsJoin() bool {
...
func (this ToPropertyIterator) IsLeave() bool {
...
func (this ToPropertyIterator) IsLike() bool {
...
func (this ToPropertyIterator) IsLink() bool {
...
func (this ToPropertyIterator) IsListen() bool {
...
func (this ToPropertyIterator) IsMention() bool {
...
func (this ToPropertyIterator) IsMove() bool {
...
func (this ToPropertyIterator) IsNote() bool {
...
func (this ToPropertyIterator) IsObject() bool {
...
func (this ToPropertyIterator) IsOffer() bool {
...
func (this ToPropertyIterator) IsOrderedCollection() bool {
...
func (this ToPropertyIterator) IsOrderedCollectionPage() bool {
...
// this property.
func (this ToPropertyIterator) IsOrganization() bool {
...
func (this ToPropertyIterator) IsPage() bool {
...
func (this ToPropertyIterator) IsPerson() bool {
...
func (this ToPropertyIterator) IsPlace() bool {
...
func (this ToPropertyIterator) IsProfile() bool {
...
func (this ToPropertyIterator) IsQuestion() bool {
...
func (this ToPropertyIterator) IsRead() bool {
...
func (this ToPropertyIterator) IsReject() bool {
...
// this property.
func (this ToPropertyIterator) IsRelationship() bool {
...
func (this ToPropertyIterator) IsRemove() bool {
...
func (this ToPropertyIterator) IsService() bool {
...
func (this ToPropertyIterator) IsTentativeAccept() bool {
...
func (this ToPropertyIterator) IsTentativeReject() bool {
...
// property.
func (this ToPropertyIterator) IsTombstone() bool {
...
func (this ToPropertyIterator) IsTravel() bool {
...
func (this ToPropertyIterator) IsUndo() bool {
...
func (this ToPropertyIterator) IsUpdate() bool {
...
func (this ToPropertyIterator) IsVideo() bool {
...
func (this ToPropertyIterator) IsView() bool {
...
func (this ToPropertyIterator) JSONLDContext() map[string]string {
...
func (this ToPropertyIterator) KindIndex() int {
	if this.IsObject() {
		return 0
	}
	if this.IsLink() {
...
func (this ToPropertyIterator) LessThan(o vocab.ToPropertyIteratorInterface) bool {
	idx1 := this.KindIndex()
	idx2 := o.KindIndex()
	if idx1 < idx2 {
		return true
...
func (this ToPropertyIterator) Name() string {
	return "to"
}

// Next returns the next iterator, or nil if there is no next iterator.
func (this ToPropertyIterator) Next() vocab.ToPropertyIteratorInterface {
...
func (this ToPropertyIterator) Prev() vocab.ToPropertyIteratorInterface {
	if this.myIdx-1 < 0 {
		return nil
	} else {
		return this.parent.At(this.myIdx - 1)
...
// true.
func (this *ToPropertyIterator) SetAccept(v vocab.AcceptInterface) {
	this.clear()
	this.AcceptMember = v
}
...
// returns true.
func (this *ToPropertyIterator) SetActivity(v vocab.ActivityInterface) {
	this.clear()
	this.ActivityMember = v
}

// SetAdd sets the value of this property. Calling IsAdd afterwards returns true.
func (this *ToPropertyIterator) SetAdd(v vocab.AddInterface) {
	this.clear()
	this.AddMember = v
}
...
// returns true.
func (this *ToPropertyIterator) SetAnnounce(v vocab.AnnounceInterface) {
	this.clear()
...
func (this *ToPropertyIterator) SetApplication(v vocab.ApplicationInterface) {
	this.clear()
...
// true.
func (this *ToPropertyIterator) SetArrive(v vocab.ArriveInterface) {
	this.clear()
	this.ArriveMember = v
}
...
// returns true.
func (this *ToPropertyIterator) SetArticle(v vocab.ArticleInterface) {
	this.clear()
...
// true.
func (this *ToPropertyIterator) SetAudio(v vocab.AudioInterface) {
	this.clear()
	this.AudioMember = v
}
...
// true.
func (this *ToPropertyIterator) SetBlock(v vocab.BlockInterface) {
	this.clear()
	this.BlockMember = v
}
...
// returns true.
func (this *ToPropertyIterator) SetCollection(v vocab.CollectionInterface) {
	this.clear()
...
// afterwards returns true.
func (this *ToPropertyIterator) SetCollectionPage(v vocab.CollectionPageInterface) {
	this.clear()
...
// true.
func (this *ToPropertyIterator) SetCreate(v vocab.CreateInterface) {
	this.clear()
	this.CreateMember = v
}
...
// true.
func (this *ToPropertyIterator) SetDelete(v vocab.DeleteInterface) {
	this.clear()
	this.DeleteMember = v
}
...
// returns true.
func (this *ToPropertyIterator) SetDislike(v vocab.DislikeInterface) {
	this.clear()
...
// returns true.
func (this *ToPropertyIterator) SetDocument(v vocab.DocumentInterface) {
	this.clear()
...
// true.
func (this *ToPropertyIterator) SetEvent(v vocab.EventInterface) {
	this.clear()
	this.EventMember = v
}

// SetFlag sets the value of this property. Calling IsFlag afterwards returns true.
func (this *ToPropertyIterator) SetFlag(v vocab.FlagInterface) {
	this.clear()
	this.FlagMember = v
}
...
// true.
func (this *ToPropertyIterator) SetFollow(v vocab.FollowInterface) {
	this.clear()
	this.FollowMember = v
}
...
// true.
func (this *ToPropertyIterator) SetGroup(v vocab.GroupInterface) {
	this.clear()
	this.GroupMember = v
}

// SetIRI sets the value of this property. Calling IsIRI afterwards returns true.
func (this *ToPropertyIterator) SetIRI(v *url.URL) {
	this.clear()
	this.iri = v
}
...
// true.
func (this *ToPropertyIterator) SetIgnore(v vocab.IgnoreInterface) {
	this.clear()
	this.IgnoreMember = v
}
...
// true.
func (this *ToPropertyIterator) SetImage(v vocab.ImageInterface) {
	this.clear()
	this.ImageMember = v
}
...
func (this *ToPropertyIterator) SetIntransitiveActivity(v vocab.IntransitiveActivityInterface) {
	this.clear()
...
// true.
func (this *ToPropertyIterator) SetInvite(v vocab.InviteInterface) {
	this.clear()
	this.InviteMember = v
}

// SetJoin sets the value of this property. Calling IsJoin afterwards returns true.
func (this *ToPropertyIterator) SetJoin(v vocab.JoinInterface) {
	this.clear()
	this.JoinMember = v
}
...
// true.
func (this *ToPropertyIterator) SetLeave(v vocab.LeaveInterface) {
	this.clear()
	this.LeaveMember = v
}

// SetLike sets the value of this property. Calling IsLike afterwards returns true.
func (this *ToPropertyIterator) SetLike(v vocab.LikeInterface) {
	this.clear()
	this.LikeMember = v
}

// SetLink sets the value of this property. Calling IsLink afterwards returns true.
func (this *ToPropertyIterator) SetLink(v vocab.LinkInterface) {
	this.clear()
	this.LinkMember = v
}
...
// true.
func (this *ToPropertyIterator) SetListen(v vocab.ListenInterface) {
	this.clear()
	this.ListenMember = v
}
...
// returns true.
func (this *ToPropertyIterator) SetMention(v vocab.MentionInterface) {
	this.clear()
	this.MentionMember = v
}

// SetMove sets the value of this property. Calling IsMove afterwards returns true.
func (this *ToPropertyIterator) SetMove(v vocab.MoveInterface) {
	this.clear()
	this.MoveMember = v
}

// SetNote sets the value of this property. Calling IsNote afterwards returns true.
func (this *ToPropertyIterator) SetNote(v vocab.NoteInterface) {
	this.clear()
	this.NoteMember = v
}
...
// true.
func (this *ToPropertyIterator) SetObject(v vocab.ObjectInterface) {
	this.clear()
	this.ObjectMember = v
}
...
// true.
func (this *ToPropertyIterator) SetOffer(v vocab.OfferInterface) {
	this.clear()
	this.OfferMember = v
}
...
func (this *ToPropertyIterator) SetOrderedCollection(v vocab.OrderedCollectionInterface) {
	this.clear()
...
func (this *ToPropertyIterator) SetOrderedCollectionPage(v vocab.OrderedCollectionPageInterface) {
	this.clear()
...
// afterwards returns true.
func (this *ToPropertyIterator) SetOrganization(v vocab.OrganizationInterface) {
	this.clear()
	this.OrganizationMember = v
}

// SetPage sets the value of this property. Calling IsPage afterwards returns true.
func (this *ToPropertyIterator) SetPage(v vocab.PageInterface) {
	this.clear()
	this.PageMember = v
}
...
// true.
func (this *ToPropertyIterator) SetPerson(v vocab.PersonInterface) {
	this.clear()
	this.PersonMember = v
}
...
// true.
func (this *ToPropertyIterator) SetPlace(v vocab.PlaceInterface) {
	this.clear()
	this.PlaceMember = v
}
...
// returns true.
func (this *ToPropertyIterator) SetProfile(v vocab.ProfileInterface) {
	this.clear()
...
// returns true.
func (this *ToPropertyIterator) SetQuestion(v vocab.QuestionInterface) {
	this.clear()
	this.QuestionMember = v
}

// SetRead sets the value of this property. Calling IsRead afterwards returns true.
func (this *ToPropertyIterator) SetRead(v vocab.ReadInterface) {
	this.clear()
	this.ReadMember = v
}
...
// true.
func (this *ToPropertyIterator) SetReject(v vocab.RejectInterface) {
	this.clear()
	this.RejectMember = v
}
...
// afterwards returns true.
func (this *ToPropertyIterator) SetRelationship(v vocab.RelationshipInterface) {
	this.clear()
...
// true.
func (this *ToPropertyIterator) SetRemove(v vocab.RemoveInterface) {
	this.clear()
	this.RemoveMember = v
}
...
// returns true.
func (this *ToPropertyIterator) SetService(v vocab.ServiceInterface) {
	this.clear()
...
// afterwards returns true.
func (this *ToPropertyIterator) SetTentativeAccept(v vocab.TentativeAcceptInterface) {
	this.clear()
...
// afterwards returns true.
func (this *ToPropertyIterator) SetTentativeReject(v vocab.TentativeRejectInterface) {
	this.clear()
...
// returns true.
func (this *ToPropertyIterator) SetTombstone(v vocab.TombstoneInterface) {
	this.clear()
...
// true.
func (this *ToPropertyIterator) SetTravel(v vocab.TravelInterface) {
	this.clear()
	this.TravelMember = v
}

// SetUndo sets the value of this property. Calling IsUndo afterwards returns true.
func (this *ToPropertyIterator) SetUndo(v vocab.UndoInterface) {
	this.clear()
	this.UndoMember = v
}
...
// true.
func (this *ToPropertyIterator) SetUpdate(v vocab.UpdateInterface) {
	this.clear()
	this.UpdateMember = v
}
...
// true.
func (this *ToPropertyIterator) SetVideo(v vocab.VideoInterface) {
	this.clear()
	this.VideoMember = v
}

// SetView sets the value of this property. Calling IsView afterwards returns true.
func (this *ToPropertyIterator) SetView(v vocab.ViewInterface) {
	this.clear()
	this.ViewMember = v
}
...
func (this *ToPropertyIterator) clear() {
...
func (this ToPropertyIterator) serialize() (interface{}, error) {
	if this.IsObject() {
...
// more values, and of different value types.
type ToProperty struct {
	properties []*ToPropertyIterator
	alias      string
}
...
func DeserializeToProperty(m map[string]interface{}, aliasMap map[string]string) (vocab.ToPropertyInterface, error) {
	alias := ""
	if a, ok := aliasMap["https://www.w3.org/TR/activitystreams-vocabulary"]; ok {
		alias = a
	}
	...
	if i, ok := m[propName]; ok {
		...
		if list, ok := i.([]interface{}); ok {
			for _, iterator := range list {
				if p, err := deserializeToPropertyIterator(iterator, aliasMap); err != nil {
					return this, err
				} else if p != nil {
			...
			if p, err := deserializeToPropertyIterator(i, aliasMap); err != nil {
				return this, err
			} else if p != nil {
				this.properties = append(this.properties, p)
			}
...
// NewToProperty creates a new to property.
func NewToProperty() *ToProperty {
	return &ToProperty{alias: ""}
}

// AppendAccept appends a Accept value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendAccept(v vocab.AcceptInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		AcceptMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
		parent:       this,
...
func (this *ToProperty) AppendActivity(v vocab.ActivityInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		ActivityMember: v,
		alias:          this.alias,
		myIdx:          this.Len(),
...
// AppendAdd appends a Add value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendAdd(v vocab.AddInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		AddMember: v,
		alias:     this.alias,
		myIdx:     this.Len(),
...
// "to". Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendAnnounce(v vocab.AnnounceInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		AnnounceMember: v,
		alias:          this.alias,
		myIdx:          this.Len(),
...
func (this *ToProperty) AppendApplication(v vocab.ApplicationInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		ApplicationMember: v,
		alias:             this.alias,
		myIdx:             this.Len(),
...
// AppendArrive appends a Arrive value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendArrive(v vocab.ArriveInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		ArriveMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// "to". Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendArticle(v vocab.ArticleInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		ArticleMember: v,
		alias:         this.alias,
		myIdx:         this.Len(),
...
// AppendAudio appends a Audio value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendAudio(v vocab.AudioInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		AudioMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// AppendBlock appends a Block value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendBlock(v vocab.BlockInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		BlockMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// property "to". Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendCollection(v vocab.CollectionInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		CollectionMember: v,
		alias:            this.alias,
		myIdx:            this.Len(),
...
func (this *ToProperty) AppendCollectionPage(v vocab.CollectionPageInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		CollectionPageMember: v,
		alias:                this.alias,
		myIdx:                this.Len(),
...
// AppendCreate appends a Create value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendCreate(v vocab.CreateInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		CreateMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendDelete appends a Delete value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendDelete(v vocab.DeleteInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		DeleteMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// "to". Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendDislike(v vocab.DislikeInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		DislikeMember: v,
		alias:         this.alias,
		myIdx:         this.Len(),
...
// "to". Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendDocument(v vocab.DocumentInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		DocumentMember: v,
		alias:          this.alias,
		myIdx:          this.Len(),
...
// AppendEvent appends a Event value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendEvent(v vocab.EventInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		EventMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// AppendFlag appends a Flag value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendFlag(v vocab.FlagInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		FlagMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendFollow appends a Follow value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendFollow(v vocab.FollowInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		FollowMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendGroup appends a Group value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendGroup(v vocab.GroupInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		GroupMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
func (this *ToProperty) AppendIRI(v *url.URL) {
	this.properties = append(this.properties, &ToPropertyIterator{
		alias:  this.alias,
		iri:    v,
		myIdx:  this.Len(),
...
// AppendIgnore appends a Ignore value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendIgnore(v vocab.IgnoreInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		IgnoreMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendImage appends a Image value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendImage(v vocab.ImageInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		ImageMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// using Prev.
func (this *ToProperty) AppendIntransitiveActivity(v vocab.IntransitiveActivityInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		IntransitiveActivityMember: v,
		alias:                      this.alias,
		myIdx:                      this.Len(),
...
// AppendInvite appends a Invite value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendInvite(v vocab.InviteInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		InviteMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendJoin appends a Join value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendJoin(v vocab.JoinInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		JoinMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendLeave appends a Leave value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendLeave(v vocab.LeaveInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		LeaveMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// AppendLike appends a Like value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendLike(v vocab.LikeInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		LikeMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendLink appends a Link value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendLink(v vocab.LinkInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		LinkMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendListen appends a Listen value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendListen(v vocab.ListenInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		ListenMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// "to". Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendMention(v vocab.MentionInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		MentionMember: v,
		alias:         this.alias,
		myIdx:         this.Len(),
...
// AppendMove appends a Move value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendMove(v vocab.MoveInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		MoveMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendNote appends a Note value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendNote(v vocab.NoteInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		NoteMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendObject appends a Object value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendObject(v vocab.ObjectInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		ObjectMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendOffer appends a Offer value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendOffer(v vocab.OfferInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		OfferMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
func (this *ToProperty) AppendOrderedCollection(v vocab.OrderedCollectionInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		OrderedCollectionMember: v,
		alias:                   this.alias,
		myIdx:                   this.Len(),
...
// using Prev.
func (this *ToProperty) AppendOrderedCollectionPage(v vocab.OrderedCollectionPageInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		OrderedCollectionPageMember: v,
		alias:                       this.alias,
		myIdx:                       this.Len(),
...
// property "to". Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendOrganization(v vocab.OrganizationInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		OrganizationMember: v,
		alias:              this.alias,
		myIdx:              this.Len(),
...
// AppendPage appends a Page value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendPage(v vocab.PageInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		PageMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendPerson appends a Person value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendPerson(v vocab.PersonInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		PersonMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendPlace appends a Place value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendPlace(v vocab.PlaceInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		PlaceMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// "to". Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendProfile(v vocab.ProfileInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		ProfileMember: v,
		alias:         this.alias,
		myIdx:         this.Len(),
...
// "to". Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendQuestion(v vocab.QuestionInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		QuestionMember: v,
		alias:          this.alias,
		myIdx:          this.Len(),
...
// AppendRead appends a Read value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendRead(v vocab.ReadInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		ReadMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendReject appends a Reject value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendReject(v vocab.RejectInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		RejectMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// property "to". Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendRelationship(v vocab.RelationshipInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		RelationshipMember: v,
		alias:              this.alias,
		myIdx:              this.Len(),
...
// AppendRemove appends a Remove value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendRemove(v vocab.RemoveInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		RemoveMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// "to". Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendService(v vocab.ServiceInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		ServiceMember: v,
		alias:         this.alias,
		myIdx:         this.Len(),
...
// the property "to". Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendTentativeAccept(v vocab.TentativeAcceptInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		TentativeAcceptMember: v,
		alias:                 this.alias,
		myIdx:                 this.Len(),
...
// the property "to". Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendTentativeReject(v vocab.TentativeRejectInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		TentativeRejectMember: v,
		alias:                 this.alias,
		myIdx:                 this.Len(),
...
// "to". Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendTombstone(v vocab.TombstoneInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		TombstoneMember: v,
		alias:           this.alias,
		myIdx:           this.Len(),
...
// AppendTravel appends a Travel value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendTravel(v vocab.TravelInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		TravelMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendUndo appends a Undo value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendUndo(v vocab.UndoInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		UndoMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// AppendUpdate appends a Update value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendUpdate(v vocab.UpdateInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		UpdateMember: v,
		alias:        this.alias,
		myIdx:        this.Len(),
...
// AppendVideo appends a Video value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendVideo(v vocab.VideoInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		VideoMember: v,
		alias:       this.alias,
		myIdx:       this.Len(),
...
// AppendView appends a View value to the back of a list of the property "to".
// Invalidates iterators that are traversing using Prev.
func (this *ToProperty) AppendView(v vocab.ViewInterface) {
	this.properties = append(this.properties, &ToPropertyIterator{
		ViewMember: v,
		alias:      this.alias,
		myIdx:      this.Len(),
...
// out of bounds.
func (this ToProperty) At(index int) vocab.ToPropertyIteratorInterface {
...
func (this ToProperty) Begin() vocab.ToPropertyIteratorInterface {
	if this.Empty() {
		return nil
	} else {
...
func (this ToProperty) Empty() bool {
	return this.Len() == 0
}
...
func (this ToProperty) End() vocab.ToPropertyIteratorInterface {
	return nil
}
...
// property and the specific values that are set. The value in the map is the
// alias used to import the property's value or values.
func (this ToProperty) JSONLDContext() map[string]string {
	m := map[string]string{"https://www.w3.org/TR/activitystreams-vocabulary": this.alias}
...
// out of bounds.
func (this ToProperty) KindIndex(idx int) int {
	return this.properties[idx].KindIndex()
}

// Len returns the number of values that exist for the "to" property.
func (this ToProperty) Len() (length int) {
	return len(this.properties)
}

// Less computes whether another property is less than this one. Mixing types
// results in a consistent but arbitrary ordering
func (this ToProperty) Less(i, j int) bool {
...
// help alternative implementations to go-fed to be able to normalize
// nonfunctional properties.
func (this ToProperty) LessThan(o vocab.ToPropertyInterface) bool {
	l1 := this.Len()
	l2 := o.Len()
	l := l1
	if l2 < l1 {
...
// Name returns the name of this property: "to".
func (this ToProperty) Name() string {
	return "to"
}

// PrependAccept prepends a Accept value to the front of a list of the property
// "to". Invalidates all iterators.
func (this *ToProperty) PrependAccept(v vocab.AcceptInterface) {
	this.properties = append([]*ToPropertyIterator{{
		AcceptMember: v,
		alias:        this.alias,
		myIdx:        0,
		parent:       this,
...
func (this *ToProperty) PrependActivity(v vocab.ActivityInterface) {
	this.properties = append([]*ToPropertyIterator{{
		ActivityMember: v,
		alias:          this.alias,
		myIdx:          0,
...
// PrependAdd prepends a Add value to the front of a list of the property "to".
// Invalidates all iterators.
func (this *ToProperty) PrependAdd(v vocab.AddInterface) {
	this.properties = append([]*ToPropertyIterator{{
		AddMember: v,
		alias:     this.alias,
		myIdx:     0,
...
// property "to". Invalidates all iterators.
func (this *ToProperty) PrependAnnounce(v vocab.AnnounceInterface) {
	this.properties = append([]*ToPropertyIterator{{
		AnnounceMember: v,
		alias:          this.alias,
		myIdx:          0,
...
// property "to". Invalidates all iterators.
func (this *ToProperty) PrependApplication(v vocab.ApplicationInterface) {
	this.properties = append([]*ToPropertyIterator{{
		ApplicationMember: v,
		alias:             this.alias,
		myIdx:             0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependArrive(v vocab.ArriveInterface) {
	this.properties = append([]*ToPropertyIterator{{
		ArriveMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependArticle(v vocab.ArticleInterface) {
	this.properties = append([]*ToPropertyIterator{{
		ArticleMember: v,
		alias:         this.alias,
		myIdx:         0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependAudio(v vocab.AudioInterface) {
	this.properties = append([]*ToPropertyIterator{{
		AudioMember: v,
		alias:       this.alias,
		myIdx:       0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependBlock(v vocab.BlockInterface) {
	this.properties = append([]*ToPropertyIterator{{
		BlockMember: v,
		alias:       this.alias,
		myIdx:       0,
...
// property "to". Invalidates all iterators.
func (this *ToProperty) PrependCollection(v vocab.CollectionInterface) {
	this.properties = append([]*ToPropertyIterator{{
		CollectionMember: v,
		alias:            this.alias,
		myIdx:            0,
...
func (this *ToProperty) PrependCollectionPage(v vocab.CollectionPageInterface) {
	this.properties = append([]*ToPropertyIterator{{
		CollectionPageMember: v,
		alias:                this.alias,
		myIdx:                0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependCreate(v vocab.CreateInterface) {
	this.properties = append([]*ToPropertyIterator{{
		CreateMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependDelete(v vocab.DeleteInterface) {
	this.properties = append([]*ToPropertyIterator{{
		DeleteMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependDislike(v vocab.DislikeInterface) {
	this.properties = append([]*ToPropertyIterator{{
		DislikeMember: v,
		alias:         this.alias,
		myIdx:         0,
...
// property "to". Invalidates all iterators.
func (this *ToProperty) PrependDocument(v vocab.DocumentInterface) {
	this.properties = append([]*ToPropertyIterator{{
		DocumentMember: v,
		alias:          this.alias,
		myIdx:          0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependEvent(v vocab.EventInterface) {
	this.properties = append([]*ToPropertyIterator{{
		EventMember: v,
		alias:       this.alias,
		myIdx:       0,
...
// PrependFlag prepends a Flag value to the front of a list of the property "to".
// Invalidates all iterators.
func (this *ToProperty) PrependFlag(v vocab.FlagInterface) {
	this.properties = append([]*ToPropertyIterator{{
		FlagMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependFollow(v vocab.FollowInterface) {
	this.properties = append([]*ToPropertyIterator{{
		FollowMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependGroup(v vocab.GroupInterface) {
	this.properties = append([]*ToPropertyIterator{{
		GroupMember: v,
		alias:       this.alias,
		myIdx:       0,
...
func (this *ToProperty) PrependIRI(v *url.URL) {
	this.properties = append([]*ToPropertyIterator{{
		alias:  this.alias,
		iri:    v,
		myIdx:  0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependIgnore(v vocab.IgnoreInterface) {
	this.properties = append([]*ToPropertyIterator{{
		IgnoreMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependImage(v vocab.ImageInterface) {
	this.properties = append([]*ToPropertyIterator{{
		ImageMember: v,
		alias:       this.alias,
		myIdx:       0,
...
func (this *ToProperty) PrependIntransitiveActivity(v vocab.IntransitiveActivityInterface) {
	this.properties = append([]*ToPropertyIterator{{
		IntransitiveActivityMember: v,
		alias:                      this.alias,
		myIdx:                      0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependInvite(v vocab.InviteInterface) {
	this.properties = append([]*ToPropertyIterator{{
		InviteMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// PrependJoin prepends a Join value to the front of a list of the property "to".
// Invalidates all iterators.
func (this *ToProperty) PrependJoin(v vocab.JoinInterface) {
	this.properties = append([]*ToPropertyIterator{{
		JoinMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependLeave(v vocab.LeaveInterface) {
	this.properties = append([]*ToPropertyIterator{{
		LeaveMember: v,
		alias:       this.alias,
		myIdx:       0,
...
// PrependLike prepends a Like value to the front of a list of the property "to".
// Invalidates all iterators.
func (this *ToProperty) PrependLike(v vocab.LikeInterface) {
	this.properties = append([]*ToPropertyIterator{{
		LikeMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// PrependLink prepends a Link value to the front of a list of the property "to".
// Invalidates all iterators.
func (this *ToProperty) PrependLink(v vocab.LinkInterface) {
	this.properties = append([]*ToPropertyIterator{{
		LinkMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependListen(v vocab.ListenInterface) {
	this.properties = append([]*ToPropertyIterator{{
		ListenMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependMention(v vocab.MentionInterface) {
	this.properties = append([]*ToPropertyIterator{{
		MentionMember: v,
		alias:         this.alias,
		myIdx:         0,
...
// PrependMove prepends a Move value to the front of a list of the property "to".
// Invalidates all iterators.
func (this *ToProperty) PrependMove(v vocab.MoveInterface) {
	this.properties = append([]*ToPropertyIterator{{
		MoveMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// PrependNote prepends a Note value to the front of a list of the property "to".
// Invalidates all iterators.
func (this *ToProperty) PrependNote(v vocab.NoteInterface) {
	this.properties = append([]*ToPropertyIterator{{
		NoteMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependObject(v vocab.ObjectInterface) {
	this.properties = append([]*ToPropertyIterator{{
		ObjectMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependOffer(v vocab.OfferInterface) {
	this.properties = append([]*ToPropertyIterator{{
		OfferMember: v,
		alias:       this.alias,
		myIdx:       0,
...
func (this *ToProperty) PrependOrderedCollection(v vocab.OrderedCollectionInterface) {
	this.properties = append([]*ToPropertyIterator{{
		OrderedCollectionMember: v,
		alias:                   this.alias,
		myIdx:                   0,
...
func (this *ToProperty) PrependOrderedCollectionPage(v vocab.OrderedCollectionPageInterface) {
	this.properties = append([]*ToPropertyIterator{{
		OrderedCollectionPageMember: v,
		alias:                       this.alias,
		myIdx:                       0,
...
// property "to". Invalidates all iterators.
func (this *ToProperty) PrependOrganization(v vocab.OrganizationInterface) {
	this.properties = append([]*ToPropertyIterator{{
		OrganizationMember: v,
		alias:              this.alias,
		myIdx:              0,
...
// PrependPage prepends a Page value to the front of a list of the property "to".
// Invalidates all iterators.
func (this *ToProperty) PrependPage(v vocab.PageInterface) {
	this.properties = append([]*ToPropertyIterator{{
		PageMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependPerson(v vocab.PersonInterface) {
	this.properties = append([]*ToPropertyIterator{{
		PersonMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependPlace(v vocab.PlaceInterface) {
	this.properties = append([]*ToPropertyIterator{{
		PlaceMember: v,
		alias:       this.alias,
		myIdx:       0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependProfile(v vocab.ProfileInterface) {
	this.properties = append([]*ToPropertyIterator{{
		ProfileMember: v,
		alias:         this.alias,
		myIdx:         0,
...
// property "to". Invalidates all iterators.
func (this *ToProperty) PrependQuestion(v vocab.QuestionInterface) {
	this.properties = append([]*ToPropertyIterator{{
		QuestionMember: v,
		alias:          this.alias,
		myIdx:          0,
...
// PrependRead prepends a Read value to the front of a list of the property "to".
// Invalidates all iterators.
func (this *ToProperty) PrependRead(v vocab.ReadInterface) {
	this.properties = append([]*ToPropertyIterator{{
		ReadMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependReject(v vocab.RejectInterface) {
	this.properties = append([]*ToPropertyIterator{{
		RejectMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// property "to". Invalidates all iterators.
func (this *ToProperty) PrependRelationship(v vocab.RelationshipInterface) {
	this.properties = append([]*ToPropertyIterator{{
		RelationshipMember: v,
		alias:              this.alias,
		myIdx:              0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependRemove(v vocab.RemoveInterface) {
	this.properties = append([]*ToPropertyIterator{{
		RemoveMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependService(v vocab.ServiceInterface) {
	this.properties = append([]*ToPropertyIterator{{
		ServiceMember: v,
		alias:         this.alias,
		myIdx:         0,
...
func (this *ToProperty) PrependTentativeAccept(v vocab.TentativeAcceptInterface) {
	this.properties = append([]*ToPropertyIterator{{
		TentativeAcceptMember: v,
		alias:                 this.alias,
		myIdx:                 0,
...
// of the property "to". Invalidates all iterators.
func (this *ToProperty) PrependTentativeReject(v vocab.TentativeRejectInterface) {
	this.properties = append([]*ToPropertyIterator{{
		TentativeRejectMember: v,
		alias:                 this.alias,
		myIdx:                 0,
...
// property "to". Invalidates all iterators.
func (this *ToProperty) PrependTombstone(v vocab.TombstoneInterface) {
	this.properties = append([]*ToPropertyIterator{{
		TombstoneMember: v,
		alias:           this.alias,
		myIdx:           0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependTravel(v vocab.TravelInterface) {
	this.properties = append([]*ToPropertyIterator{{
		TravelMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// PrependUndo prepends a Undo value to the front of a list of the property "to".
// Invalidates all iterators.
func (this *ToProperty) PrependUndo(v vocab.UndoInterface) {
	this.properties = append([]*ToPropertyIterator{{
		UndoMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependUpdate(v vocab.UpdateInterface) {
	this.properties = append([]*ToPropertyIterator{{
		UpdateMember: v,
		alias:        this.alias,
		myIdx:        0,
...
// "to". Invalidates all iterators.
func (this *ToProperty) PrependVideo(v vocab.VideoInterface) {
	this.properties = append([]*ToPropertyIterator{{
		VideoMember: v,
		alias:       this.alias,
		myIdx:       0,
...
// PrependView prepends a View value to the front of a list of the property "to".
// Invalidates all iterators.
func (this *ToProperty) PrependView(v vocab.ViewInterface) {
	this.properties = append([]*ToPropertyIterator{{
		ViewMember: v,
		alias:      this.alias,
		myIdx:      0,
...
// Invalidates all iterators.
func (this *ToProperty) Remove(idx int) {
	(this.properties)[idx].parent = nil
	copy((this.properties)[idx:], (this.properties)[idx+1:])
	(this.properties)[len(this.properties)-1] = &ToPropertyIterator{}
...
// function as most typical use cases serialize types instead of individual
// properties. It is exposed for alternatives to go-fed implementations to use.
func (this ToProperty) Serialize() (interface{}, error) {
...
func (this *ToProperty) SetAccept(idx int, v vocab.AcceptInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		AcceptMember: v,
		alias:        this.alias,
		myIdx:        idx,
		parent:       this,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetActivity(idx int, v vocab.ActivityInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		ActivityMember: v,
		alias:          this.alias,
...
// SetAdd sets a Add value to be at the specified index for the property "to".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetAdd(idx int, v vocab.AddInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		AddMember: v,
		alias:     this.alias,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetAnnounce(idx int, v vocab.AnnounceInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		AnnounceMember: v,
		alias:          this.alias,
...
// iterators.
func (this *ToProperty) SetApplication(idx int, v vocab.ApplicationInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		ApplicationMember: v,
		alias:             this.alias,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetArrive(idx int, v vocab.ArriveInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		ArriveMember: v,
		alias:        this.alias,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetArticle(idx int, v vocab.ArticleInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		ArticleMember: v,
		alias:         this.alias,
...
// SetAudio sets a Audio value to be at the specified index for the property "to".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetAudio(idx int, v vocab.AudioInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		AudioMember: v,
		alias:       this.alias,
...
// SetBlock sets a Block value to be at the specified index for the property "to".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetBlock(idx int, v vocab.BlockInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		BlockMember: v,
		alias:       this.alias,
...
// property "to". Panics if the index is out of bounds. Invalidates all
// iterators.
func (this *ToProperty) SetCollection(idx int, v vocab.CollectionInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		CollectionMember: v,
		alias:            this.alias,
...
// iterators.
func (this *ToProperty) SetCollectionPage(idx int, v vocab.CollectionPageInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		CollectionPageMember: v,
		alias:                this.alias,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetCreate(idx int, v vocab.CreateInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		CreateMember: v,
		alias:        this.alias,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetDelete(idx int, v vocab.DeleteInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		DeleteMember: v,
		alias:        this.alias,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetDislike(idx int, v vocab.DislikeInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		DislikeMember: v,
		alias:         this.alias,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetDocument(idx int, v vocab.DocumentInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		DocumentMember: v,
		alias:          this.alias,
...
// SetEvent sets a Event value to be at the specified index for the property "to".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetEvent(idx int, v vocab.EventInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		EventMember: v,
		alias:       this.alias,
...
// SetFlag sets a Flag value to be at the specified index for the property "to".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetFlag(idx int, v vocab.FlagInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		FlagMember: v,
		alias:      this.alias,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetFollow(idx int, v vocab.FollowInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		FollowMember: v,
		alias:        this.alias,
...
// SetGroup sets a Group value to be at the specified index for the property "to".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetGroup(idx int, v vocab.GroupInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		GroupMember: v,
		alias:       this.alias,
...
func (this *ToProperty) SetIRI(idx int, v *url.URL) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		alias:  this.alias,
		iri:    v,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetIgnore(idx int, v vocab.IgnoreInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		IgnoreMember: v,
		alias:        this.alias,
...
// SetImage sets a Image value to be at the specified index for the property "to".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetImage(idx int, v vocab.ImageInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		ImageMember: v,
		alias:       this.alias,
...
func (this *ToProperty) SetIntransitiveActivity(idx int, v vocab.IntransitiveActivityInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		IntransitiveActivityMember: v,
		alias:                      this.alias,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetInvite(idx int, v vocab.InviteInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		InviteMember: v,
		alias:        this.alias,
...
// SetJoin sets a Join value to be at the specified index for the property "to".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetJoin(idx int, v vocab.JoinInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		JoinMember: v,
		alias:      this.alias,
...
// SetLeave sets a Leave value to be at the specified index for the property "to".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetLeave(idx int, v vocab.LeaveInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		LeaveMember: v,
		alias:       this.alias,
...
// SetLike sets a Like value to be at the specified index for the property "to".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetLike(idx int, v vocab.LikeInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		LikeMember: v,
		alias:      this.alias,
...
// SetLink sets a Link value to be at the specified index for the property "to".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetLink(idx int, v vocab.LinkInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		LinkMember: v,
		alias:      this.alias,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetListen(idx int, v vocab.ListenInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		ListenMember: v,
		alias:        this.alias,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetMention(idx int, v vocab.MentionInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		MentionMember: v,
		alias:         this.alias,
...
// SetMove sets a Move value to be at the specified index for the property "to".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetMove(idx int, v vocab.MoveInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		MoveMember: v,
		alias:      this.alias,
...
// SetNote sets a Note value to be at the specified index for the property "to".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetNote(idx int, v vocab.NoteInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		NoteMember: v,
		alias:      this.alias,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetObject(idx int, v vocab.ObjectInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		ObjectMember: v,
		alias:        this.alias,
...
// SetOffer sets a Offer value to be at the specified index for the property "to".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetOffer(idx int, v vocab.OfferInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		OfferMember: v,
		alias:       this.alias,
...
// Invalidates all iterators.
func (this *ToProperty) SetOrderedCollection(idx int, v vocab.OrderedCollectionInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		OrderedCollectionMember: v,
		alias:                   this.alias,
...
// specified index for the property "to". Panics if the index is out of
// bounds. Invalidates all iterators.
func (this *ToProperty) SetOrderedCollectionPage(idx int, v vocab.OrderedCollectionPageInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		OrderedCollectionPageMember: v,
		alias:                       this.alias,
...
// property "to". Panics if the index is out of bounds. Invalidates all
// iterators.
func (this *ToProperty) SetOrganization(idx int, v vocab.OrganizationInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		OrganizationMember: v,
		alias:              this.alias,
...
// SetPage sets a Page value to be at the specified index for the property "to".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetPage(idx int, v vocab.PageInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		PageMember: v,
		alias:      this.alias,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetPerson(idx int, v vocab.PersonInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		PersonMember: v,
		alias:        this.alias,
...
// SetPlace sets a Place value to be at the specified index for the property "to".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetPlace(idx int, v vocab.PlaceInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		PlaceMember: v,
		alias:       this.alias,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetProfile(idx int, v vocab.ProfileInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		ProfileMember: v,
		alias:         this.alias,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetQuestion(idx int, v vocab.QuestionInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		QuestionMember: v,
		alias:          this.alias,
...
// SetRead sets a Read value to be at the specified index for the property "to".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetRead(idx int, v vocab.ReadInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		ReadMember: v,
		alias:      this.alias,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetReject(idx int, v vocab.RejectInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		RejectMember: v,
		alias:        this.alias,
...
// property "to". Panics if the index is out of bounds. Invalidates all
// iterators.
func (this *ToProperty) SetRelationship(idx int, v vocab.RelationshipInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		RelationshipMember: v,
		alias:              this.alias,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetRemove(idx int, v vocab.RemoveInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		RemoveMember: v,
		alias:        this.alias,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetService(idx int, v vocab.ServiceInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		ServiceMember: v,
		alias:         this.alias,
...
// all iterators.
func (this *ToProperty) SetTentativeAccept(idx int, v vocab.TentativeAcceptInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		TentativeAcceptMember: v,
		alias:                 this.alias,
...
// for the property "to". Panics if the index is out of bounds. Invalidates
// all iterators.
func (this *ToProperty) SetTentativeReject(idx int, v vocab.TentativeRejectInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		TentativeRejectMember: v,
		alias:                 this.alias,
...
// property "to". Panics if the index is out of bounds. Invalidates all
// iterators.
func (this *ToProperty) SetTombstone(idx int, v vocab.TombstoneInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		TombstoneMember: v,
		alias:           this.alias,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetTravel(idx int, v vocab.TravelInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		TravelMember: v,
		alias:        this.alias,
...
// SetUndo sets a Undo value to be at the specified index for the property "to".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetUndo(idx int, v vocab.UndoInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		UndoMember: v,
		alias:      this.alias,
...
// "to". Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetUpdate(idx int, v vocab.UpdateInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		UpdateMember: v,
		alias:        this.alias,
...
// SetVideo sets a Video value to be at the specified index for the property "to".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetVideo(idx int, v vocab.VideoInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		VideoMember: v,
		alias:       this.alias,
...
// SetView sets a View value to be at the specified index for the property "to".
// Panics if the index is out of bounds. Invalidates all iterators.
func (this *ToProperty) SetView(idx int, v vocab.ViewInterface) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ToPropertyIterator{
		ViewMember: v,
		alias:      this.alias,
...
func (this ToProperty) Swap(i, j int) {
