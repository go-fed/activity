...
// HeightProperty is the functional property "height". It is permitted to be a
...
func DeserializeHeightProperty(m map[string]interface{}, aliasMap map[string]string) (*HeightProperty, error) {
	alias := ""
...
// NewHeightProperty creates a new height property.
func NewHeightProperty() *HeightProperty {
	return &HeightProperty{alias: ""}
}

// Clear ensures no value of this property is set. Calling IsNonNegativeInteger
// afterwards will return false.
func (this *HeightProperty) Clear() {
	this.unknown = nil
	this.iri = nil
...
func (this HeightProperty) Get() int {
	return this.nonNegativeIntegerMember
}

// GetIRI returns the IRI of this property. When IsIRI returns false, GetIRI will
// return any arbitrary value.
func (this HeightProperty) GetIRI() *url.URL {
	return this.iri
}

// HasAny returns true if the value or IRI is set.
func (this HeightProperty) HasAny() bool {
	return this.IsNonNegativeInteger() || this.iri != nil
}

// IsIRI returns true if this property is an IRI.
func (this HeightProperty) IsIRI() bool {
	return this.iri != nil
}

// IsNonNegativeInteger returns true if this property is set and not an IRI.
func (this HeightProperty) IsNonNegativeInteger() bool {
...
func (this HeightProperty) JSONLDContext() map[string]string {
...
func (this HeightProperty) KindIndex() int {
...
func (this HeightProperty) LessThan(o vocab.HeightPropertyInterface) bool {
...
func (this HeightProperty) Name() string {
	return "height"
}
...
func (this HeightProperty) Serialize() (interface{}, error) {
	if this.IsNonNegativeInteger() {
...
// will return true.
func (this *HeightProperty) Set(v int) {
	this.Clear()
...
// true.
func (this *HeightProperty) SetIRI(v *url.URL) {
	this.Clear()
	this.iri = v
}
