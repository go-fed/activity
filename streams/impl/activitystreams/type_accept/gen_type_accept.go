...
func (this Accept) GetSummary() vocab.SummaryPropertyInterface {
	return this.Summary
}

// GetTag returns the "tag" property if it exists, and nil otherwise.
func (this Accept) GetTag() vocab.TagPropertyInterface {
	return this.Tag
}

// GetTarget returns the "target" property if it exists, and nil otherwise.
func (this Accept) GetTarget() vocab.TargetPropertyInterface {
	return this.Target
}

// GetTo returns the "to" property if it exists, and nil otherwise.
func (this Accept) GetTo() vocab.ToPropertyInterface {
	return this.To
}

// GetType returns the "type" property if it exists, and nil otherwise.
func (this Accept) GetType() vocab.TypePropertyInterface {
	return this.Type
}
...
func (this Accept) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Accept) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Accept) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Accept type extends from the other type.
func (this Accept) IsExtending(other vocab.Type) bool {
	return AcceptExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Accept) JSONLDContext() map[string]string {
...
// determination.
func (this Accept) LessThan(o vocab.AcceptInterface) bool {
...
func (this Accept) Serialize() (interface{}, error) {
...
// if it is not nil.
func (this Accept) helperJSONLDContext(i jsonldContexter, toMerge map[string]string) map[string]string {
	if i == nil {
		return toMerge
	}
