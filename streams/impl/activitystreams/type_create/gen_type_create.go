...
// CreateExtends returns true if the Create type extends from the other type.
func CreateExtends(other vocab.Type) bool {
...
func DeserializeCreate(m map[string]interface{}, aliasMap map[string]string) (*Create, error) {
	alias := ""
	aliasPrefix := ""
...
func (this Create) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Create) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Create) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Create type extends from the other type.
func (this Create) IsExtending(other vocab.Type) bool {
	return CreateExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Create) JSONLDContext() map[string]string {
...
// determination.
func (this Create) LessThan(o vocab.CreateInterface) bool {
...
func (this Create) Serialize() (map[string]interface{}, error) {
