...
func DeserializeVideo(m map[string]interface{}, aliasMap map[string]string) (*Video, error) {
	alias := ""
	aliasPrefix := ""
...
// VideoExtends returns true if the Video type extends from the other type.
func VideoExtends(other vocab.Type) bool {
...
func (this Video) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Video) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Video) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Video type extends from the other type.
func (this Video) IsExtending(other vocab.Type) bool {
	return VideoExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Video) JSONLDContext() map[string]string {
...
// determination.
func (this Video) LessThan(o vocab.VideoInterface) bool {
...
func (this Video) Serialize() (map[string]interface{}, error) {
