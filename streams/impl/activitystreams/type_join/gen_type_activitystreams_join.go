...
func (this ActivityStreamsJoin) GetJSONLDId() vocab.JSONLDIdProperty {
	return this.JSONLDId
}

// GetJSONLDType returns the "type" property if it exists, and nil otherwise.
func (this ActivityStreamsJoin) GetJSONLDType() vocab.JSONLDTypeProperty {
...
func (this *ActivityStreamsJoin) SetJSONLDId(i vocab.JSONLDIdProperty) {
	this.JSONLDId = i
}

// SetJSONLDType sets the "type" property.
func (this *ActivityStreamsJoin) SetJSONLDType(i vocab.JSONLDTypeProperty) {
	this.JSONLDType = i
}
