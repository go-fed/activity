...
// JoinExtends returns true if the Join type extends from the other type.
func JoinExtends(other vocab.Type) bool {
...
func (this Join) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Join) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Join) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Join type extends from the other type.
func (this Join) IsExtending(other vocab.Type) bool {
	return JoinExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Join) JSONLDContext() map[string]string {
...
// determination.
func (this Join) LessThan(o vocab.JoinInterface) bool {
...
func (this Join) Serialize() (interface{}, error) {
...
// if it is not nil.
func (this Join) helperJSONLDContext(i jsonldContexter, toMerge map[string]string) map[string]string {
	if i == nil {
		return toMerge
	}
