...
func DeserializeService(m map[string]interface{}, aliasMap map[string]string) (*Service, error) {
	alias := ""
	aliasPrefix := ""
...
// ServiceExtends returns true if the Service type extends from the other type.
func ServiceExtends(other vocab.Type) bool {
...
func (this Service) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Service) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Service) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Service type extends from the other type.
func (this Service) IsExtending(other vocab.Type) bool {
	return ServiceExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Service) JSONLDContext() map[string]string {
...
// determination.
func (this Service) LessThan(o vocab.ServiceInterface) bool {
...
func (this Service) Serialize() (map[string]interface{}, error) {
