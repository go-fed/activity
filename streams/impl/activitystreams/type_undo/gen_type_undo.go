...
func DeserializeUndo(m map[string]interface{}, aliasMap map[string]string) (*Undo, error) {
	alias := ""
	aliasPrefix := ""
...
// UndoExtends returns true if the Undo type extends from the other type.
func UndoExtends(other vocab.Type) bool {
...
func (this Undo) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Undo) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Undo) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Undo type extends from the other type.
func (this Undo) IsExtending(other vocab.Type) bool {
	return UndoExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Undo) JSONLDContext() map[string]string {
...
// determination.
func (this Undo) LessThan(o vocab.UndoInterface) bool {
...
func (this Undo) Serialize() (map[string]interface{}, error) {
