...
// WidthProperty is the functional property "width". It is permitted to be a
...
func DeserializeWidthProperty(m map[string]interface{}, aliasMap map[string]string) (*WidthProperty, error) {
	alias := ""
...
// NewWidthProperty creates a new width property.
func NewWidthProperty() *WidthProperty {
	return &WidthProperty{alias: ""}
}

// Clear ensures no value of this property is set. Calling IsNonNegativeInteger
// afterwards will return false.
func (this *WidthProperty) Clear() {
	this.unknown = nil
	this.iri = nil
...
func (this WidthProperty) JSONLDContext() map[string]string {
...
func (this WidthProperty) KindIndex() int {
...
func (this WidthProperty) LessThan(o vocab.WidthPropertyInterface) bool {
...
func (this WidthProperty) Name() string {
	return "width"
}
...
func (this WidthProperty) Serialize() (interface{}, error) {
	if this.IsNonNegativeInteger() {
...
// will return true.
func (this *WidthProperty) Set(v int) {
	this.Clear()
...
// true.
func (this *WidthProperty) SetIRI(v *url.URL) {
	this.Clear()
	this.iri = v
}
