...
func (this OrderedCollectionPage) GetItems() vocab.ItemsPropertyInterface {
	return this.Items
}
...
func (this OrderedCollectionPage) LessThan(o vocab.OrderedCollectionPageInterface) bool {
	...
	if this.StartIndex.LessThan(o.GetStartIndex()) {
		return true
	} else if o.GetStartIndex().LessThan(this.StartIndex) {
		return false
	}
...
func (this OrderedCollectionPage) Serialize() (interface{}, error) {
...
func (this OrderedCollectionPage) SetItems(i vocab.ItemsPropertyInterface) {
	this.Items = i
}
