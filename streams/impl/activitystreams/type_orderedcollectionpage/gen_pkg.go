...
type privateManager interface {
	...
	// method for the "NextPropertyInterface" non-functional property in
	// the vocabulary "ActivityStreams"
	DeserializeNextPropertyActivityStreams() func(map[string]interface{}, map[string]string) (vocab.NextPropertyInterface, error)
	...
	// method for the "PartOfPropertyInterface" non-functional property in
	// the vocabulary "ActivityStreams"
	DeserializePartOfPropertyActivityStreams() func(map[string]interface{}, map[string]string) (vocab.PartOfPropertyInterface, error)
	// DeserializePrevPropertyActivityStreams returns the deserialization
	// method for the "PrevPropertyInterface" non-functional property in
	// the vocabulary "ActivityStreams"
	DeserializePrevPropertyActivityStreams() func(map[string]interface{}, map[string]string) (vocab.PrevPropertyInterface, error)
	...
	// non-functional property in the vocabulary "ActivityStreams"
	DeserializeStartIndexPropertyActivityStreams() func(map[string]interface{}, map[string]string) (vocab.StartIndexPropertyInterface, error)
