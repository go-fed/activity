...
func (this ActivityStreamsOrderedCollectionPage) GetJSONLDId() vocab.JSONLDIdProperty {
	return this.JSONLDId
}

// GetJSONLDType returns the "type" property if it exists, and nil otherwise.
func (this ActivityStreamsOrderedCollectionPage) GetJSONLDType() vocab.JSONLDTypeProperty {
...
func (this *ActivityStreamsOrderedCollectionPage) SetJSONLDId(i vocab.JSONLDIdProperty) {
	this.JSONLDId = i
}

// SetJSONLDType sets the "type" property.
func (this *ActivityStreamsOrderedCollectionPage) SetJSONLDType(i vocab.JSONLDTypeProperty) {
	this.JSONLDType = i
}
