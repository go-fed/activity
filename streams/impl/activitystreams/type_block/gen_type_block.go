...
func DeserializeBlock(m map[string]interface{}, aliasMap map[string]string) (*Block, error) {
	alias := ""
	aliasPrefix := ""
...
func (this Block) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Block) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Block) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Block type extends from the other type.
func (this Block) IsExtending(other vocab.Type) bool {
	return BlockExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Block) JSONLDContext() map[string]string {
...
// determination.
func (this Block) LessThan(o vocab.BlockInterface) bool {
...
func (this Block) Serialize() (map[string]interface{}, error) {
