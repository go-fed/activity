...
//     "type": "Block"
//   }
type ActivityStreamsBlock struct {
...
// ActivityStreamsBlockExtends returns true if the Block type extends from the
// other type.
...
// DeserializeBlock creates a Block from a map representation that has been
// unmarshalled from a text or binary format.
func DeserializeBlock(m map[string]interface{}, aliasMap map[string]string) (*ActivityStreamsBlock, error) {
	alias := ""
	aliasPrefix := ""
	...
	if typeValue, ok := m["type"]; !ok {
		...
		if typeName != "Block" {
			return nil, fmt.Errorf("\"type\" property is not of %q type: %s", "Block", typeName)
		}
		// Fall through, success in finding a proper Type
	} else if arrType, ok := typeValue.([]interface{}); ok {
		found := false
		for _, elemVal := range arrType {
			if typeString, ok := elemVal.(string); ok && strings.TrimPrefix(typeString, aliasPrefix) == "Block" {
				found = true
				break
			}
		}
		if !found {
			return nil, fmt.Errorf("could not find a \"type\" property of value %q", "Block")
		}
		// Fall through, success in finding a proper Type
	} else {
...
func NewActivityStreamsBlock() *ActivityStreamsBlock {
	...
	typeProp.AppendXMLSchemaString("Block")
...
// otherwise.
func (this ActivityStreamsBlock) GetActivityStreamsSummary() vocab.ActivityStreamsSummaryProperty {
	return this.ActivityStreamsSummary
}

// GetActivityStreamsTag returns the "tag" property if it exists, and nil
// otherwise.
func (this ActivityStreamsBlock) GetActivityStreamsTag() vocab.ActivityStreamsTagProperty {
	return this.ActivityStreamsTag
}

// GetActivityStreamsTarget returns the "target" property if it exists, and nil
// otherwise.
func (this ActivityStreamsBlock) GetActivityStreamsTarget() vocab.ActivityStreamsTargetProperty {
	return this.ActivityStreamsTarget
}

// GetActivityStreamsTo returns the "to" property if it exists, and nil otherwise.
func (this ActivityStreamsBlock) GetActivityStreamsTo() vocab.ActivityStreamsToProperty {
	return this.ActivityStreamsTo
}

// GetActivityStreamsType returns the "type" property if it exists, and nil
// otherwise.
func (this ActivityStreamsBlock) GetActivityStreamsType() vocab.ActivityStreamsTypeProperty {
	return this.ActivityStreamsType
}

// GetActivityStreamsUpdated returns the "updated" property if it exists, and nil
// otherwise.
func (this ActivityStreamsBlock) GetActivityStreamsUpdated() vocab.ActivityStreamsUpdatedProperty {
	return this.ActivityStreamsUpdated
}

// GetActivityStreamsUrl returns the "url" property if it exists, and nil
// otherwise.
func (this ActivityStreamsBlock) GetActivityStreamsUrl() vocab.ActivityStreamsUrlProperty {
...
// GetUnknownProperties returns the unknown properties for the Block type. Note
...
func (this ActivityStreamsBlock) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// IsExtending returns true if the Block type extends from the other type.
func (this ActivityStreamsBlock) IsExtending(other vocab.Type) bool {
	return ActivityStreamsBlockExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this ActivityStreamsBlock) JSONLDContext() map[string]string {
...
// determination.
func (this ActivityStreamsBlock) LessThan(o vocab.ActivityStreamsBlock) bool {
...
func (this ActivityStreamsBlock) Serialize() (map[string]interface{}, error) {
	m := make(map[string]interface{})
	typeName := "Block"
	if len(this.alias) > 0 {
		typeName = this.alias + ":" + "Block"
	}
	m["type"] = typeName
...
// otherwise.
func (this *ActivityStreamsBlock) SetActivityStreamsReplies(i vocab.ActivityStreamsRepliesProperty) {
	this.ActivityStreamsReplies = i
}

// SetActivityStreamsResult returns the "result" property if it exists, and nil
// otherwise.
func (this *ActivityStreamsBlock) SetActivityStreamsResult(i vocab.ActivityStreamsResultProperty) {
...
// otherwise.
func (this *ActivityStreamsBlock) SetActivityStreamsSummary(i vocab.ActivityStreamsSummaryProperty) {
	this.ActivityStreamsSummary = i
}

// SetActivityStreamsTag returns the "tag" property if it exists, and nil
// otherwise.
func (this *ActivityStreamsBlock) SetActivityStreamsTag(i vocab.ActivityStreamsTagProperty) {
	this.ActivityStreamsTag = i
}

// SetActivityStreamsTarget returns the "target" property if it exists, and nil
// otherwise.
func (this *ActivityStreamsBlock) SetActivityStreamsTarget(i vocab.ActivityStreamsTargetProperty) {
	this.ActivityStreamsTarget = i
}

// SetActivityStreamsTo returns the "to" property if it exists, and nil otherwise.
func (this *ActivityStreamsBlock) SetActivityStreamsTo(i vocab.ActivityStreamsToProperty) {
	this.ActivityStreamsTo = i
}

// SetActivityStreamsType returns the "type" property if it exists, and nil
// otherwise.
func (this *ActivityStreamsBlock) SetActivityStreamsType(i vocab.ActivityStreamsTypeProperty) {
	this.ActivityStreamsType = i
}

// SetActivityStreamsUpdated returns the "updated" property if it exists, and nil
// otherwise.
func (this *ActivityStreamsBlock) SetActivityStreamsUpdated(i vocab.ActivityStreamsUpdatedProperty) {
	this.ActivityStreamsUpdated = i
}

// SetActivityStreamsUrl returns the "url" property if it exists, and nil
// otherwise.
func (this *ActivityStreamsBlock) SetActivityStreamsUrl(i vocab.ActivityStreamsUrlProperty) {
	this.ActivityStreamsUrl = i
}

// VocabularyURI returns the vocabulary's URI as a string.
func (this ActivityStreamsBlock) VocabularyURI() string {
	return "https://www.w3.org/TR/activitystreams-vocabulary"
}

// helperJSONLDContext obtains the context uris and their aliases from a property,
// if it is not nil.
func (this ActivityStreamsBlock) helperJSONLDContext(i jsonldContexter, toMerge map[string]string) map[string]string {
	if i == nil {
		return toMerge
	}
