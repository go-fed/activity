...
func (this ActivityStreamsOrderedCollection) GetJSONLDId() vocab.JSONLDIdProperty {
	return this.JSONLDId
}

// GetJSONLDType returns the "type" property if it exists, and nil otherwise.
func (this ActivityStreamsOrderedCollection) GetJSONLDType() vocab.JSONLDTypeProperty {
...
func (this *ActivityStreamsOrderedCollection) SetJSONLDId(i vocab.JSONLDIdProperty) {
	this.JSONLDId = i
}

// SetJSONLDType sets the "type" property.
func (this *ActivityStreamsOrderedCollection) SetJSONLDType(i vocab.JSONLDTypeProperty) {
	this.JSONLDType = i
}
