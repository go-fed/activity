...
func DeserializeMove(m map[string]interface{}, aliasMap map[string]string) (*Move, error) {
	alias := ""
	aliasPrefix := ""
...
// MoveExtends returns true if the Move type extends from the other type.
func MoveExtends(other vocab.Type) bool {
...
func (this Move) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Move) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Move) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Move type extends from the other type.
func (this Move) IsExtending(other vocab.Type) bool {
	return MoveExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Move) JSONLDContext() map[string]string {
...
// determination.
func (this Move) LessThan(o vocab.MoveInterface) bool {
...
func (this Move) Serialize() (map[string]interface{}, error) {
