...
// AudioExtends returns true if the Audio type extends from the other type.
func AudioExtends(other vocab.Type) bool {
...
func DeserializeAudio(m map[string]interface{}, aliasMap map[string]string) (*Audio, error) {
	alias := ""
	aliasPrefix := ""
...
func (this Audio) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Audio) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Audio) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Audio type extends from the other type.
func (this Audio) IsExtending(other vocab.Type) bool {
	return AudioExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Audio) JSONLDContext() map[string]string {
...
// determination.
func (this Audio) LessThan(o vocab.AudioInterface) bool {
...
func (this Audio) Serialize() (map[string]interface{}, error) {
