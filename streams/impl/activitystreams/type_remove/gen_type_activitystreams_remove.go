...
// ActivityStreamsRemoveExtends returns true if the Remove type extends from the
// other type.
...
func NewActivityStreamsRemove() *ActivityStreamsRemove {
	...
	typeProp.AppendXMLSchemaString("Remove")
...
func (this ActivityStreamsRemove) GetActivityStreamsId() vocab.ActivityStreamsIdProperty {
...
// otherwise.
func (this ActivityStreamsRemove) GetActivityStreamsType() vocab.ActivityStreamsTypeProperty {
...
func (this ActivityStreamsRemove) IsExtending(other vocab.Type) bool {
	return ActivityStreamsRemoveExtends(other)
}
...
// determination.
func (this ActivityStreamsRemove) LessThan(o vocab.ActivityStreamsRemove) bool {
...
func (this *ActivityStreamsRemove) SetActivityStreamsId(i vocab.ActivityStreamsIdProperty) {
...
// otherwise.
func (this *ActivityStreamsRemove) SetActivityStreamsType(i vocab.ActivityStreamsTypeProperty) {
...
// if it is not nil.
func (this ActivityStreamsRemove) helperJSONLDContext(i jsonldContexter, toMerge map[string]string) map[string]string {
	if i == nil {
		return toMerge
	}
