...
func DeserializeView(m map[string]interface{}, aliasMap map[string]string) (*View, error) {
	alias := ""
	aliasPrefix := ""
...
// ViewExtends returns true if the View type extends from the other type.
func ViewExtends(other vocab.Type) bool {
...
func (this View) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this View) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this View) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the View type extends from the other type.
func (this View) IsExtending(other vocab.Type) bool {
	return ViewExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this View) JSONLDContext() map[string]string {
...
// determination.
func (this View) LessThan(o vocab.ViewInterface) bool {
...
func (this View) Serialize() (map[string]interface{}, error) {
