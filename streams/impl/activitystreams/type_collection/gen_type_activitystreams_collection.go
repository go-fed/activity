...
// ActivityStreamsCollectionExtends returns true if the Collection type extends
// from the other type.
...
func DeserializeCollection(m map[string]interface{}, aliasMap map[string]string) (*ActivityStreamsCollection, error) {
	...
	this := &ActivityStreamsCollection{
		alias:   alias,
...
func NewActivityStreamsCollection() *ActivityStreamsCollection {
	...
	typeProp.AppendXMLSchemaString("Collection")
...
func (this ActivityStreamsCollection) GetActivityStreamsId() vocab.ActivityStreamsIdProperty {
...
// otherwise.
func (this ActivityStreamsCollection) GetActivityStreamsType() vocab.ActivityStreamsTypeProperty {
...
func (this ActivityStreamsCollection) IsExtending(other vocab.Type) bool {
	return ActivityStreamsCollectionExtends(other)
}
...
// determination.
func (this ActivityStreamsCollection) LessThan(o vocab.ActivityStreamsCollection) bool {
...
func (this *ActivityStreamsCollection) SetActivityStreamsId(i vocab.ActivityStreamsIdProperty) {
...
// SetActivityStreamsItems returns the "items" property if it exists, and nil
// otherwise.
...
// otherwise.
func (this *ActivityStreamsCollection) SetActivityStreamsType(i vocab.ActivityStreamsTypeProperty) {
...
// if it is not nil.
func (this ActivityStreamsCollection) helperJSONLDContext(i jsonldContexter, toMerge map[string]string) map[string]string {
	if i == nil {
		return toMerge
	}
