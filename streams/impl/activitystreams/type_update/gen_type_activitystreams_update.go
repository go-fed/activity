...
// ActivityStreamsUpdateExtends returns true if the Update type extends from the
// other type.
...
func NewActivityStreamsUpdate() *ActivityStreamsUpdate {
	...
	typeProp.AppendXMLSchemaString("Update")
	return &ActivityStreamsUpdate{
...
func (this ActivityStreamsUpdate) GetActivityStreamsId() vocab.ActivityStreamsIdProperty {
...
// otherwise.
func (this ActivityStreamsUpdate) GetActivityStreamsType() vocab.ActivityStreamsTypeProperty {
...
func (this ActivityStreamsUpdate) IsExtending(other vocab.Type) bool {
	return ActivityStreamsUpdateExtends(other)
}
...
// determination.
func (this ActivityStreamsUpdate) LessThan(o vocab.ActivityStreamsUpdate) bool {
...
func (this *ActivityStreamsUpdate) SetActivityStreamsId(i vocab.ActivityStreamsIdProperty) {
...
func (this *ActivityStreamsUpdate) SetActivityStreamsType(i vocab.ActivityStreamsTypeProperty) {
...
// if it is not nil.
func (this ActivityStreamsUpdate) helperJSONLDContext(i jsonldContexter, toMerge map[string]string) map[string]string {
	if i == nil {
		return toMerge
	}
