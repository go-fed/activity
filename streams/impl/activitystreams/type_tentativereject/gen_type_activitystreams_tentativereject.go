...
func (this ActivityStreamsTentativeReject) GetJSONLDId() vocab.JSONLDIdProperty {
	return this.JSONLDId
}

// GetJSONLDType returns the "type" property if it exists, and nil otherwise.
func (this ActivityStreamsTentativeReject) GetJSONLDType() vocab.JSONLDTypeProperty {
...
func (this *ActivityStreamsTentativeReject) SetJSONLDId(i vocab.JSONLDIdProperty) {
	this.JSONLDId = i
}

// SetJSONLDType sets the "type" property.
func (this *ActivityStreamsTentativeReject) SetJSONLDType(i vocab.JSONLDTypeProperty) {
	this.JSONLDType = i
}
