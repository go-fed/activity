...
// PublishedProperty is the functional property "published". It is permitted to be
...
func DeserializePublishedProperty(m map[string]interface{}, aliasMap map[string]string) (*PublishedProperty, error) {
	alias := ""
...
// NewPublishedProperty creates a new published property.
func NewPublishedProperty() *PublishedProperty {
	return &PublishedProperty{alias: ""}
}

// Clear ensures no value of this property is set. Calling IsDateTime afterwards
// will return false.
func (this *PublishedProperty) Clear() {
	this.unknown = nil
	this.iri = nil
...
func (this PublishedProperty) Get() time.Time {
	return this.dateTimeMember
}

// GetIRI returns the IRI of this property. When IsIRI returns false, GetIRI will
// return any arbitrary value.
func (this PublishedProperty) GetIRI() *url.URL {
	return this.iri
}

// HasAny returns true if the value or IRI is set.
func (this PublishedProperty) HasAny() bool {
	return this.IsDateTime() || this.iri != nil
}

// IsDateTime returns true if this property is set and not an IRI.
func (this PublishedProperty) IsDateTime() bool {
	return this.hasDateTimeMember
}

// IsIRI returns true if this property is an IRI.
func (this PublishedProperty) IsIRI() bool {
	return this.iri != nil
}
...
func (this PublishedProperty) JSONLDContext() map[string]string {
...
func (this PublishedProperty) KindIndex() int {
	if this.IsDateTime() {
		return 0
	}
	if this.IsIRI() {
...
func (this PublishedProperty) LessThan(o vocab.PublishedPropertyInterface) bool {
...
func (this PublishedProperty) Name() string {
	return "published"
}
...
func (this PublishedProperty) Serialize() (interface{}, error) {
	if this.IsDateTime() {
...
// true.
func (this *PublishedProperty) Set(v time.Time) {
	this.Clear()
...
// true.
func (this *PublishedProperty) SetIRI(v *url.URL) {
	this.Clear()
	this.iri = v
}
