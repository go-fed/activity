...
func NewActivityStreamsPage() *ActivityStreamsPage {
	...
	typeProp.AppendXMLSchemaString("Page")
	return &ActivityStreamsPage{
...
func (this ActivityStreamsPage) GetActivityStreamsId() vocab.ActivityStreamsIdProperty {
...
// otherwise.
func (this ActivityStreamsPage) GetActivityStreamsType() vocab.ActivityStreamsTypeProperty {
...
func (this ActivityStreamsPage) IsExtending(other vocab.Type) bool {
	return ActivityStreamsPageExtends(other)
}
...
// determination.
func (this ActivityStreamsPage) LessThan(o vocab.ActivityStreamsPage) bool {
...
func (this *ActivityStreamsPage) SetActivityStreamsId(i vocab.ActivityStreamsIdProperty) {
...
func (this *ActivityStreamsPage) SetActivityStreamsType(i vocab.ActivityStreamsTypeProperty) {
...
// if it is not nil.
func (this ActivityStreamsPage) helperJSONLDContext(i jsonldContexter, toMerge map[string]string) map[string]string {
	if i == nil {
		return toMerge
	}
