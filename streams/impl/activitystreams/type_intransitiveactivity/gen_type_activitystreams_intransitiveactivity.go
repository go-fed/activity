...
func (this ActivityStreamsIntransitiveActivity) GetJSONLDId() vocab.JSONLDIdProperty {
	return this.JSONLDId
}

// GetJSONLDType returns the "type" property if it exists, and nil otherwise.
func (this ActivityStreamsIntransitiveActivity) GetJSONLDType() vocab.JSONLDTypeProperty {
...
func (this *ActivityStreamsIntransitiveActivity) SetJSONLDId(i vocab.JSONLDIdProperty) {
	this.JSONLDId = i
}

// SetJSONLDType sets the "type" property.
func (this *ActivityStreamsIntransitiveActivity) SetJSONLDType(i vocab.JSONLDTypeProperty) {
	this.JSONLDType = i
}
