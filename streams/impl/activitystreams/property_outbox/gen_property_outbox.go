...
// OutboxProperty is the functional property "outbox". It is permitted to be one
...
// arbitrary value.
func (this OutboxProperty) GetOrderedCollection() vocab.OrderedCollectionInterface {
...
// an arbitrary value.
func (this OutboxProperty) GetOrderedCollectionPage() vocab.OrderedCollectionPageInterface {
...
func (this OutboxProperty) IsOrderedCollectionPage() bool {
...
func (this *OutboxProperty) SetOrderedCollection(v vocab.OrderedCollectionInterface) {
	this.Clear()
...
func (this *OutboxProperty) SetOrderedCollectionPage(v vocab.OrderedCollectionPageInterface) {
	this.Clear()
