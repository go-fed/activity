...
func NewActivityStreamsPerson() *ActivityStreamsPerson {
	...
	typeProp.AppendXMLSchemaString("Person")
	return &ActivityStreamsPerson{
...
func (this ActivityStreamsPerson) GetActivityStreamsId() vocab.ActivityStreamsIdProperty {
...
// otherwise.
func (this ActivityStreamsPerson) GetActivityStreamsType() vocab.ActivityStreamsTypeProperty {
...
// SetActivityStreamsFollowers returns the "followers" property if it exists, and
// nil otherwise.
...
// SetActivityStreamsFollowing returns the "following" property if it exists, and
// nil otherwise.
...
func (this *ActivityStreamsPerson) SetActivityStreamsId(i vocab.ActivityStreamsIdProperty) {
...
// SetActivityStreamsInbox returns the "inbox" property if it exists, and nil
// otherwise.
func (this *ActivityStreamsPerson) SetActivityStreamsInbox(i vocab.ActivityStreamsInboxProperty) {
	this.ActivityStreamsInbox = i
}

// SetActivityStreamsLiked returns the "liked" property if it exists, and nil
// otherwise.
...
// SetActivityStreamsOutbox returns the "outbox" property if it exists, and nil
// otherwise.
...
// SetActivityStreamsPreferredUsername returns the "preferredUsername" property if
// it exists, and nil otherwise.
...
// SetActivityStreamsStreams returns the "streams" property if it exists, and nil
// otherwise.
...
// otherwise.
func (this *ActivityStreamsPerson) SetActivityStreamsType(i vocab.ActivityStreamsTypeProperty) {
...
// if it is not nil.
func (this ActivityStreamsPerson) helperJSONLDContext(i jsonldContexter, toMerge map[string]string) map[string]string {
	if i == nil {
		return toMerge
	}
