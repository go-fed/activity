...
// ActivityStreamsListenExtends returns true if the Listen type extends from the
// other type.
...
func NewActivityStreamsListen() *ActivityStreamsListen {
	...
	typeProp.AppendXMLSchemaString("Listen")
...
func (this ActivityStreamsListen) GetActivityStreamsId() vocab.ActivityStreamsIdProperty {
...
// otherwise.
func (this ActivityStreamsListen) GetActivityStreamsType() vocab.ActivityStreamsTypeProperty {
...
func (this ActivityStreamsListen) IsExtending(other vocab.Type) bool {
	return ActivityStreamsListenExtends(other)
}
...
// determination.
func (this ActivityStreamsListen) LessThan(o vocab.ActivityStreamsListen) bool {
...
func (this *ActivityStreamsListen) SetActivityStreamsId(i vocab.ActivityStreamsIdProperty) {
...
func (this *ActivityStreamsListen) SetActivityStreamsType(i vocab.ActivityStreamsTypeProperty) {
...
// if it is not nil.
func (this ActivityStreamsListen) helperJSONLDContext(i jsonldContexter, toMerge map[string]string) map[string]string {
	if i == nil {
		return toMerge
	}
