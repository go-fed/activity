...
func DeserializeLike(m map[string]interface{}, aliasMap map[string]string) (*Like, error) {
	alias := ""
	aliasPrefix := ""
...
// LikeExtends returns true if the Like type extends from the other type.
func LikeExtends(other vocab.Type) bool {
...
func (this Like) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Like) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Like) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Like type extends from the other type.
func (this Like) IsExtending(other vocab.Type) bool {
	return LikeExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Like) JSONLDContext() map[string]string {
...
// determination.
func (this Like) LessThan(o vocab.LikeInterface) bool {
...
func (this Like) Serialize() (map[string]interface{}, error) {
