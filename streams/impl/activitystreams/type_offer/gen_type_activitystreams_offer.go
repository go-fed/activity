...
// ActivityStreamsOfferExtends returns true if the Offer type extends from the
// other type.
...
func NewActivityStreamsOffer() *ActivityStreamsOffer {
	...
	typeProp.AppendXMLSchemaString("Offer")
...
func (this ActivityStreamsOffer) GetActivityStreamsId() vocab.ActivityStreamsIdProperty {
...
// otherwise.
func (this ActivityStreamsOffer) GetActivityStreamsType() vocab.ActivityStreamsTypeProperty {
...
func (this ActivityStreamsOffer) IsExtending(other vocab.Type) bool {
	return ActivityStreamsOfferExtends(other)
}
...
// determination.
func (this ActivityStreamsOffer) LessThan(o vocab.ActivityStreamsOffer) bool {
...
func (this *ActivityStreamsOffer) SetActivityStreamsId(i vocab.ActivityStreamsIdProperty) {
...
func (this *ActivityStreamsOffer) SetActivityStreamsType(i vocab.ActivityStreamsTypeProperty) {
...
// if it is not nil.
func (this ActivityStreamsOffer) helperJSONLDContext(i jsonldContexter, toMerge map[string]string) map[string]string {
	if i == nil {
		return toMerge
	}
