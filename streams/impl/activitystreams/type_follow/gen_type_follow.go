...
func DeserializeFollow(m map[string]interface{}, aliasMap map[string]string) (*Follow, error) {
	alias := ""
	aliasPrefix := ""
...
// FollowExtends returns true if the Follow type extends from the other type.
func FollowExtends(other vocab.Type) bool {
...
func (this Follow) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Follow) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Follow) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Follow type extends from the other type.
func (this Follow) IsExtending(other vocab.Type) bool {
	return FollowExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Follow) JSONLDContext() map[string]string {
