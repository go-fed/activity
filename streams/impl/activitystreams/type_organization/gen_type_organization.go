...
// OrganizationExtends returns true if the Organization type extends from the
// other type.
func OrganizationExtends(other vocab.Type) bool {
...
func (this Organization) GetIcon() vocab.IconPropertyInterface {
	return this.Icon
}

// GetId returns the "id" property if it exists, and nil otherwise.
func (this Organization) GetId() vocab.IdPropertyInterface {
	return this.Id
}

// GetImage returns the "image" property if it exists, and nil otherwise.
func (this Organization) GetImage() vocab.ImagePropertyInterface {
	return this.Image
}

// GetInReplyTo returns the "inReplyTo" property if it exists, and nil otherwise.
func (this Organization) GetInReplyTo() vocab.InReplyToPropertyInterface {
...
func (this Organization) GetMediaType() vocab.MediaTypePropertyInterface {
	return this.MediaType
}

// GetName returns the "name" property if it exists, and nil otherwise.
func (this Organization) GetName() vocab.NamePropertyInterface {
	return this.Name
}

// GetObject returns the "object" property if it exists, and nil otherwise.
func (this Organization) GetObject() vocab.ObjectPropertyInterface {
	return this.Object
}
...
func (this Organization) GetPublished() vocab.PublishedPropertyInterface {
	return this.Published
}

// GetReplies returns the "replies" property if it exists, and nil otherwise.
func (this Organization) GetReplies() vocab.RepliesPropertyInterface {
	return this.Replies
}
...
func (this Organization) GetSummary() vocab.SummaryPropertyInterface {
	return this.Summary
}

// GetTag returns the "tag" property if it exists, and nil otherwise.
func (this Organization) GetTag() vocab.TagPropertyInterface {
	return this.Tag
}

// GetTo returns the "to" property if it exists, and nil otherwise.
func (this Organization) GetTo() vocab.ToPropertyInterface {
	return this.To
}

// GetType returns the "type" property if it exists, and nil otherwise.
func (this Organization) GetType() vocab.TypePropertyInterface {
	return this.Type
}
...
func (this Organization) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// GetUpdated returns the "updated" property if it exists, and nil otherwise.
func (this Organization) GetUpdated() vocab.UpdatedPropertyInterface {
	return this.Updated
}

// GetUrl returns the "url" property if it exists, and nil otherwise.
func (this Organization) GetUrl() vocab.UrlPropertyInterface {
	return this.Url
}

// IsExtending returns true if the Organization type extends from the other type.
func (this Organization) IsExtending(other vocab.Type) bool {
	return OrganizationExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this Organization) JSONLDContext() map[string]string {
...
// determination.
func (this Organization) LessThan(o vocab.OrganizationInterface) bool {
...
func (this Organization) Serialize() (interface{}, error) {
...
// if it is not nil.
func (this Organization) helperJSONLDContext(i jsonldContexter, toMerge map[string]string) map[string]string {
	if i == nil {
		return toMerge
	}
