...
// ActivityStreamsTravelExtends returns true if the Travel type extends from the
// other type.
...
func NewActivityStreamsTravel() *ActivityStreamsTravel {
	...
	typeProp.AppendXMLSchemaString("Travel")
...
func (this ActivityStreamsTravel) GetActivityStreamsId() vocab.ActivityStreamsIdProperty {
...
// otherwise.
func (this ActivityStreamsTravel) GetActivityStreamsType() vocab.ActivityStreamsTypeProperty {
...
func (this ActivityStreamsTravel) IsExtending(other vocab.Type) bool {
	return ActivityStreamsTravelExtends(other)
}
...
// determination.
func (this ActivityStreamsTravel) LessThan(o vocab.ActivityStreamsTravel) bool {
...
func (this *ActivityStreamsTravel) SetActivityStreamsId(i vocab.ActivityStreamsIdProperty) {
...
// otherwise.
func (this *ActivityStreamsTravel) SetActivityStreamsType(i vocab.ActivityStreamsTypeProperty) {
...
// if it is not nil.
func (this ActivityStreamsTravel) helperJSONLDContext(i jsonldContexter, toMerge map[string]string) map[string]string {
	if i == nil {
		return toMerge
	}
