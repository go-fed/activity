...
//   }
type TombstoneInterface interface {
	...
	// GetDeleted returns the "deleted" property if it exists, and nil
	// otherwise.
	GetDeleted() DeletedPropertyInterface
	...
	// GetFormerType returns the "formerType" property if it exists, and nil
	// otherwise.
	GetFormerType() FormerTypePropertyInterface
	...
	LessThan(o TombstoneInterface) bool
	...
	// SetDeleted returns the "deleted" property if it exists, and nil
	// otherwise.
	SetDeleted(i DeletedPropertyInterface)
	...
	// SetFormerType returns the "formerType" property if it exists, and nil
	// otherwise.
	SetFormerType(i FormerTypePropertyInterface)
