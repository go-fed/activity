...
//   }
type MediaTypePropertyInterface interface {
	// Clear ensures no value of this property is set. Calling IsRfc2045
	// afterwards will return false.
	Clear()
	// Get returns the value of this property. When IsRfc2045 returns false,
	...
	LessThan(o MediaTypePropertyInterface) bool
	...
	// Set sets the value of this property. Calling IsRfc2045 afterwards will
	// return true.
	Set(v string)
