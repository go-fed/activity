...
// RelPropertyIteratorInterface represents a single value for the "rel" property.
type RelPropertyIteratorInterface interface {
	// Get returns the value of this property. When IsRfc5988 returns false,
	...
	LessThan(o RelPropertyIteratorInterface) bool
	// Name returns the name of this property: "rel".
	Name() string
	// Next returns the next iterator, or nil if there is no next iterator.
	Next() RelPropertyIteratorInterface
	// Prev returns the previous iterator, or nil if there is no previous
	// iterator.
	Prev() RelPropertyIteratorInterface
	// Set sets the value of this property. Calling IsRfc5988 afterwards will
	// return true.
	Set(v string)
...
//   }
type RelPropertyInterface interface {
