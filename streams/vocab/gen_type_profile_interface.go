...
type ProfileInterface interface {
	...
	// GetDescribes returns the "describes" property if it exists, and nil
	// otherwise.
	GetDescribes() DescribesPropertyInterface
	...
	LessThan(o ProfileInterface) bool
	...
	// SetDescribes returns the "describes" property if it exists, and nil
	// otherwise.
	SetDescribes(i DescribesPropertyInterface)
