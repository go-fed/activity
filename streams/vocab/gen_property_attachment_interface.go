...
// AttachmentPropertyIteratorInterface represents a single value for the
// "attachment" property.
type AttachmentPropertyIteratorInterface interface {
	...
	LessThan(o AttachmentPropertyIteratorInterface) bool
	// Name returns the name of this property: "attachment".
	Name() string
	// Next returns the next iterator, or nil if there is no next iterator.
	Next() AttachmentPropertyIteratorInterface
	// Prev returns the previous iterator, or nil if there is no previous
	// iterator.
	Prev() AttachmentPropertyIteratorInterface
...
//     "type": "Note"
//   }
type AttachmentPropertyInterface interface {
	...
	At(index int) AttachmentPropertyIteratorInterface
	// Begin returns the first iterator, or nil if empty. Can be used with the
	// iterator's Next method and this property's End method to iterate
	// from front to back through all values.
	Begin() AttachmentPropertyIteratorInterface
	// Empty returns returns true if there are no elements.
	Empty() bool
	// End returns beyond-the-last iterator, which is nil. Can be used with
	// the iterator's Next method and this property's Begin method to
	// iterate from front to back through all values.
	End() AttachmentPropertyIteratorInterface
	// JSONLDContext returns the JSONLD URIs required in the context string
	// for this property and the specific values that are set. The value
	// in the map is the alias used to import the property's value or
	// values.
	...
	// only meant to help alternative implementations to go-fed to be able
	// to normalize nonfunctional properties.
	LessThan(o AttachmentPropertyInterface) bool
	// Name returns the name of this property: "attachment".
	Name() string
