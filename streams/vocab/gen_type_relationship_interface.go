...
type RelationshipInterface interface {
	...
	// GetRelationship returns the "relationship" property if it exists, and
	// nil otherwise.
	GetRelationship() RelationshipPropertyInterface
	...
	// GetSubject returns the "subject" property if it exists, and nil
	// otherwise.
	GetSubject() SubjectPropertyInterface
	...
	LessThan(o RelationshipInterface) bool
	...
	// SetRelationship returns the "relationship" property if it exists, and
	// nil otherwise.
	SetRelationship(i RelationshipPropertyInterface)
	...
	// SetSubject returns the "subject" property if it exists, and nil
	// otherwise.
	SetSubject(i SubjectPropertyInterface)
