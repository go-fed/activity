...
//   }
type HreflangPropertyInterface interface {
	// Clear ensures no value of this property is set. Calling IsBcp47
	// afterwards will return false.
	Clear()
	// Get returns the value of this property. When IsBcp47 returns false, Get
	...
	LessThan(o HreflangPropertyInterface) bool
	...
	// Set sets the value of this property. Calling IsBcp47 afterwards will
	// return true.
	Set(v string)
